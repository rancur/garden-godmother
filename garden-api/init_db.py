...
PLANTS = [
    ...
    # ── NEW DESERT PLANTS (research run 2026-06-01 r10) ──
    {
        "name": "Sotol",
        "category": "edible_native",
        "subcategory": "desert succulent",
        "days_to_maturity_min": 1825,
        "days_to_maturity_max": 3650,
        "spacing_inches": 60,
        "sun": "full",
        ...
        "desert_seasons": ["cool", "warm", "monsoon"],
        "sow_indoor_weeks_before_transplant": 0,
        "desert_sow_outdoor": ["03-01", "05-31"],
        "desert_transplant": ["03-01", "05-31"],
        "desert_harvest": None,
        "notes": "Dasylirion wheeleri — a true Sonoran/Chihuahuan native (desert spoon). Plant in full sun with sharp drainage and do NOT amend with organic matter. Drought tolerant once established; deep-soak monthly in summer for best appearance. Space at least 5 ft apart — frequently planted too tightly in Phoenix landscapes. Heart was historically roasted/distilled into sotol spirit; grown mainly as a low-water accent.",
        "companions": ["Parry's Penstemon", "Blackfoot Daisy", "Agave", "Globe Mallow"],
        "antagonists": [],
    },
    {
        "name": "Ocotillo",
        "category": "edible_native",
        "subcategory": "desert shrub",
        "days_to_maturity_min": 180,
        "days_to_maturity_max": 730,
        "spacing_inches": 96,
        "sun": "full",
        ...
        "desert_transplant": ["03-01", "05-31"],
        "desert_harvest": ["03-15", "05-15"],
        "notes": "Fouquieria splendens — native desert shrub with edible, tangy-sweet flowers (salads, nectar, tea). Plant bare-root/container March-May to original depth and SAME compass orientation. Drainage is critical and overwatering after transplant is the #1 killer. NOTE: ocotillo is an AZ protected native — nursery/salvage stock requires an AZ Dept. of Agriculture permit tag. Outstanding hummingbird and carpenter-bee plant.",
        "companions": ["Saguaro", "Palo Verde", "Agave", "Parry's Penstemon"],
        "antagonists": [],
    },
    {
        "name": "Garlic Chives",
        "category": "herb",
        "subcategory": "perennial allium",
        "days_to_maturity_min": 80,
        "days_to_maturity_max": 150,
        "spacing_inches": 12,
        "sun": "partial",
        ...
        "desert_seasons": ["cool", "warm"],
        "sow_indoor_weeks_before_transplant": 8,
        "desert_sow_outdoor": ["10-01", "04-30"],
        "desert_transplant": ["10-01", "04-30"],
        "desert_harvest": ["01-15", "11-30"],
        "notes": "Allium tuberosum — a more reliable perennial allium for Phoenix than common chives. Plant Oct-April; give afternoon shade so intense sun doesn't scorch foliage. Growth slows in peak summer but the clump persists as a true perennial. Reseeds aggressively — deadhead the white late-summer flowers to control spread. Mild garlic flavor; leaves, buds and flower stalks all edible.",
        "companions": ["Carrot", "Tomato", "Grape", "Pepper"],
        "antagonists": ["Bean (Bush)", "Pea"],
    },
    {
        "name": "Egyptian Walking Onion",
        ...
        "desert_seasons": ["cool", "warm"],
        "sow_indoor_weeks_before_transplant": 0,
        "desert_sow_outdoor": ["09-15", "11-30"],
        "desert_transplant": ["09-15", "11-30"],
        "desert_harvest": ["11-01", "05-31"],
        "notes": "Allium x proliferum — topsetting perennial onion grown from bulbils/divisions, not seed. Plant bulbils in fall; it is fundamentally a cool-season performer in the low desert and will slow or die back in the hottest months, then regrow as temps moderate. Mulch heavily and give afternoon shade to carry it through summer. Aerial bulbil clusters bend, root and 'walk' to form new plants. Greens, bulbils and underground bulbs all edible.",
        "companions": ["Carrot", "Beet", "Tomato", "Strawberry"],
        "antagonists": ["Bean (Bush)", "Pea"],
    },
    {
        "name": "Winged Bean",
        "category": "legume",
        "subcategory": "vining bean",
        "days_to_maturity_min": 70,
        "days_to_maturity_max": 120,
        "spacing_inches": 12,
        "sun": "full",
        ...
        "desert_transplant": ["04-01", "05-15"],
        "desert_harvest": ["07-01", "11-15"],
        "notes": "Psophocarpus tetragonolobus — every part is edible (pods, leaves, flowers, protein-rich seeds, tubers). CHOOSE A DAY-NEUTRAL VARIETY ('Singha'): standard short-day tropical types will not flower in time at Phoenix's latitude. Loves heat but is NOT drought tolerant — needs steady moisture, mulch, and likely afternoon shade through June. Provide a strong 6-12 ft trellis; harvest pods young (4-6 in). Nitrogen-fixing.",
        "companions": ["Corn", "Squash (Summer)", "Cucumber", "Sunflower"],
        "antagonists": ["Onion", "Garlic", "Fennel"],
    },
    {
        "name": "Hoja Santa",
        ...
        "desert_transplant": ["03-15", "05-31"],
        "desert_harvest": ["05-01", "11-15"],
        "notes": "Piper auritum (Mexican pepperleaf / root beer plant) — large anise/sassafras-scented leaves used to wrap tamales and fish. Plant in afternoon shade with rich, moisture-retentive soil; full desert sun scorches the big leaves. Frost kills the top but the rhizome survives Phoenix winters — mulch 4-6 in before first frost and it resprouts. Spreads aggressively by rhizome, so plant in a buried container or contained bed.",
        "companions": ["Ginger", "Turmeric", "Banana"],
        "antagonists": [],
    },
    {
        "name": "Chipilin",
        "category": "vegetable",
        "subcategory": "leafy green (legume)",
        "days_to_maturity_min": 60,
        "days_to_maturity_max": 90,
        "spacing_inches": 12,
        "sun": "full",
        ...
        "sow_indoor_weeks_before_transplant": 4,
        "desert_sow_outdoor": ["03-15", "07-31"],
        "desert_transplant": ["04-01", "06-30"],
        "desert_harvest": ["05-15", "11-15"],
        "notes": "Crotalaria longirostrata (chepil) — a heat-and-sun-loving legume green that thrives in Phoenix summer where many greens fail, and fixes nitrogen. Frost-tender; grow as a summer annual or short-lived perennial, harvesting tender leaves/tips repeatedly. IMPORTANT: leaves must ALWAYS be cooked (boiled) before eating — the plant contains pyrrolizidine alkaloids and the seeds are toxic. Used in tamales de chipilin and soups.",
        "companions": ["Corn", "Squash (Summer)"],
        "antagonists": ["Onion", "Garlic"],
    },
    {
        "name": "Black Sapote",
        "category": "fruit",
        "subcategory": "tropical fruit tree",
        "days_to_maturity_min": 1095,
        "days_to_maturity_max": 2190,
        "spacing_inches": 240,
        "sun": "full",
        ...
        "desert_transplant": ["03-15", "05-15"],
        "desert_harvest": ["11-01", "03-31"],
        "notes": "Diospyros nigra ('chocolate pudding fruit') — MARGINAL/ADVANCED in Phoenix. Hardy only to zones 10-12: young trees die near 30F, mature near 28F, so it needs a warm microclimate (south wall, NOT a frost pocket), frost cloth every winter, and pruning to 8-10 ft so it can be covered. NOT drought tolerant: deep weekly water, doubled over 105F, plus heavy mulch. Give young trees afternoon shade to prevent sunburn; watch for iron chlorosis in alkaline soil. Buy a grafted tree to fruit in ~3 years. Many low-desert gardeners lose them to a hard freeze.",
        "companions": ["Pigeon Pea", "Moringa"],
        "antagonists": [],
    },
]
...
def init_db():
    ...
    VARIETIES = [
        ...
        # ── NEW DESERT VARIETIES (research run 2026-06-01 r10) ──
        ('Garlic Chives', 'Geisha', 'Broad-leaf garlic chive selected for wider, more tender culinary leaves.', 80, 120, 'high', None, 'Mild garlic, tender', '12-18 in', 'Green leaves, white flowers', 'Clumping perennial', 4, 'Reliable perennial in Phoenix with afternoon shade; slows but survives summer. Cut leaves regularly for tender regrowth.', 'Growing In The Garden; UNH Extension'),
        ('Winged Bean', 'Singha', 'Early-flowering, day-length-neutral winged bean that sets flowers regardless of daylength — the key to fruiting outside the tropics.', 70, 90, 'excellent', None, 'Tender asparagus-like winged pods', 'Vine 8-12 ft; pods 6-9 in', 'Green pods, blue flowers', 'Vigorous climbing vine', 3, "Essential choice for Phoenix — day-neutrality lets it fruit before season's end; still needs ample water, a tall trellis, and likely afternoon shade in peak heat.", 'Kitchen Garden Seeds; Epic Gardening'),
        ('Black Sapote', 'Bernecker', 'Florida-selected, reliable heavy producer with good-quality fruit; commonly grafted.', 1095, 1460, 'high', None, 'Rich, sweet chocolate-pudding', 'Medium-large fruit ~1 lb; prune tree to 8-10 ft', 'Olive-green skin, dark brown-black flesh', 'Evergreen tree', 2, 'Even a good cultivar is marginal in Phoenix — requires winter frost cloth and heavy summer irrigation; grow grafted to fruit in ~3 yr. Other selections (e.g. Wilson) similar.', 'Sow Exotic; Garden Oracle'),
    ]
