...
<<<<<<< HEAD
        ...
        "days_to_maturity_max": 60,
        "sow_indoor_weeks_before_transplant": None,
        "desert_sow_outdoor": ["04-01", "08-15"],
        "desert_transplant": None,
        "desert_harvest": ["06-01", "10-15"],
        "notes": "Heat-loving legume also called cluster bean. Produces edible pods and performs reliably in high heat with low water.",
        "companions": ["Corn", "Okra", "Amaranth", "Basil"],
        "antagonists": ["Onion", "Garlic"],
    },
...
=======
    ...
    },
    {
        ...
        "sow_indoor_weeks_before_transplant": None,
        "desert_sow_outdoor": ["04-01", "08-31"],
        "desert_transplant": None,
        "desert_harvest": ["05-15", "10-31"],
        "notes": "Corchorus olitorius. Tender edible leaves for soups and sautés. One of the best summer greens for low-desert heat.",
        "companions": ["Okra", "Pepper", "Eggplant", "Amaranth"],
        "antagonists": ["None known"],
    },
    # ── EPAZOTE ──
    {
        ...
        "desert_sow_outdoor": ["03-15", "08-31"],
        "desert_transplant": None,
        "desert_harvest": ["05-01", "11-01"],
        "notes": "Traditional Mexican culinary herb used with beans. Thrives in heat and poorer soils; can self-seed in warm climates.",
        "companions": ["Bean (Bush)", "Pinto Bean", "Black-eyed Pea", "Corn"],
        "antagonists": ["None known"],
    },
    # ── OLIVE ──
    {
        ...
        "desert_seasons": ["warm"],
        "sow_indoor_weeks_before_transplant": None,
        "desert_sow_outdoor": ["02-01", "04-30"],
        "desert_transplant": ["02-01", "04-30"],
        "desert_harvest": ["09-01", "12-15"],
        "notes": "Mediterranean fruit tree adapted to hot, dry climates and alkaline soils. Needs excellent drainage and little summer water once established.",
        "companions": ["Rosemary", "Thyme", "Lavender", "Sage"],
        "antagonists": ["None known"],
    },
    # ── GUAVA ──
    {
        ...
        "desert_transplant": ["03-01", "05-15"],
        "desert_harvest": ["08-15", "12-31"],
        "notes": "Tropical fruit tree that performs in low-desert microclimates with frost protection. Benefits from deep irrigation during hot months.",
        "companions": ["Basil", "Marigold", "Lemongrass", "Oregano"],
        "antagonists": ["None known"],
    },
    {
        "name": "Chickpea",
        ...
        "notes": "Cool-season pulse crop that handles low-desert spring heat better than peas. Direct sow in fall through winter for spring harvest of green pods or dry seed.",
        "companions": ["Carrot", "Cilantro", "Lettuce", "Radish"],
        "antagonists": ["Onion", "Garlic"],
    },
    {
        "name": "Sorghum",
        ...
        "notes": "Ultra heat- and drought-adapted grain crop. Performs in alkaline soils and can double as windbreak or biomass crop in low-desert gardens.",
        "companions": ["Cowpea", "Sesame", "Pigeon Pea", "Sunflower"],
        "antagonists": ["Tomato"],
    },
    {
        "name": "Bottle Gourd",
    ...
    },
    {
        ...
        "desert_harvest": ["08-01", "11-30"],
        "notes": "Native Sonoran tree producing small edible berries for people and wildlife. Extremely drought tolerant once established and useful as a food-forest backbone species.",
        "companions": ["Desert Chia", "Mesquite", "Pomegranate", "Globe Mallow"],
        "antagonists": ["None known"],
    },
    {
        ...
        "desert_sow_outdoor": None,
        "desert_transplant": ["02-15", "04-30"],
        "desert_harvest": ["05-01", "08-31"],
        "notes": "Native Lycium shrub with small red-orange edible berries. Handles reflected heat and poor soils; valuable for pollinators and desert food hedges.",
        "companions": ["Mesquite", "Desert Chia", "Globe Mallow", "Desert Milkweed"],
        "antagonists": ["None known"],
    },
]
...
def init_db():
    ...
    VARIETIES = [
        ...
        ("Okra", "Jambalaya", "Early compact okra hybrid with high yields in heat.", 50, 55, "excellent", None, "Tender, classic okra flavor", "Pods 3-5 in", "Green", "Compact upright", 5, "Excellent choice for Arizona because it sets early and keeps producing in high heat; compact habit suits raised beds.", "Hybrid"),
        ("Cowpea", "Mississippi Silver", "Productive cowpea with long silver-green pods for shelling or snap use.", 60, 80, "excellent", None, "Rich, earthy, sweet-pea notes", "Long pods", "Green/silver", "Bush to semi-vining", 5, "Reliable pod set in extreme heat and low humidity; well suited to monsoon-season planting.", "Heirloom"),
        ("Tepary Bean", "Blue Speckled Tepary", "Landrace tepary with mottled seed and outstanding dryland resilience.", 65, 85, "excellent", None, "Nutty, dense, earthy", "Small dry bean", "Blue-gray speckled", "Low bush", 5, "Desert-adapted tepary selected in the Southwest for minimal irrigation systems.", "Native heirloom"),
        ("Basil", "Prospera DMR", "Downy-mildew-resistant Genovese basil with strong heat performance.", 55, 70, "high", "Downy mildew resistance", "Sweet Genovese profile", "Medium leaves", "Green", "Upright bushy", 4, "Useful in desert climates where warm nights and overhead irrigation can trigger downy mildew.", "Hybrid"),
        ("Pomegranate", "Eversweet", "Low-acid pomegranate with soft seeds and high summer heat tolerance.", 730, 1095, "excellent", None, "Very sweet, low-tannin", "Medium-large fruit", "Pink-red", "Multi-trunk shrub/tree", 5, "Excellent low-desert pomegranate for fresh eating; maintains sweetness under intense heat.", "Cultivar"),

        # ── NEW DESERT VARIETIES (research run 2026-03-27b) ──
        ("Guar (Cluster Bean)", "Pusa Navbahar", "Indian guar cultivar selected for tender pods and strong summer heat set.", 48, 65, "excellent", None, "Mild bean flavor", "Medium green pods", "Green", "Bush", 5, "Highly reliable pod set under high heat; suitable for low-desert summer production.", "Open-pollinated"),
        ("Jute Mallow (Molokhia)", "Balady", "Traditional molokhia type grown for tender leaves in hot climates.", 45, 60, "excellent", None, "Mild spinach-like with slight mucilage", "Leaf harvest", "Green", "Upright", 5, "Excellent summer leafy crop for Zone 9b/10a; responds well to repeated cutting.", "Heirloom"),
        ("Epazote", "Mexican Green", "Common culinary epazote strain used for leaf harvest.", 55, 75, "excellent", None, "Pungent resinous herb", "Leaf harvest", "Green", "Upright", 4, "Thrives in hot dry conditions and keeps producing through monsoon season with light irrigation.", "Open-pollinated"),
        ("Olive", "Arbequina", "Low-chill olive cultivar with reliable fruiting in warm climates.", 730, 1095, "excellent", None, "Mild buttery olive", "Small-medium fruit", "Green to black", "Compact tree", 5, "One of the most desert-adapted fruiting olives; productive with minimal irrigation once established.", "Spanish cultivar"),
        ("Guava", "Mexican Cream", "White-fleshed guava with sweet aromatic fruit and good heat adaptation.", 730, 1095, "high", None, "Sweet, creamy, aromatic", "Medium round fruit", "Yellow skin, white flesh", "Small tree", 4, "Handles summer heat well in low desert; protect during hard freezes and irrigate deeply during fruiting.", "Heirloom"),
        # ── NEW DESERT VARIETIES (research run 2026-03-28) ──
        ("Black-Eyed Pea", "California Blackeye #46", "Improved black-eyed pea with reliable pod set under high heat.", 60, 75, "excellent", None, "Classic creamy cowpea flavor", "Medium pods", "Cream seed with black eye", "Bush", 5, "Strong producer for low-desert summers with modest water demand.", "University release"),
        ("Bitter Melon", "India Long Green", "Long ridged bitter melon line selected for hot-season production.", 60, 75, "excellent", None, "Bold bitter flavor, best harvested young", "Long fruit (8-12 in)", "Green", "Vigorous vine", 5, "Performs well in Arizona summer heat when trellised and harvested frequently.", "Open-pollinated"),
        ("Anaheim Pepper", "NuMex Joe E. Parker", "Improved New Mexico-type chile with larger pods and uniform plants.", 75, 85, "high", "TMV tolerance", "Mild, sweet-roasty green chile flavor", "Large pods (6-8 in)", "Green to red", "Upright bush", 4, "Consistent roasting chile for desert gardens; benefits from early spring transplant timing.", "New Mexico State University"),
        ("Apricot", "Katy", "Low-chill apricot suitable for mild-winter regions.", 730, 1095, "high", None, "Sweet-tart, aromatic", "Medium fruit", "Golden-orange", "Medium tree", 4, "One of the more dependable apricots for low-desert chill accumulation.", "Low-chill cultivar"),
        ("Blood Orange", "Moro", "Classic blood orange with strong internal red pigmentation.", 1095, 1460, "high", None, "Sweet-tart with berry notes", "Medium fruit", "Deep orange rind, red flesh", "Medium tree", 4, "Performs in low-desert citrus zones with deep irrigation and micronutrient support.", "Italian cultivar"),
    ]
