...
PLANTS = [
    ...
    },
    {
        ...
        "desert_transplant": ["03-01", "05-01"],
        "desert_harvest": ["05-15", "10-15"],
        "notes": "Melothria scabra — Mexican sour gherkin or 'mouse melon.' Native to Mexico/Central America so excellent desert performer. Vigorous vining cucurbit producing grape-sized cucumber-watermelon look-alikes with citrusy cucumber flavor. Far more heat- and drought-tolerant than true cucumber and largely free of common cucumber pests. Trellis required (8-10 ft vines). Tubers can be overwintered to restart next season. Slow to establish then explodes with fruit through monsoon.",
        "companions": ["Bean", "Corn", "Sunflower", "Radish", "Marigold", "Nasturtium"],
        "antagonists": ["Potato", "Aromatic herbs (sage, mint)"],
    },
    {
        "name": "Banana",
        ...
        "desert_transplant": ["03-15", "05-31"],
        "desert_harvest": ["09-01", "11-30"],
        "notes": "Musa spp. — works in zone 9b/10a with cold protection. Dwarf Cavendish, Dwarf Namwah, Ice Cream (Blue Java), and Raja Puri are top desert performers. Plant on east/north side of structure for afternoon shade — leaves shred above 105F in full sun. Heavy water and feeder during growing season; mulch deeply. Frost will kill leaves to ground but corm survives down to ~25F if mulched. Each pseudostem fruits once then dies — keep one sucker (pup) for next year. Needs windbreak.",
        "companions": ["Sweet Potato", "Comfrey", "Lemongrass", "Ginger", "Turmeric"],
        "antagonists": [],
    },
    {
        "name": "Sugarcane",
    ...
    },
    {
        ...
        "notes": "Solanum muricatum — Andean fruit related to tomato/eggplant. Sprawling perennial that produces sweet melon-honeydew-cucumber-flavored fruit with purple striping. Tender perennial in 9b/10a — root surives most winters with mulch. Sets fruit best at 65-85F so heaviest yields are spring and fall. Pause/shadecloth above 100F. Propagated from cuttings (very easy). Stake or sprawl on mulch. Susceptible to whiteflies and the same pests as tomato.",
    ...
    },
    {
        ...
        "desert_transplant": ["03-01", "05-15"],
        "desert_harvest": ["04-01", "11-30"],
        "notes": "Plectranthus amboinicus — also called Mexican mint, Spanish thyme, Indian borage. Succulent-leaved perennial herb that loves Phoenix heat. Strong oregano-thyme aroma; one or two leaves season an entire pot. Tolerates 115F if given afternoon shade and occasional water. Damaged at 32F but recovers from roots in 9b/10a. Easily propagated from cuttings. Excellent container plant — outgrows ground beds quickly. Used in Caribbean and Filipino cuisine plus traditional cough remedies.",
        "companions": ["Pepper", "Tomato", "Eggplant", "Basil"],
        "antagonists": [],
    },
    {
        "name": "Anise Hyssop",
        ...
        "notes": "Agastache foeniculum — drought-tolerant perennial in the mint family with anise-licorice flavored leaves and edible purple flower spikes. One of the strongest pollinator magnets you can plant; bees, hummingbirds, and beneficial wasps swarm it. Established plants need almost no supplemental water and tolerate full Phoenix sun. Cut back hard in late winter for vigorous spring regrowth. Self-seeds gently. Leaves used for teas, salads, infusions; flowers garnish desserts and drinks.",
        "companions": ["Tomato", "Pepper", "Eggplant", "Squash (Summer)", "Cucumber", "Sunflower"],
        "antagonists": [],
    },
    {
        "name": "Tree Collards",
        ...
        "desert_sow_outdoor": None,
        "desert_transplant": ["10-01", "03-15"],
        "desert_harvest": ["12-01", "06-30"],
        "notes": "Brassica oleracea — perennial collard propagated from cuttings (rarely flowers/seeds). Lives 5-7 years and grows 6-8 ft tall, producing tender purple- or green-tinged leaves year-round in mild winters. Plant on east side or under 30-50% shade cloth — leaves bleach and toughen above 100F in full sun. Mulch heavily, drip-irrigate at base. Cut back hard in late spring before peak heat to push fresh tender growth in fall. Stems get top-heavy — stake or layer the lower branches.",
        "companions": ["Onion", "Garlic", "Dill", "Nasturtium", "Marigold", "Beet"],
        "antagonists": ["Tomato", "Pepper", "Strawberry"],
    },
    {
        "name": "Orach",
        ...
        "desert_transplant": None,
        "desert_harvest": ["10-15", "05-31"],
        "notes": "Atriplex hortensis — 'mountain spinach.' Salt- and drought-tolerant Chenopodiaceae cousin of spinach and quinoa. Holds in heat far longer than true spinach before bolting; red and gold cultivars are striking and equally edible. Direct sow into native soil from fall through early spring. Pinch flower spikes to extend leaf harvest. Mature plants reach 4-6 ft and self-seed prolifically — pull volunteers you don't want before they set seed. Cook like spinach; raw use sparingly due to oxalates.",
