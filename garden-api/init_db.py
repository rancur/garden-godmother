...
PLANTS = [
    ...
    },
    {
        ...
        "heat_tolerance": "high",
        "cold_tolerance": "high",
        "desert_seasons": ["cool", "monsoon"],
        "sow_indoor_weeks_before_transplant": 0,
        "desert_sow_outdoor": ["08-01", "11-30"],
        "desert_transplant": None,
        "desert_harvest": ["05-01", "07-15"],
        "notes": "Allium cepa var. aggregatum — Sonoran heirloom multiplier/bunching onion grown by the Tohono O'odham (named for the desert creator deity I'itoi). Planted as small bulbs, not seed; each bulb divides into a clump of 10+ that is split and replanted. Plant 1in deep with the monsoon moisture Aug–Nov; harvest May–July, then replant within 2–3 months as bulbs shrivel in storage. Goes dormant through the driest months. Extremely tough — grows in native soil with no feeding, though richer soil yields larger bulbs. Use greens like scallions year-round and bulbs like shallots. Available seasonally from Native Seeds/SEARCH.",
        "companions": ["Tomato", "Carrot", "Beet", "Lettuce", "Strawberry"],
        "antagonists": ["Bean (Bush)", "Pea", "Tepary Bean"],
    },
    {
        "name": "Devil's Claw",
        "category": "native edible",
        ...
        "desert_seasons": ["warm", "monsoon"],
        "sow_indoor_weeks_before_transplant": 0,
        "desert_sow_outdoor": ["06-15", "07-31"],
        "desert_transplant": None,
        "desert_harvest": ["08-15", "10-31"],
        "notes": "Proboscidea parviflora — domesticated by the Hohokam over 1,000 years ago and cultivated by the Tohono O'odham (O'odham name 'i:huk'). The white-seeded domesticate (var. hohokamiana) germinates faster than the wild black-seeded form and yields longer, more flexible pods. Young tender pods are boiled and eaten like okra; the oil-rich seeds are eaten raw or ground. Dried split pods provide the black fiber in O'odham basketry. Direct-sow 1/4–1/3in deep with the summer monsoon in well-drained sandy soil; seeds are a favorite of desert critters, so protect new plantings. Extreme heat and drought tolerance.",
        "companions": ["Tepary Bean", "Corn", "Squash (Summer)"],
        "antagonists": [],
    },
    {
        "name": "Orach",
        ...
        "desert_transplant": None,
        "desert_harvest": ["11-01", "05-31"],
        "notes": "Atriplex hortensis (mountain spinach) — an ancient leafy green and one of the best warm-weather spinach substitutes; far slower to bolt than true spinach and holds through heat that would bolt spinach. Halophytic — thrives in poor, alkaline, and saline desert soils. Green, red, and purple-leaved types; young leaves are mild and tender (3x the vitamin C of spinach), larger leaves cook like spinach. Germinates in cool soil, so sow fall through late winter in the low desert; succession-sow every 2–3 weeks. Self-seeds readily — deadhead to control spread.",
        "companions": ["Lettuce", "Bean (Bush)", "Pea"],
        "antagonists": [],
    },
    {
        "name": "Cardoon",
        ...
        "desert_harvest": ["01-01", "04-30"],
        "notes": "Cynara cardunculus — the artichoke's leaf-stalk relative, also called the desert artichoke. Mediterranean and well adapted to hot, dry, alkaline, and saline ground; drought tolerant once established but needs steady water and rich soil through active growth. Grown for blanched leaf stalks (tie and wrap the plant for several weeks before harvest to tenderize). Grows fast through the cool, wetter desert winter; in AZ it can be harvested across much of the year as plants mature. Striking 4–5ft silvery architectural plant. Note: can naturalize/become weedy — deadhead flowers before they set seed.",
        "companions": ["Pea", "Bean (Bush)"],
        "antagonists": [],
    },
    {
        "name": "Magenta Spreen",
        ...
        "desert_transplant": None,
        "desert_harvest": ["03-15", "06-30"],
        "notes": "Chenopodium giganteum — also called tree spinach, giant goosefoot, or giant lambsquarters; a heat- and humidity-tolerant relative of quinoa and lambsquarters. More heat tolerant than spinach. The brilliant magenta young growing tips have a glittery sheen and are eaten raw; larger leaves are cooked like spinach. Surface-sow (needs light to germinate) and press in; can reach 6–9ft if left to grow, so harvest tips regularly to keep it bushy and tender. Sow late winter through midsummer. Self-seeds prolifically — remove seed heads to prevent volunteers.",
        "companions": ["Lettuce", "Bean (Bush)"],
        "antagonists": [],
    },
    {
        ...
        "desert_seasons": ["cool"],
        "sow_indoor_weeks_before_transplant": 0,
        "desert_sow_outdoor": ["09-01", "11-30"],
        "desert_transplant": None,
        "desert_harvest": ["02-01", "05-31"],
        "notes": "Allium x proliferum (tree/topset onion) — a hardy perennial that forms clusters of bulblets (topsets) at the top of the stalk; the stalk bends over and the bulblets root where they land, so the patch 'walks' across the bed. Hardy from zone 3 through zone 10. In the low desert, plant bulblets in fall for spring harvest and give the patch dappled afternoon shade to carry it through summers above 90F. Harvest greens like scallions, the topsets as pearl-onion substitutes, and the underground bulbs like shallots. Very low maintenance — well-drained soil and minimal water.",
        "companions": ["Carrot", "Beet", "Lettuce", "Strawberry", "Tomato"],
    ...
    },
    {
        ...
        "desert_transplant": ["10-01", "02-28"],
        "desert_harvest": ["11-01", "05-31"],
        "notes": "Rumex scutatus (buckler-leaf sorrel) — a low, mat-forming perennial green prized for its bright lemony-tart shield-shaped leaves, used in salads, sauces (classic sorrel soup), and with fish. Drought, frost, and wind tolerant once established. In the low desert give it afternoon shade and supplemental water; it stays productive through the cool season and self-seeds readily. Cut flower stalks to keep leaves tender and prevent reseeding. Can be used as an edible groundcover. Contains oxalic acid — eat in moderation.",
    ...
    },
    {
        ...
        "desert_transplant": ["03-01", "04-15"],
        "desert_harvest": ["05-01", "10-31"],
        "notes": "Agastache foeniculum — a fragrant mint-family perennial whose anise/licorice-scented leaves and seeds flavor teas, salads, and baked goods. Reliably hardy zones 4–8 and marginal at zone 9, so in the low desert treat it as a short-lived perennial: give sharply drained soil, afternoon shade, and only occasional deep water once established (rot from wet/rich soil is the main killer). Violet flower spikes from early summer to fall are a major magnet for bees and hummingbirds. Deer- and rabbit-resistant. A tough drought-tolerant pollinator herb where drainage is good.",
        "companions": ["Tomato", "Squash (Summer)", "Melon"],
        "antagonists": [],
    },
    # ── NEW DESERT PLANTS (research run 2026-05-31, batch 2) ──
    {
        "name": "Cucamelon",
        "category": "vegetable",
        "subcategory": "fruit",
        ...
        "desert_harvest": ["05-01", "11-30"],
        "notes": "Melothria scabra (Mexican sour gherkin, mouse melon) — grape-sized cucumber-flavored fruits with a citrusy tang, eaten fresh, in salads, or pickled. Far more heat-tolerant than true cucumbers and develops moisture-storing tubers, but fruit set pauses above ~95-100F, so give afternoon shade June-Aug and a trellis. Frost-sensitive, but tubers can overwinter underground in mild Phoenix winters and re-sprout. Plant for a spring flush and again for a heavy fall harvest.",
        "companions": ["Corn", "Bean (Bush)", "Nasturtium", "Radish", "Marigold"],
        "antagonists": ["Potato"],
    },
    {
    ...
    },
    {
        ...
        "desert_harvest": ["01-01", "12-31"],
        "notes": "Allium tuberosum (Chinese chives, nira) — a clumping perennial allium with flat garlicky leaves and edible white flower umbels, used in stir-fries, dumplings, eggs, and as a garnish. Heat-, cold-, drought-, and alkaline-soil tolerant; plant in fall, give afternoon shade and well-drained compost-amended soil, and harvest nearly year-round once established. Deadhead the flowers to prevent prolific reseeding. Very low maintenance and long-lived; alliums also deter aphids near roses and tomatoes.",
        "companions": ["Carrot", "Tomato", "Apple", "Rosemary"],
        "antagonists": ["Bean (Bush)", "Pea"],
    },
    {
        "name": "Pomelo",
        ...
        "notes": "Citrus maxima (pummelo, shaddock) — the largest citrus, with thick rind and mild sweet segments eaten fresh, in salads, or as candied peel. Like other citrus it excels in Phoenix heat, but it is the most frost-tender of the common desert citrus (damaged near 26F), so plant in spring after frost in a warm south/west-facing microclimate and protect young trees the first few winters. Deep, infrequent irrigation in well-drained soil; tolerates alkaline desert soils with standard citrus care.",
        "companions": ["Lemon", "Orange", "Grapefruit"],
        "antagonists": [],
    },
    {
        ...
        "desert_sow_outdoor": None,
        "desert_transplant": ["02-15", "04-15"],
        "desert_harvest": ["08-01", "09-30"],
        "notes": "Diospyros texana (Mexican persimmon, chapote) — a tough small multi-trunked tree bearing small, intensely sweet black fruit when fully ripe, used fresh or in jams. Listed by the UA Campus Arboretum as low-water, highly heat- and drought-tolerant, and happy in alkaline caliche soils; showy peeling pale bark is an ornamental bonus. Dioecious — needs a female (with a male nearby) to fruit. The ripe black fruit stains heavily, so site away from patios, walks, and cars.",
        "companions": ["Mesquite", "Palo Verde"],
        "antagonists": [],
    },
    {
    ...
    },
    {
        ...
        "desert_transplant": ["10-01", "03-31"],
        "desert_harvest": ["08-01", "11-30"],
        "notes": "Atriplex lentiformis (big saltbush) — a fast, large evergreen Sonoran Desert native for screening, windbreak, erosion control, and quail/bird habitat, with near-zero supplemental water once established. Extremely drought-, heat-, salinity-, and alkalinity-tolerant. Primarily a habitat/landscape plant: seeds are edible only as famine food (boil through two changes of water) and leaves are a marginal potherb. Dioecious (needs male + female for seed) and grows to ~10 ft; accumulates salt in leaves that can suppress nearby ornamentals, so give it room.",
        "companions": ["Mesquite", "Palo Verde"],
        "antagonists": [],
    },
]
