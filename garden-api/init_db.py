...
PLANTS = [
    ...
    },
    {
        ...
        "desert_transplant": ["03-15", "04-30"],
        "desert_harvest": ["06-01", "10-31"],
        "notes": "Melothria scabra — also called Mexican sour gherkin or mouse melon. Native to Mexico/Central America, ideal for desert heat. Grape-sized fruits taste like cucumber with citrus tang. Vining habit needs 5-6 ft trellis. Slow to start but produces heavily once established. Drought-tolerant once roots reach down. Tubers can overwinter and resprout. Pest- and disease-resistant compared to cucumbers.",
        "companions": ["Bean (Bush)", "Marigold", "Nasturtium", "Corn"],
        "antagonists": ["Potato"],
    },
    {
        "name": "Anise Hyssop",
        ...
        "desert_transplant": ["03-01", "04-15"],
        "desert_harvest": ["05-01", "11-30"],
        "notes": "Agastache foeniculum — drought-tolerant perennial with licorice-anise scented leaves and lavender flower spikes that attract bees, butterflies, hummingbirds. Native to North American prairies, very heat- and drought-tolerant once established. Leaves used for tea, salads, baking. Flowers edible. Self-seeds. Cut back hard in late winter. Pairs well with native pollinator plantings.",
        "companions": ["Lavender", "Rosemary", "Sage", "Echinacea"],
        "antagonists": [],
    },
    {
        "name": "Cardoon",
        ...
        "desert_transplant": ["10-15", "11-30"],
        "desert_harvest": ["02-01", "04-30"],
        "notes": "Cynara cardunculus — Mediterranean perennial relative of artichoke grown for blanched leaf stalks. Massive silver-gray foliage to 5 ft tall, striking purple thistle flowers. Heat- and drought-tolerant once established; goes summer-dormant in extreme desert heat. Blanch stalks by wrapping with cardboard 3-4 weeks before harvest. Italian/French cuisine staple. Can be invasive — deadhead before seed set.",
    ...
    },
    {
        ...
        "desert_transplant": ["02-15", "03-31"],
        "desert_harvest": ["06-01", "11-30"],
        "notes": "Solanum muricatum — Andean shrub with melon-cucumber-flavored fruit. Tender perennial in low desert (zone 9b+); root-hardy with mulch. Grow from cuttings — seeds are slow and variable. Needs afternoon shade in peak summer; mulch heavily. Self-fertile but light shake helps fruit set. Fruit is golden with purple stripes when ripe. Container-friendly. Can produce within 4-6 months from cutting.",
        "companions": ["Basil", "Marigold", "Tomato", "Pepper"],
        "antagonists": [],
    },
    {
        "name": "Tigernut",
        ...
        "desert_transplant": None,
        "desert_harvest": ["09-15", "11-30"],
        "notes": "Cyperus esculentus var. sativus — also called chufa. Sedge grown for sweet, nutty underground tubers used in horchata de chufa. Extremely heat-tolerant, originated in North Africa/Mediterranean. Soak tubers 24 hours before planting in loose sandy soil. Harvest after foliage yellows in fall by digging entire plant. Can be invasive — grow in contained beds. Tubers store dry for months.",
        "companions": ["Sunflower", "Corn"],
        "antagonists": [],
    },
    {
        ...
        "desert_harvest": ["02-01", "06-30"],
        "notes": "Allium × proliferum — perennial onion that forms topsetting bulblets which bend down and replant themselves, hence 'walking.' Hardy and forgiving; bulblets, scapes, and greens all edible. Tolerates desert heat with afternoon shade and mulch; goes semi-dormant in peak summer and revives with fall rains. Plant bulblets in fall for spring greens. Once established, rarely needs replanting.",
        "companions": ["Carrot", "Tomato", "Lettuce", "Strawberry"],
        "antagonists": ["Pea", "Bean (Bush)"],
    },
    {
        "name": "Salsify",
        "category": "vegetable",
        ...
        "desert_transplant": None,
        "desert_harvest": ["02-15", "05-15"],
        "notes": "Tragopogon porrifolius — long taproot with mild oyster flavor when cooked; also called oyster plant. Cool-season biennial best fall-sown in low desert for spring harvest. Needs deep, loose soil free of rocks for straight roots — work bed to 12-18 inches. Frost improves flavor. Pretty purple flowers if left to bolt in second year. Roots store well in ground through winter.",
