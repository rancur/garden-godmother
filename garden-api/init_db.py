...
PLANTS = [
    ...
    },
    {
        ...
        "notes": "Pistacia vera — one of the most desert-adapted nut trees on earth, originating in Iranian/Central Asian deserts. Tolerates 120F summers, alkaline/saline soils, and prolonged drought once established (taproot 30+ ft). Dioecious: needs at least one male (Peters) per 8-10 females (Kerman, Golden Hills, Lost Hills). Requires 600-1000 chill hours — borderline for low desert; choose Kerman or Aleppo for warmer zones. Bears in 5-7 years, full production at 15-20. Alternate-bearing tendency. Hull splits and shells crack open on tree when ripe. No pesticides typically needed in dry desert air (avoids navel orangeworm humidity issues).",
        "companions": ["Pomegranate", "Olive", "Fig", "Lavender"],
        "antagonists": [],
    },
    {
        "name": "Cucamelon",
        ...
        "desert_transplant": ["03-01", "05-01"],
        "desert_harvest": ["05-01", "10-31"],
        "notes": "Melothria scabra — also called Mexican Sour Gherkin or Mouse Melon. Native to Mexico/Central America, naturally heat- and drought-tolerant. Produces grape-sized cucumber-lookalike fruits with citrusy tang. Slow to germinate (10-14 days, soak seed overnight). Vigorous vine — trellis 6+ ft. Tuberous root can overwinter and resprout in mild winters; mulch heavily. More heat-resistant than true cucumber, sets fruit through summer if shaded afternoon. Fruit eaten raw, pickled, or in salads. Lightly self-seeds.",
        "companions": ["Bean", "Corn", "Sunflower", "Marigold", "Nasturtium", "Radish"],
    ...
    },
    {
        ...
        "notes": "Rumex scutatus / R. acetosa — perennial sour-lemon green used in soups (sorrel soup), sauces, omelets. Treat as a cool-season annual or shaded perennial in low desert: goes summer-dormant or dies back above 100F. Plant under afternoon shade, use heavy mulch, cut back hard before summer; often resprouts in fall. Cut flower stalks immediately to prolong leaf production. High oxalate — eat in moderation. Tolerates clay if drainage is decent. Cold-hardy to 10F.",
        "companions": ["Strawberry", "Mint", "Parsley", "Chive"],
        "antagonists": [],
    },
    {
        "name": "Anise Hyssop",
        ...
        "desert_seasons": ["cool", "warm"],
        "sow_indoor_weeks_before_transplant": 8,
        "desert_sow_outdoor": ["10-01", "03-01"],
        "desert_transplant": ["10-15", "03-15"],
        "desert_harvest": ["04-01", "10-31"],
        "notes": "Agastache foeniculum — North American native perennial in the mint family, anise-licorice scented leaves and lavender flower spikes. Top-tier pollinator plant: bees, hummingbirds, butterflies. Drought tolerant once established; rot-prone in poorly drained soil. Hardy to -30F, but in low desert appreciates morning sun / afternoon shade through July-August. Leaves for tea, salads, baked goods; flowers edible. Self-seeds; deadhead to extend bloom. Cold stratify seed 30 days for best germination. Companion to vegetables for pollinator draw.",
        "companions": ["Tomato", "Pepper", "Squash (Summer)", "Cucumber", "Echinacea", "Yarrow"],
        "antagonists": [],
    },
    {
        "name": "Desert Willow",
        ...
        "desert_harvest": None,
        "notes": "Chilopsis linearis — Sonoran/Chihuahuan Desert native small tree, not a true willow. Trumpet-shaped pink/burgundy/white flowers May through October attract hummingbirds and native bees. Cold-hardy to 0F, heat-proof to 115F+, fully drought-tolerant once established (water deeply 1-2x/month after first year). Fast grower to 15-25 ft; multi-trunk natural form, prune to single trunk for shade tree. Excellent pollinator/shade companion in food forests and desert hedgerows. Cultivars: 'Bubba', 'Burgundy Lace', 'Art's Seedless' (no messy seedpods), 'Timeless Beauty'. Drops leaves in winter.",
        "companions": ["Penstemon", "Salvia", "Globe Mallow", "Brittlebush"],
        "antagonists": [],
    },
    {
        "name": "Autumn Sage",
    ...
    },
    {
        ...
        "desert_transplant": ["09-15", "11-15"],
        "desert_harvest": ["12-15", "04-15"],
        "notes": "Cynara cardunculus — Mediterranean perennial relative of artichoke grown for tender blanched leaf stalks rather than flower buds. Mild artichoke flavor; staple of Italian/Spanish cuisine (cardi alla parmigiana, gratin). In Zone 9b/10a treat as fall-planted annual or short-lived perennial; goes dormant in summer heat. Blanch stalks 3-4 weeks before harvest by wrapping in cardboard or tying outer leaves to interior. Hardy to 20F. Drought tolerant once established. Spectacular silver foliage and 6 ft purple thistle flowers if allowed to bloom — strong pollinator draw. Considered invasive in California; deadhead before seed set.",
        "companions": ["Pea", "Bean (Bush)", "Sunflower", "Tarragon"],
        "antagonists": [],
    },
]
