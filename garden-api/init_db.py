...
PLANTS = [
    ...
    # ── NEW PLANTS (research run 2026-06-02 r3) ──
    {
        'name': 'Safflower',
        'category': 'grain',
        'subcategory': 'oilseed',
        ...
        'desert_seasons': ['cool'],
        'sow_indoor_weeks_before_transplant': 0,
        'desert_sow_outdoor': ['11-01', '01-31'],
        'desert_transplant': None,
        'desert_harvest': ['05-01', '06-30'],
        'notes': "Carthamus tinctorius — thistle-like annual oilseed grown commercially across Arizona and California for its 32-40% seed oil. An extremely long taproot reaches deep moisture, making it one of the best dryland desert crops; it tolerates drought, heat, salinity and poor soil. Prefers cool temperatures for germination and tolerates light frost, so in the low desert it is a cool-season crop: direct-sow late fall through winter and harvest as the heads dry in late spring. Do not overwater — it dislikes waterlogging and humidity (rosette-stage crown rot). Spiny types deter birds; spineless types are easier to handle. Petals also yield a saffron-substitute dye.",
        'companions': ['Onion', 'Garlic', 'Sunflower'],
        'antagonists': [],
    },
    {
        'name': 'Goumi Berry',
        ...
        'sow_indoor_weeks_before_transplant': 0,
        'desert_sow_outdoor': None,
        'desert_transplant': ['01-15', '03-01'],
        'desert_harvest': ['05-01', '06-15'],
        'notes': "Elaeagnus multiflora — a nitrogen-fixing deciduous shrub (6-10 ft) in the oleaster family bearing speckled scarlet, blueberry-sized tart-sweet drupes in late spring. Hardy USDA 4-9, so the low desert (9b) sits at the warm edge: give afternoon shade and consistent moisture through fruit set, and expect best results in cooler microclimates. As a nitrogen fixer it enriches soil for neighboring plants and is largely pest- and disease-free. Self-fertile, but a second variety boosts yield and fruit size. Fruit is high in lycopene; eat fresh once fully red (under-ripe fruit is astringent) or make into jam.",
        'companions': ['Apple', 'Pomegranate', 'Fig', 'Grape'],
        'antagonists': [],
    },
    {
        'name': 'Marama Bean',
        ...
        'desert_transplant': None,
        'desert_harvest': ['09-01', '11-30'],
        'notes': "Tylosema esculentum (morama/marama bean) — a long-lived perennial tuberous legume native to the Kalahari Desert, adapted to extreme heat (daily highs ~37C/100F), deep sands, and 100-900 mm rainfall. Sprawling vines die back in winter while a large perennial tuber (which stores water) persists; experimental U.S. cultivation has succeeded in Texas. Grown for protein- and oil-rich seeds (29-39% protein, 24-48% oil) that roast to a chestnut/cashew flavor, plus an edible sweet-potato-like tuber best dug from 1-2 year-old plants before it turns fibrous. Note: marama is non-nodulating and does not fix nitrogen in the usual way. Soak and scarify the hard seed; needs deep sandy soil and full sun. Frost kills the vines but an established tuber resists mild cold.",
        'companions': ['Sorghum', 'Pearl Millet', 'Tepary Bean'],
        'antagonists': [],
    },
    {
        'name': 'Indian Jujube',
        ...
        'desert_transplant': ['03-01', '05-01'],
        'desert_harvest': ['11-01', '02-28'],
        'notes': "Ziziphus mauritiana (ber / Indian jujube / desert apple) — an evergreen thorny fruit tree of the arid tropics, distinct from the deciduous Chinese jujube (Z. jujuba) already in the database. A deep taproot and tough constitution let it thrive on low rainfall (250-1000 mm), high heat, wind, alkaline and even slightly waterlogged soils — India grows over half the world's crop in its arid zones. Bears crisp, sweet apple-like fruits that ripen through the cool months. The main caution for the low desert is cold: it is frost-sensitive, so site young trees in a warm microclimate and protect from hard freezes; mature trees tolerate brief light frost. Prune after harvest; fruits on current-season growth. Grafted trees fruit in 2-3 years.",
        'companions': ['Pomegranate', 'Fig', 'Date Palm'],
        'antagonists': [],
    },
    {
        'name': 'Finger Millet',
        ...
        'desert_sow_outdoor': ['03-15', '08-15'],
        'desert_transplant': None,
        'desert_harvest': ['07-01', '11-30'],
        'notes': "Eleusine coracana (ragi / finger millet) — a hardy warm-season cereal from the African/Indian semi-arid tropics, tolerant of drought, heat, salinity and low fertility with few pests or diseases. The grain stores exceptionally well and is among the most calcium- and iron-rich cereals. Direct-sow into warm soil after frost or for a monsoon crop; needs full sun and only modest water. Harvest the finger-like seed heads as they turn brown, then dry and thresh. A reliable low-input grain for the low desert; also good forage.",
        'companions': ['Cowpea', 'Pigeon Pea', 'Pearl Millet'],
        'antagonists': [],
    },
    {
        'name': 'Aibika',
        ...
        'sow_indoor_weeks_before_transplant': 4,
        'desert_sow_outdoor': ['03-15', '07-31'],
        'desert_transplant': ['04-01', '08-15'],
        'desert_harvest': ['05-15', '11-15'],
        'notes': "Abelmoschus manihot (aibika / edible hibiscus / sunset muskmallow) — a fast-growing tropical perennial in the okra family, grown as a warm-season annual for its tender, mildly mucilaginous leaves and shoots (about 12% protein) used in soups and stir-fries. Reaches 4-10 ft in a season with large pale-yellow dark-eyed flowers. Loves heat (best 60-85F) but prefers humidity, so in the low desert it does best in the monsoon season or with afternoon shade and steady irrigation. Pinch tips for bushy cut-and-come-again harvests. Propagate easily from cuttings. Frost-tender — treat as annual.",
        'companions': ['Okra', 'Basil', 'Roselle', 'Sweet Potato'],
        'antagonists': [],
    },
    {
        'name': 'Nigella',
        ...
        'desert_seasons': ['cool'],
        'sow_indoor_weeks_before_transplant': 0,
        'desert_sow_outdoor': ['10-01', '01-15'],
        'desert_transplant': None,
        'desert_harvest': ['04-01', '05-31'],
        'notes': "Nigella sativa (black cumin / kalonji / black seed) — an annual spice in the buttercup family grown for its peppery, oregano-meets-onion seeds used across Middle Eastern and South Asian cooking. Thrives with cool winters and warm dry summers, so in the low desert it is an autumn-sown cool-season crop: direct-sow in place (it resents transplanting) from fall through midwinter and harvest as the inflated seed pods dry in spring. Drought-tolerant in well-drained sandy/loamy soil but quickly rots if waterlogged. Full sun. Let a few pods self-seed for next year. Do not confuse with culinary cumin (Cuminum cyminum).",
        'companions': ['Cilantro', 'Dill', 'Fennel'],
        'antagonists': [],
    },
]
...
def init_db():
    ...
    VARIETIES = [
        ...
        # ── NEW DESERT VARIETIES (research run 2026-06-02 r3) ──
        ('Goumi Berry', 'Sweet Scarlet', 'Heavy-yielding goumi selected in Kiev for large, sweet, tasty red fruit.', 730, 1095, 'moderate', 'pest- and disease-resistant', 'sweet-tart, cherry-like', '6-8 ft shrub', 'speckled scarlet fruit', 'deciduous N-fixing shrub', 4, 'The sweetest, largest-fruited goumi and the easiest fresh-eating type; ripens a couple weeks after Red Gem. Self-fertile but yields more beside a second variety. Give afternoon shade at the low-desert (9b) warm edge.', 'onegreenworld.com; isons.com; raintreenursery.com'),
        ('Goumi Berry', 'Red Gem', 'Reliable self-fertile goumi, similar to Sweet Scarlet but ripening earlier.', 730, 1095, 'moderate', 'pest- and disease-resistant', 'sweet-tart, slightly smaller', '6-8 ft shrub', 'bright red speckled fruit', 'deciduous N-fixing shrub', 4, 'Ripens in mid-summer a few weeks before Sweet Scarlet, extending the goumi season; a good pollination partner. Nitrogen-fixing; tolerant of poor soil and drought once established.', 'isons.com; greatescapefarms.com; treepeony.com'),
    ]
