...
PLANTS = [
    ...
    },
    {
        ...
        "desert_sow_outdoor": ["02-15", "04-15"],
        "desert_transplant": ["03-01", "05-01"],
        "desert_harvest": ["05-01", "10-15"],
        "notes": "Melothria scabra — mouse melon or Mexican sour gherkin. Grape-sized cucumber-watermelon hybrid flavor. Vigorous climbing vine, needs trellis. Native to Mexico/Central America, thrives in Sonoran heat where standard cucumbers fail. Drought-tolerant once established. Perennial tuber can be overwintered. Eat raw, pickle, or add to salads. Slow start but produces abundantly once warm. Provide afternoon shade during 110F+ peak.",
        "companions": ["Basil", "Marigold", "Nasturtium", "Corn", "Sunflower"],
        "antagonists": ["Potato"],
    },
    {
        "name": "Buffalo Gourd",
        ...
        "desert_seasons": ["warm", "monsoon"],
        "sow_indoor_weeks_before_transplant": None,
        "desert_sow_outdoor": ["03-01", "05-01"],
        "desert_transplant": None,
        "desert_harvest": ["09-01", "11-15"],
        "notes": "Cucurbita foetidissima — native Sonoran perennial vine from massive taproot (can exceed 100 lbs). Extremely drought tolerant, needs almost no irrigation once established. Traditionally used by Indigenous Southwest peoples — seeds are edible (roasted), roots yield soap/saponins, fruits used as rattles. Fruits and foliage bitter and should not be eaten. Grow for seeds, soil stabilization, and native habitat value. Dies back in winter, resprouts from taproot.",
    ...
    },
    {
        ...
        "desert_sow_outdoor": ["09-15", "11-15"],
        "desert_transplant": ["10-01", "03-15"],
        "desert_harvest": ["03-01", "06-15"],
        "notes": "Agastache foenicum — short-lived perennial herb with licorice-scented leaves and purple bottlebrush flowers. Exceptional pollinator plant, favored by bees and hummingbirds. Leaves and flowers used in teas, salads, desserts. Needs afternoon shade in Phoenix summers and well-drained soil — root rot if overwatered. Self-seeds readily. Companion for vegetables as a pollinator attractor. Related desert-adapted Agastache rupestris (Sunset Hyssop) handles heat better.",
        "companions": ["Tomato", "Pepper", "Squash (Summer)", "Melon", "Marigold"],
        "antagonists": [],
    },
    {
        "name": "Finger Lime",
        ...
        "desert_harvest": ["09-15", "01-31"],
        "notes": "Citrus australasica — Australian rainforest citrus with cylindrical fruit containing 'caviar' pearls. Thorny evergreen shrub/small tree. Marginally hardy in zone 9b — cover below 28F. Prefers afternoon shade in Phoenix (leaves scorch above 110F in full sun). Slow growing, best grown in containers so it can be moved. Acidic, free-draining soil. Fruit prized by chefs. Self-fertile. Less cold-tolerant than standard citrus — avoid unprotected planting in colder Phoenix microclimates.",
        "companions": ["Nasturtium", "Basil", "Marigold"],
        "antagonists": [],
    },
    {
        "name": "Calamondin",
        ...
        "desert_transplant": ["02-15", "04-15"],
        "desert_harvest": ["10-01", "03-31"],
        "notes": "Citrus × microcarpa — Philippine lime (calamansi). Small ornamental citrus, prolific year-round bearer of tart orange fruit. Excellent for containers and tolerates Phoenix heat with occasional deep watering. Cold-tolerant to about 25F — protect from hard freezes. Juice used in Filipino/Southeast Asian cuisine, marmalade, drinks. Flowers continuously, beautiful fragrant white blossoms. Self-fertile, dwarfing rootstocks available. One of the most reliable patio citrus for low desert.",
        "companions": ["Nasturtium", "Basil", "Marigold", "Borage"],
        "antagonists": [],
    },
    {
        "name": "Quinoa",
        ...
        "notes": "Chenopodium quinoa — Andean pseudocereal. In low desert, treat as cool-season crop: sow fall/early winter for spring harvest before 95F+ heat arrives (pollen sterilizes above 95F). Direct sow 0.25\" deep. Drought and salt tolerant. Leaves edible like spinach when young. Seeds must be rinsed to remove bitter saponins. Short-day and heat-sensitive varieties do best — try 'Cherry Vanilla' or 'Brightest Brilliant Rainbow'. Hard to grow in summer; cool-season only in Phoenix.",
        "companions": ["Corn", "Bean (Bush)", "Amaranth"],
        "antagonists": [],
    },
    {
        "name": "French Sorrel",
        ...
        "notes": "Rumex scutatus — perennial lemony-tart leafy green used in French soups and sauces. Cool-season crop in desert: grows fall through spring, dies back or goes dormant in summer heat. Needs afternoon shade and moist soil. Cut flower stalks to prolong leaf production. Will re-emerge from taproot in fall if mulched heavily to protect through summer. High in oxalic acid — eat in moderation. More heat tolerant than standard garden sorrel (Rumex acetosa).",
