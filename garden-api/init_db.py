...
PLANTS = [
    ...
    },
    {
        ...
        "desert_transplant": None,
        "desert_harvest": ["03-15", "06-30"],
        "notes": "Chenopodium giganteum — relative of lambsquarters and quinoa with brilliant magenta-pink new growth that's both edible and ornamental. More heat-tolerant than spinach or chard. Reaches 4-6 feet tall. Use young leaves and shoots like spinach — milder flavor than lambsquarters. Direct sow shallowly; needs light to germinate. Self-seeds aggressively once established — deadhead to prevent volunteers. Drought-tolerant once established. Bolts in extreme heat but remains palatable longer than most greens.",
    ...
    },
    {
        ...
        "desert_harvest": ["11-01", "03-31"],
        "notes": "Annona cherimola — subtropical fruit Mark Twain called 'the most delicious fruit known to man.' Marginal in Phoenix — needs afternoon shade and consistent water; bark damage common in summer above 105°F. Plant on east side of structure for morning sun, afternoon shade. Hand-pollination dramatically improves fruit set (flowers protogynous — female phase first, then male). Collect male pollen at dusk, brush onto receptive female flowers next morning. Frost-tender below 27°F — protect young trees. Self-fertile but better with two trees. Grafted trees fruit in 3-5 years; seedlings 5-7. Pick when slightly soft; ripen on counter.",
