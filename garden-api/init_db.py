...
PLANTS = [
    ...
    # ── ADDED 2026-06-01 (r4): extension-grounded heat/desert edibles (zone 9b/10a low desert) ──
    {
        "name": "Moth Bean",
        "category": "vegetable",
        "subcategory": "legume",
    ...
    },
    {
        ...
        "desert_sow_outdoor": ["03-15", "05-15"],
        "desert_transplant": None,
        "desert_harvest": ["10-15", "12-01"],
        "notes": "MARGINAL / trial-only in Phoenix (Psophocarpus tetragonolobus). Most cultivars are short-day plants — flowering won't start until days shorten (~Sep), and the long-season vine then races the ~Dec 11 frost, so reliable pod set is doubtful. It's also a humid-tropics crop stressed by low-desert aridity. Will likely grow leafy all summer with poor pod yield unless you source a DAY-NEUTRAL cultivar and give it a strong trellis, afternoon shade, and steady water. Nearly the whole plant is edible — young pods (asparagus-like), seeds (~20%+ protein), leaves, flowers, and protein-rich tubers. Frost-killed annual here.",
        "companions": ["Corn", "Squash (Summer)", "Sorghum"],
        "antagonists": ["Onion", "Garlic", "Garlic Chives", "Egyptian Walking Onion"],
    },
    {
        "name": "Winter Melon",
    ...
    },
    {
        ...
        "desert_transplant": None,
        "desert_harvest": ["10-15", "04-15"],
        "notes": "A COOL-SEASON green in the low desert despite being marketed as 'summer spinach' (Atriplex hortensis) — it bolts fast in sustained 100F+ heat, so grow it Sep-Mar like chard/spinach, not in summer. More heat- and drought-tolerant than true spinach and, as a saltbush relative, tolerates alkaline/saline desert soils. Pinch growing tips to delay bolting and encourage branching. Self-seeds readily — deadhead if you don't want volunteers. Red/ruby types are ornamental-edible. Young leaves raw or cooked like spinach; mild, faintly salty.",
        "companions": ["Beet", "Lettuce", "Radish", "Bean (Bush)"],
        "antagonists": [],
    },
    {
        ...
        "desert_harvest": ["11-01", "05-01"],
        "notes": "Hardy perennial allium (Allium x proliferum) grown from topset bulbils, not seed. Plant bulbils in fall so they establish through the mild winter and spring; expect SUMMER DORMANCY in Phoenix — tops die back in peak heat and regrow in fall, so give afternoon/dappled shade and a little water in May-June to carry it through. It 'walks' by rooting its top bulbils, spreading steadily but easy to control by harvesting. Eat green tops (scallion use), small basal bulbs, and the topset bulbils (pickle or replant). Pungency rises with heat.",
        "companions": ["Carrot", "Tomato", "Cabbage", "Broccoli", "Beet"],
        "antagonists": ["Bean (Bush)", "Pea", "Moth Bean", "Winged Bean"],
    },
    {
        "name": "Garlic Chives",
        "category": "herb",
        ...
        "desert_sow_outdoor": None,
        "desert_transplant": ["09-15", "11-15"],
        "desert_harvest": ["10-01", "05-31"],
        "notes": "Tough, heat- and drought-tolerant perennial allium (Allium tuberosum) that establishes well and returns reliably; slow from seed (start indoors or buy clumps). Most productive in cool spring and fall; goes semi-dormant in peak summer heat and again in deep winter — afternoon shade helps. MAIN CAUTION: an aggressive self-seeder that can naturalize — cut the white late-summer flower stalks before seed set to prevent rampant volunteers, and divide clumps every ~3 years. Flat garlic-onion leaves, edible flower buds/scapes, and flowers used heavily in Chinese cooking (dumplings, jiucai stir-fries).",
        "companions": ["Carrot", "Tomato", "Grape", "Apple", "Rose"],
...
def init_db():
    ...
    VARIETIES = [
        ...
        # ── ADDED 2026-06-01 (r4): extension-grounded desert varieties ──
        ("Watermelon", "Charleston Gray", "USDA-bred oblong watermelon with gray-green rind, 25-35 lb, and strong disease resistance.", 85, 100, "high", "fusarium wilt & anthracnose resistant", "sweet, crisp, classic", "25-35 lb oblong fruit", "gray-green rind, red flesh", "vigorous vining", 5, "Bred by USDA (Charleston, SC) for heat, drought, and disease tolerance; long-season but a dependable big melon in low-desert summers with steady irrigation.", "aggie-horticulture.tamu.edu; bonnieplants.com"),
