...
PLANTS = [
    ...
    },
    {
        ...
        "desert_transplant": ["02-15", "03-31"],
        "desert_harvest": ["05-01", "11-30"],
        "notes": "Solanum muricatum — Andean fruiting nightshade. Striped, melon-flavored fruit on a sprawling shrub. Propagate from cuttings (much faster than seed). Needs afternoon shade in low desert; mulch heavily and protect from frost. Treat as tender perennial in zones 9b+. Drip irrigation works well; avoid overhead watering. Self-fertile but fruit set improves with bees. Plants live 3-4 years.",
    ...
    },
    {
        ...
        "category": "fruit",
        "subcategory": "ground cherry relative",
        "days_to_maturity_min": 75,
        "days_to_maturity_max": 100,
        "spacing_inches": 30,
        "sun": "full",
        ...
        "desert_transplant": ["02-15", "03-31"],
        "desert_harvest": ["06-01", "11-15"],
        "notes": "Physalis peruviana — also called goldenberry or poha. Husked golden fruit with sweet-tart pineapple flavor. More vigorous and larger than ground cherry. Tolerates desert heat better than tomatoes; provide afternoon shade in July-August. Self-seeds aggressively. Fruit ripens when husk turns papery and drops. Short-lived perennial in zones 9b-10. Stake or cage — sprawling habit.",
    ...
    },
    {
        ...
        "desert_seasons": ["cool"],
        "sow_indoor_weeks_before_transplant": None,
        "desert_sow_outdoor": ["10-01", "11-15"],
        "desert_transplant": None,
        "desert_harvest": ["02-15", "04-30"],
        "notes": "Chenopodium quinoa — Andean pseudocereal in the amaranth family. Heat above 95F during flowering causes pollen sterility, so grow as a winter crop in low desert (sow fall, harvest spring). Cherry Vanilla, Brightest Brilliant Rainbow, and Cochabamba are heat-tolerant varieties. Rinse seeds thoroughly after threshing to remove bitter saponins. Edible greens before flowering. Drought tolerant once established.",
        "companions": ["Bean (Bush)", "Corn", "Squash (Summer)"],
        "antagonists": ["Spinach", "Beet"],
    },
    {
        "name": "Sorrel",
        "category": "herb",
        "subcategory": "leafy perennial",
        "days_to_maturity_min": 55,
        "days_to_maturity_max": 90,
        "spacing_inches": 12,
        "sun": "partial",
        ...
        "desert_transplant": ["10-01", "12-31"],
        "desert_harvest": ["11-01", "04-30"],
        "notes": "Rumex acetosa (common) or Rumex scutatus (French). Tart, lemony leaves for soups, salads, sauces. Grow as a winter crop in low desert — goes dormant or dies back in summer heat. Provide afternoon shade and heavy mulch to perennialize. Cut flower stalks to keep leaves tender. Red-veined sorrel is more ornamental. Pick young leaves; older leaves get oxalic-acid-bitter.",
    ...
    },
    {
        ...
        "notes": "Allium tuberosum — also called Chinese chives or nira. Flat, garlic-flavored leaves used in Asian cooking. White star flowers attract pollinators and are edible. Far more heat-tolerant than common chives and reliably perennial in low desert with afternoon shade in summer. Divides easily; clumps thicken over years. Reseeds — remove spent flowers if you don't want volunteers.",
        "companions": ["Carrot", "Tomato", "Strawberry", "Rose"],
        "antagonists": ["Bean (Bush)", "Pea"],
    },
    {
        "name": "Anise Hyssop",
        "category": "herb",
        "subcategory": "pollinator perennial",
        "days_to_maturity_min": 90,
        "days_to_maturity_max": 120,
        "spacing_inches": 18,
        "sun": "full to partial",
        ...
        "desert_transplant": ["03-01", "04-15"],
        "desert_harvest": ["05-01", "10-31"],
        "notes": "Agastache foeniculum — licorice-anise-scented mint relative. Lavender flower spikes are a magnet for bees and hummingbirds. Drought-tolerant once established; needs afternoon shade in low desert. Leaves and flowers used for tea, salads, garnish. Self-seeds prolifically. Short-lived perennial (3-4 years) but reliably returns from seed. Cut back hard after first bloom for second flush.",
        "companions": ["Tomato", "Pepper", "Squash (Summer)", "Cucumber"],
        "antagonists": [],
    },
    {
        "name": "Lentil",
    ...
    },
    {
        "name": "Mache",
        "category": "vegetable",
        "subcategory": "winter salad green",
        "days_to_maturity_min": 45,
        "days_to_maturity_max": 70,
        "spacing_inches": 4,
        "sun": "partial",
        ...
        "notes": "Valerianella locusta — also called corn salad or lamb's lettuce. Nutty rosette green for winter salads. One of the most cold-hardy greens; thrives in low-desert winter where lettuce sometimes burns. Sow thickly and harvest whole rosettes. Bolts in late spring as days warm. Self-seeds if allowed to flower. Slow to germinate — pre-soak seed and keep soil cool.",
        "companions": ["Strawberry", "Carrot", "Onion"],
        "antagonists": [],
    },
]
