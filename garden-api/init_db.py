...
PLANTS = [
    ...
    },
    {
        ...
        "notes": "Citrus maxima — largest of the citrus fruits, ancestor of grapefruit. Sweeter and less bitter than grapefruit. Thrives in low desert heat (zone 9b/10a). Hardy to about 28°F when established. Plant on north/east side of yard with afternoon shade for first 2 years to prevent sunburn — whitewash trunks. Slow to bear (4-6 years from grafted nursery stock). Deep, infrequent watering once established. 'Chandler' and 'Reinking' varieties do well in AZ. Drops fruit in extreme heat if water-stressed.",
        "companions": ["Marigold", "Nasturtium", "Borage", "Comfrey"],
        "antagonists": [],
    },
    {
        "name": "Sour Orange",
        ...
        "notes": "Citrus aurantium — bitter/Seville orange. Iconic Phoenix street tree, extremely heat and drought tolerant. Hardy to ~22°F. Highly aromatic blossoms used in orange blossom water, neroli oil. Fruit too sour to eat fresh — used for marmalade, sauces, marinades, cocktails (Old Fashioned twist), Persian cuisine. Common rootstock for other citrus (resistant to root rot, gummosis). Tolerates alkaline desert soil better than sweet orange. Flowers Feb-Apr — major bee forage.",
        "companions": ["Marigold", "Nasturtium", "Comfrey", "Borage"],
        "antagonists": [],
    },
    {
        "name": "Cardoon",
        ...
        "sow_indoor_weeks_before_transplant": 6,
        "desert_sow_outdoor": ["09-15", "11-15"],
        "desert_transplant": ["10-15", "12-15"],
        "desert_harvest": ["02-01", "04-15"],
        "notes": "Cynara cardunculus — Mediterranean relative of artichoke grown for blanched leaf stems, not flower buds. Drought-tolerant once established. Plant in fall for winter/spring harvest before summer heat. Blanch stems by wrapping with cardboard or burlap for 3-4 weeks before harvest to remove bitterness. Striking silver-gray architectural foliage 4-6 ft tall. Perennial in mild winters but often grown as annual. Used in Italian (cardi) and Spanish cooking. Goes dormant or dies in extreme summer heat — replant from seed in fall.",
        "companions": ["Pea", "Sunflower", "Tarragon"],
        "antagonists": [],
    },
    {
        "name": "Yacon",
        ...
        "notes": "Smallanthus sonchifolius — Andean root crop also called 'Peruvian ground apple'. Sweet, crisp tubers eaten raw like jicama or apple — high in inulin (prebiotic, low glycemic). Plants reach 5-7 ft, look like sunflowers. Plant divisions/rhizomes after frost. Needs afternoon shade in low desert summer. Mulch heavily. Harvest after first frost or when tops die back. Cure tubers in sun for 1-2 weeks to develop sweetness. Grows surprisingly well in desert with shade and consistent water — top-rated by Tucson Backyard Gardener network.",
        "companions": ["Bean", "Corn", "Sunflower"],
        "antagonists": [],
    },
    {
        "name": "Anise Hyssop",
        ...
        "desert_transplant": ["10-01", "03-31"],
        "desert_harvest": ["04-01", "10-31"],
        "notes": "Agastache foeniculum — perennial mint-family herb with anise-licorice scented leaves. Top pollinator plant — magnet for bees, hummingbirds, butterflies. Drought-tolerant once established. Tall purple flower spikes June-Sept. Leaves used in tea, salads, baked goods. Tolerates alkaline desert soil. Cut back hard in late winter. Self-seeds. Companion to fruit trees and vegetables — boosts pollination of nearby crops. Several Agastache species (A. cana, A. rupestris) are AZ natives even better adapted to extreme heat.",
    ...
    },
    {
        ...
        "desert_transplant": None,
        "desert_harvest": ["05-15", "07-31"],
        "notes": "Phaseolus lunatus — heat-loving legume more tolerant of extreme heat than common beans. Pole types (Christmas, King of the Garden, Sieva) outyield bush types and benefit from afternoon shade trellising. Direct sow when soil is 70°F+. Light water once flowering. Nitrogen-fixer. Harvest pods when seeds fully formed but still tender. Some heirloom desert-adapted strains (Hopi White) tolerate 110°F+. Avoid planting in monsoon humidity (rust risk).",
        "companions": ["Corn", "Squash (Summer)", "Cucumber", "Marigold", "Sunflower"],
    ...
    },
    {
        ...
        "desert_transplant": None,
        "desert_harvest": ["01-15", "04-15"],
        "notes": "Tragopogon porrifolius — also called 'oyster plant' for the mild oyster-like flavor of the roots. Long, slender taproot (8-12 in). Plant in fall in deep, loose, rock-free soil. Direct sow only — taproot resents transplanting. Cold actually improves flavor. Frost-hardy. Harvest after frost through early spring. Roots can stay in ground through winter. Young leaves edible in salads. Lovely purple flowers if left to bolt in spring.",
        "companions": ["Carrot", "Beet", "Onion", "Lettuce"],
        "antagonists": [],
    },
    {
        "name": "Texas Sage",
        ...
        "desert_transplant": ["10-01", "03-31"],
        "desert_harvest": None,
        "notes": "Leucophyllum frutescens — also called 'Cenizo' or 'Barometer Bush'. Iconic Sonoran/Chihuahuan native. Silver-gray foliage with magenta-purple flower flushes after summer humidity/monsoon rain. Extremely drought tolerant once established — overwatering kills it. Hardy to 5°F. Tolerates highly alkaline soil. Excellent pollinator plant for bees. Cultivars: 'Compacta' (3-4 ft), 'Green Cloud' (green leaves), 'White Cloud' (white flowers), 'Heavenly Cloud' (deep purple). Avoid pruning into formal shapes — kills the plant; let it grow naturally.",
        "companions": [],
        "antagonists": [],
    },
    {
        ...
        "desert_transplant": ["10-01", "03-31"],
        "desert_harvest": None,
        "notes": "Chilopsis linearis — Sonoran/Chihuahuan native small tree (15-30 ft). Not a true willow — bignonia family. Trumpet-shaped pink to burgundy flowers May-October — premier hummingbird plant. Tolerates 115°F and -10°F. Deep taproot — drought-tolerant once established. Drops leaves in winter. Cultivars: 'Bubba' (sterile, more flowers), 'Burgundy' (deep wine flowers), 'Warren Jones' (vigorous). Excellent shade tree for sensitive crops (citrus understory, vegetable beds with morning sun). Fast growing. Low litter compared to mesquite.",
        "companions": ["Anise Hyssop", "Salvia Hot Lips", "Globe Mallow"],
        "antagonists": [],
    },
]
