...
PLANTS = [
    ...
    },
    {
        ...
        "desert_transplant": ["03-01", "04-30"],
        "desert_harvest": ["05-01", "11-30"],
        "notes": "Plectranthus amboinicus — also called Mexican mint, Spanish thyme, or broadleaf thyme. Thick succulent fuzzy leaves with strong oregano-thyme flavor; used in Caribbean and Latin cooking. Propagates easily from cuttings. Needs afternoon shade in peak summer; bring indoors or protect below 40F. Excellent container plant. Tolerates drought and poor soil, hates wet feet.",
        "companions": ["Basil", "Rosemary", "Thyme", "Oregano"],
        "antagonists": [],
    },
    {
        "name": "Garlic Chives",
    ...
    },
    {
        ...
        "notes": "Rumex scutatus — tangy lemony perennial green used in soups (classic schav/sorrel soup), sauces, and salads. Prefers cool weather; goes dormant or bolts in desert summer heat — provide afternoon shade and mulch heavily to extend season. Cut flower stalks to keep leaves tender. Contains oxalic acid — eat in moderation. Perennial in zones 4-9; may behave as cool-season annual at 10a.",
    ...
    },
    {
        ...
        "desert_harvest": ["03-01", "05-15"],
        "notes": "Cynara cardunculus — artichoke relative grown for blanched edible leaf stalks, a Mediterranean winter vegetable. Silvery architectural foliage doubles as ornamental. Blanch stalks by tying and wrapping 3-4 weeks before harvest. Well-suited to low desert winters; mulch for occasional frost. Thistle flowers attract bees and can be used as vegetarian rennet. Perennial but often grown as annual.",
        "companions": ["Pea", "Fava Bean", "Sunflower"],
        "antagonists": [],
    },
    {
        "name": "Yacon",
