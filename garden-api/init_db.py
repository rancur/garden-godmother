...
PLANTS = [
    ...
    },
    {
        ...
        "desert_transplant": ["03-15", "05-01"],
        "desert_harvest": ["05-15", "10-15"],
        "notes": "Melothria scabra — Mexican Sour Gherkin / mouse melon. Grape-sized cucumber-like fruits with citrus tang. Native to Mexico/Central America, far more heat- and drought-tolerant than true cucumbers. Slow to start but produces heavily once vines establish; can crop through monsoon. Vigorous climber, give 5-6 ft trellis. Forms a tuberous root that can be overwintered for an earlier crop next year. Resistant to most cucumber pests.",
    ...
    },
    {
        ...
        "desert_rating": 3,
        "notes": "Smallanthus sonchifolius — Andean perennial in the sunflower family. Sweet, crisp tubers eaten raw like apple-pear or juiced; rich in fructooligosaccharides (prebiotic, low glycemic). Grown from rhizome divisions, not seed. In desert: needs afternoon shade and consistent water, mulch heavily to keep root zone cool. Frost kills tops but rhizomes survive most 9b winters if mulched. Harvest tubers after first cool nights to maximize sweetness. Plants can reach 6-7 ft.",
        "companions": ["Bean", "Corn", "Squash (Summer)", "Sunflower"],
        "antagonists": [],
    },
    {
        "name": "French Sorrel",
        ...
        "desert_rating": 3,
        "notes": "Rumex scutatus — shield-leaf sorrel, milder and more refined than garden sorrel. Lemony oxalic-acid tang for soups (classic sorrel soup), sauces for fish, salads. Perennial in Zone 9b if given afternoon shade and mulch; treat as cool-season annual in the lowest desert. Bolts and goes bitter above 90F — cut back hard and let it regrow in fall. Cut flower stalks to prolong leaf production. Self-sows freely.",
        "companions": ["Strawberry", "Mint", "Lettuce"],
        "antagonists": [],
    },
    {
        "name": "Anise Hyssop",
        ...
        "desert_rating": 4,
        "notes": "Agastache foeniculum — drought-tolerant mint-family perennial with licorice-anise scented leaves and purple flower spikes. Among the top pollinator plants for Sonoran gardens; covered in bees and hummingbirds spring through fall. Leaves used fresh in salads, teas, with fruit; dried for tea. Tolerates poor soil; rots in heavy clay if overwatered. Provide afternoon shade in lowest desert. Cut back by 1/3 mid-summer for fresh flush.",
        "companions": ["Tomato", "Pepper", "Squash (Summer)", "Bean"],
        "antagonists": [],
    },
    {
        "name": "Cardoon",
        ...
        "desert_harvest": ["02-01", "04-30"],
        "desert_rating": 3,
        "notes": "Cynara cardunculus — close relative of artichoke grown for its blanched leaf stalks, not flower buds. Classic in Italian and Provençal cooking (cardi alla parmigiana, bagna cauda). In desert: treat as fall-planted cool-season crop; harvest stems before peak heat. Blanch by wrapping stalks with cardboard or burlap 3-4 weeks before harvest to remove bitterness. Architectural silvery foliage; flowers attract beneficials if left to bloom. Can be perennial in mild winters but usually best replanted each year in low desert.",
        "companions": ["Pea", "Bean", "Cabbage"],
        "antagonists": [],
    },
    {
        ...
        "desert_harvest": ["06-01", "11-15"],
        "desert_rating": 4,
        "notes": "Physalis peruviana — also called Peruvian groundcherry, goldenberry, or poha. Larger and more tart-sweet than common ground cherry. Sprawling 3-4 ft plants with husked golden berries used fresh, in jams, dipped in chocolate, or dried like raisins. Self-fertile. Ripe fruit drops to ground in its papery husk — pick from soil daily. Heat- and drought-tolerant once established, often acts as a short-lived perennial in Zone 9b/10a. Protect from frost; mulch crown to overwinter.",
        "companions": ["Tomato", "Pepper", "Basil", "Marigold"],
        "antagonists": ["Fennel", "Brassicas"],
    },
    {
        "name": "Endive",
        ...
        "desert_harvest": ["11-15", "04-15"],
        "desert_rating": 3,
        "notes": "Cichorium endivia — frisée (curly) and escarole (broad-leaf) types. Cool-season chicory grown for slightly bitter salad greens; flavor mellows when inner leaves are blanched by tying outer leaves over the head for 7-14 days before harvest. Bolts quickly once temperatures stay above 75F. In desert plant in fall for winter/early-spring harvest. Tolerates light frost. Pairs well with citrus, anchovy, warm bacon dressings.",
        "companions": ["Carrot", "Onion", "Radish", "Lettuce"],
        "antagonists": ["Brassicas"],
    },
    {
        "name": "Pineapple Sage",
