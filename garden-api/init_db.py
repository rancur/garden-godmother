...
PLANTS = [
    ...
    },
    {
        ...
        "desert_transplant": ["03-01", "04-30"],
        "desert_harvest": ["05-15", "10-31"],
        "notes": "Melothria scabra — Mexican sour gherkin, sandita. Native to Mexico/Central America, naturally heat-adapted. Vining cucurbit producing grape-sized cucumber-watermelon hybrids with citrus-cucumber tang. Tuberous root overwinters; mulch heavily for perennial harvests. Far more pest-resistant than true cucumber; ignored by squash bugs and cucumber beetles. Trellis 6-8 ft. Slow to start but extremely productive once established. Tolerates 110F+ when watered.",
        "companions": ["Bean", "Corn", "Nasturtium", "Marigold", "Sunflower", "Radish"],
        "antagonists": ["Potato"],
    },
    {
        "name": "Cardoon",
        ...
        "desert_harvest": ["02-01", "04-30"],
        "notes": "Cynara cardunculus — Mediterranean perennial relative of globe artichoke, grown for blanched leaf stalks rather than buds. Drought-tolerant once established; deep taproot reaches subsoil moisture. Plant fall, harvest late winter to early spring before summer heat dormancy. Blanch by tying leaves and wrapping with cardboard 3-4 weeks before harvest for sweet, tender stalks. Goes dormant in extreme heat — cut back and water sparingly through summer, will regrow in fall. Striking silver foliage doubles as ornamental.",
        "companions": ["Pea", "Bean", "Cabbage", "Sunflower"],
        "antagonists": [],
    },
    {
        "name": "Endive",
        ...
        "notes": "Cichorium endivia — curly endive (frisee) and broad-leaf escarole types. Cool-season green tolerates light frost; bitterness intensifies in heat so harvest by March. Blanch heads by tying outer leaves together 2-3 weeks before harvest to sweeten the heart. More heat-tolerant than lettuce in shoulder seasons. 'Rhodos' and 'Natacha' escarole hold well in warm spells. Bolts fast above 80F. Good Caesar salad and braising green.",
        "companions": ["Carrot", "Radish", "Onion", "Beet", "Cabbage"],
        "antagonists": ["Sunflower"],
    },
    {
        "name": "Mache",
        "category": "vegetable",
        ...
        "desert_sow_outdoor": ["10-01", "01-31"],
        "desert_transplant": None,
        "desert_harvest": ["12-01", "03-15"],
        "notes": "Valerianella locusta — corn salad, lamb's lettuce. Cold-hardy European green, one of the most frost-tolerant edibles (handles 5F). Nutty mild flavor, tender rosettes harvested whole. Direct sow only; resents transplanting. Germinates best when soil drops below 70F — wait until late fall in desert. Self-seeds prolifically once allowed to flower. Bolts immediately above 75F. 'Vit' and 'Verte de Cambrai' are reliable varieties. Perfect for winter cold frames in desert.",
        "companions": ["Carrot", "Strawberry", "Onion", "Radish"],
        "antagonists": [],
    },
    {
        "name": "Winged Bean",
        ...
        "desert_transplant": ["04-01", "07-15"],
        "desert_harvest": ["07-01", "11-15"],
        "notes": "Psophocarpus tetragonolobus — tropical legume from Southeast Asia, every part edible: pods, leaves, flowers, seeds, tubers. Day-length sensitive — most varieties only flower as days shorten in late summer, so monsoon planting produces fall pods. 'Day-neutral' lines like UPS-122 set pods regardless of day length. Needs sturdy 8-ft trellis. Loves heat and humidity, thrives during monsoon. Nitrogen-fixer. Drought-sensitive when flowering — water deeply. Frost kills immediately. Try as monsoon crop after summer solstice.",
        "companions": ["Corn", "Squash (Summer)", "Sunflower", "Marigold"],
        "antagonists": ["Onion", "Garlic"],
    },
    {
        "name": "Lovage",
        ...
        "notes": "Levisticum officinale — perennial celery-flavored herb. Goes summer-dormant in low desert above 100F; cut back hard in May and it returns with fall rains. Needs afternoon shade and consistent moisture. Hollow stems can be used as straws for Bloody Marys. Leaves substitute 3:1 for celery in stocks and soups. Deep taproot — plant where it can stay 5+ years. Self-seeds. Cold-hardy to 0F so winter survives easily in Zone 9b/10a.",
        "companions": ["Bean", "Tomato", "Potato", "Asparagus"],
        "antagonists": [],
    },
    {
        "name": "Hyssop",
