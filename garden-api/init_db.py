...
PLANTS = [
    ...
    },
    {
        ...
        "desert_transplant": ["03-01", "04-15"],
        "desert_harvest": ["05-15", "10-15"],
        "notes": "Melothria scabra — Mexican sour gherkin / mouse melon. Native to Mexico and Central America, naturally suited to desert heat. Grape-sized fruits with cucumber-lime flavor. Vigorous climbing vine — needs 6ft trellis. Drought tolerant once established but produces best with regular moisture. Tuberous roots can overwinter underground in protected microclimates and resprout. Slow to germinate (2-3 weeks). Pest- and disease-resistant. Pick when firm and grape-sized for best flavor.",
        "companions": ["Marigold", "Nasturtium", "Basil", "Corn", "Sunflower"],
    ...
    },
    {
        ...
        "desert_seasons": ["cool"],
        "sow_indoor_weeks_before_transplant": 8,
        "desert_sow_outdoor": ["09-01", "10-15"],
        "desert_transplant": ["10-01", "11-15"],
        "desert_harvest": ["02-01", "04-15"],
        "notes": "Cynara cardunculus — Mediterranean cousin of the artichoke grown for its blanched leaf stalks. Drought-tolerant and well adapted to desert cool season. Plants reach 4-6ft tall and wide — give plenty of space. Blanch stalks by tying leaves together and wrapping with cardboard or burlap 3-4 weeks before harvest to reduce bitterness. Beautiful silver-grey foliage doubles as ornamental. Can act as short-lived perennial if cut back after flowering. Tap-rooted — work soil deep at planting.",
    ...
    },
    {
        ...
        "notes": "Smallanthus sonchifolius — Andean root crop with crisp, sweet tubers tasting like a cross between apple and watermelon. Stores inulin (a prebiotic fiber) rather than starch — low glycemic. Grows 5-7ft tall with sunflower-like foliage. Plant rhizome divisions after last frost. Provide afternoon shade in extreme heat. Harvest after first frost or when foliage dies back in late fall. Cure tubers in sun 3-7 days to develop full sweetness. Save rhizomes (separate from edible tubers) for replanting next spring.",
        "companions": ["Bean (Bush)", "Corn", "Sunflower", "Squash (Summer)"],
        "antagonists": [],
    },
    {
        "name": "Calamondin",
        ...
        "desert_transplant": ["02-15", "04-15"],
        "desert_harvest": ["10-01", "03-31"],
        "notes": "Citrofortunella microcarpa (calamansi) — Filipino kitchen citrus, cross between mandarin and kumquat. Very small tart-sweet fruit used in marinades, drinks, condiments. Hardier than most acid citrus, tolerates Zone 9b winters with light frost protection. Excellent container plant — can be moved under cover during hard freezes. Self-fruitful and nearly everbearing once established. Feed with citrus fertilizer 3x per year (Feb, May, Sep). Deep water weekly in summer, monthly in winter. Wash with hose periodically to control aphids.",
        "companions": ["Nasturtium", "Marigold", "Borage", "Calendula"],
        "antagonists": [],
    },
    {
        "name": "Anise Hyssop",
        ...
        "desert_sow_outdoor": ["10-01", "02-15"],
        "desert_transplant": ["10-15", "03-15"],
        "desert_harvest": ["03-01", "10-31"],
        "notes": "Agastache foeniculum — North American native mint-family herb with anise-licorice scented leaves and purple flower spikes. Drought tolerant once established. Outstanding bee, butterfly, and hummingbird plant. Short-lived perennial in desert (2-4 years) but self-seeds reliably. Leaves used in teas, salads, baked goods. Flowers are edible and beautiful in garnishes. Cut back after first bloom for repeat flowering. Provide afternoon shade in hottest exposures.",
        "companions": ["Tomato", "Pepper", "Squash (Summer)", "Cucumber", "Rose"],
        "antagonists": [],
    },
    {
        "name": "Sorrel",
        ...
        "desert_transplant": ["10-01", "02-28"],
        "desert_harvest": ["11-01", "04-30"],
        "notes": "Rumex acetosa (garden/common sorrel) and Rumex scutatus (French sorrel) — tangy lemon-flavored greens from oxalic acid content. Cool-season perennial that struggles through desert summer heat. In Zone 9b/10a treat as cool-season annual or place in deep afternoon shade and mulch heavily to push through summer. Pick young leaves for best flavor; remove flower stalks to keep leaves tender. Classic in soups, sauces, salads. High oxalates — eat in moderation.",
        "companions": ["Strawberry", "Mint", "Chive"],
        "antagonists": [],
    },
    {
        "name": "Water Spinach",
        ...
        "sow_indoor_weeks_before_transplant": 3,
        "desert_sow_outdoor": ["03-15", "08-31"],
        "desert_transplant": ["04-01", "09-15"],
        "desert_harvest": ["05-01", "10-31"],
        "notes": "Ipomoea aquatica — kang kong / ong choy / Chinese water spinach. One of the most heat-loving leafy greens in the world. Grows through midsummer when most other greens bolt. Two forms: upland (drier soil, narrow leaves) and aquatic (constant moisture, broad leaves). Needs consistent moisture and high nitrogen. Cut-and-come-again — harvest 6-8in tips every 2 weeks. Frost kills it; treat as warm-season annual. NOTE: Federal Noxious Weed in the U.S. — possession/import restricted in some states. Check Arizona Department of Agriculture before planting outdoors; container growing is generally allowed.",
    ...
    },
    {
        ...
        "desert_transplant": None,
        "desert_harvest": ["06-01", "11-15"],
        "notes": "Phaseolus lunatus — heat-loving bean far more tolerant of desert summer than common beans. Bush types (Henderson, Fordhook) mature faster; pole types (King of the Garden, Christmas) bear longer through monsoon season. Direct sow when soil reaches 65F. Drop blossoms above 95F day / 80F night — time plantings to set pods before peak summer or during monsoon cool-down. Inoculate with rhizobia for best yields. Nitrogen fixer. Soak seeds 4-6 hours before sowing for faster emergence. Harvest pods when plump but before they yellow.",
        "companions": ["Corn", "Squash (Summer)", "Cucumber", "Marigold", "Nasturtium"],
        "antagonists": ["Onion", "Garlic", "Fennel"],
    },
    {
        "name": "Tamarillo",
        ...
        "desert_transplant": ["03-01", "04-15"],
        "desert_harvest": ["12-01", "04-30"],
        "notes": "Solanum betaceum — Andean tree tomato. Short-lived (5-8 year) subtropical small tree producing egg-shaped tart-sweet fruit. Plant on east or north side of structure for afternoon shade; full desert sun scorches leaves and fruit. Brittle wood — stake young trees and shelter from wind. Frost-sensitive below 28F; protect with frost cloth or grow in large container that can move under cover. Pinch tip at 3-4ft to encourage branching above wind. Bears within 18-24 months from seed or 12 months from transplant. Heavy feeder during fruiting — apply balanced organic fertilizer monthly Apr-Sep.",
        "companions": ["Basil", "Borage", "Marigold", "Nasturtium"],
        "antagonists": ["Fennel"],
    },
]
