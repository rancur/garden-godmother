...
def init_db():
    ...
    VARIETIES = [
        ...
        ("Cowpea", "California Blackeye No. 5", "Drought-tolerant blackeye pea selected for Western production.", 60, 90, "excellent", None, "Nutty, earthy bean and tender shelling pea", "Medium pods (6-8 in)", "Cream seed with black eye", "Bush to semi-vine", 5, "One of the most dependable hot-weather legumes for Arizona-style summers.", "UC selection"),
