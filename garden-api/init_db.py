...
PLANTS = [
    ...
    },
    {
        ...
        "desert_transplant": ["03-15", "06-01"],
        "desert_harvest": ["07-01", "11-15"],
        "notes": "Climbing cactus (Hylocereus/Selenicereus spp.) that performs well in low-desert heat with afternoon protection on west exposure. Needs trellis/post support, sharp drainage, and light but regular summer irrigation.",
        "companions": ["Pomegranate", "Lemongrass", "Basil", "Marigold"],
        "antagonists": ["Watermelon", "Mint"],
    },
    {
        "name": "Pineapple Guava",
        "category": "fruit",
        "subcategory": "evergreen shrub",
        "days_to_maturity_min": 730,
        "days_to_maturity_max": 1460,
        "spacing_inches": 120,
        "sun": "full to partial",
        ...
        "notes": "Feijoa sellowiana produces aromatic fruit and edible petals. Handles heat and drought once established, but fruits best with deep watering and some afternoon shade in the hottest desert sites.",
        "companions": ["Pomegranate", "Rosemary", "Lavender", "Thyme"],
        "antagonists": ["None known"],
    },
    {
        "name": "Carob",
        "category": "fruit",
        "subcategory": "nitrogen-fixing tree",
        "days_to_maturity_min": 1825,
        ...
        "notes": "Mediterranean evergreen legume tree (Ceratonia siliqua) with exceptional drought and alkaline-soil tolerance. Best for long-term desert food-forest plantings; pods used as cocoa substitute or sweet flour.",
    ...
    },
    {
        ...
        "desert_harvest": ["05-15", "10-15"],
        "notes": "Corchorus olitorius (molokhia) is a heat-loving leafy vegetable that thrives in summer when spinach fails. Harvest young leaves repeatedly; flavor is mild and slightly mucilaginous in soups.",
    ...
    },
    {
        ...
        "notes": "Origanum majorana is a tender perennial culinary herb with sweet, floral oregano-like flavor. Performs well in desert beds and containers with excellent drainage and light afternoon shade in peak summer.",
        "companions": ["Tomato", "Pepper", "Eggplant", "Basil"],
        "antagonists": ["None known"],
    },
]
