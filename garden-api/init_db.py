...
PLANTS = [
    ...
    # ── BLACK-EYED PEA ──
        ...
        "desert_transplant": None,
        "desert_harvest": ["06-01", "10-31"],
        "notes": "Classic cowpea for desert summers. Strong pod set in high heat with less irrigation than common beans. Great fresh-shelled or dry.",
        "companions": ["Corn", "Okra", "Basil", "Marigold", "Sesame"],
        "antagonists": ["Onion", "Garlic"],
    },
    # ── BLOOD ORANGE ──
        {
    ...
    # ── GUAR BEAN ──
        ...
        "desert_transplant": None,
        "desert_harvest": ["05-15", "10-15"],
        "notes": "Cluster bean grown for tender pods and as a drought-hardy summer legume. Handles extreme heat and low water better than most beans once established.",
        "companions": ["Okra", "Sesame", "Basil", "Marigold"],
        "antagonists": ["Onion"],
    },
    # ── ICE PLANT ──
        {
    ...
    # ── MOLOKHIA ──
        ...
        "desert_harvest": ["05-15", "10-31"],
        "notes": "Corchorus olitorius (jute mallow). Extremely heat-loving leafy green that performs well through desert summer with regular harvest.",
        "companions": ["Okra", "Cowpea", "Basil", "Amaranth"],
        "antagonists": ["Lettuce"],
    },
    # ── NATAL PLUM ──
        {
