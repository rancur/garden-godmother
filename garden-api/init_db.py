...
PLANTS = [
    ...
    },
    {
        ...
        "sow_indoor_weeks_before_transplant": 8,
        "desert_sow_outdoor": ["10-01", "02-28"],
        "desert_transplant": ["11-01", "03-31"],
        "desert_harvest": ["05-15", "09-30"],
        "notes": "Lycium barbarum is a drought-tolerant berry shrub that can perform in low-desert climates with afternoon shade and mulch. Benefits from trellising for easier harvest.",
        "companions": ["Lavender", "Rosemary", "Marigold", "Chive"],
        "antagonists": ["None known"],
    },
    {
        "name": "Papalo",
    ...
    },
    {
        ...
        "desert_harvest": ["05-01", "11-30"],
        "notes": "Carissa macrocarpa is a thorny evergreen hedge with edible red fruit. Handles reflected heat well once established.",
        "companions": ["Rosemary", "Lavender", "Pomegranate", "Fig"],
        "antagonists": ["None known"],
    },
    {
        "name": "Passionfruit",
    ...
    },
    {
        ...
        "notes": "Feijoa sellowiana (pineapple guava) is a hardy evergreen fruiting shrub for warm climates; best fruit quality with deep irrigation and afternoon protection in hottest sites.",
        "companions": ["Lavender", "Rosemary", "Pomegranate", "Olive"],
        "antagonists": ["None known"],
    },
    {
        "name": "Surinam Cherry",
    ...
    },
    {
        ...
        "desert_seasons": ["warm", "monsoon"],
        "sow_indoor_weeks_before_transplant": 0,
        "desert_sow_outdoor": ["03-01", "08-31"],
        "desert_transplant": None,
        "desert_harvest": ["04-15", "11-15"],
        "notes": "Alternanthera sissoo is a fast-growing edible groundcover ideal for hot desert summers and can handle reflective heat once established.",
        "companions": ["Okra", "Eggplant", "Pepper", "Marigold"],
        "antagonists": ["None known"],
    },
    {
        "name": "Molokhia",
        ...
        "desert_transplant": None,
        "desert_harvest": ["05-01", "10-31"],
        "notes": "Corchorus olitorius (jute mallow) is a classic hot-weather leafy green and one of the best spinach alternatives for desert summer.",
        "companions": ["Okra", "Cowpea", "Amaranth", "Basil"],
        "antagonists": ["None known"],
    },
    {
        "name": "Nopal",
...
def init_db():
    ...
    VARIETIES = [
        ...
        # ── NEW DESERT VARIETIES (research run 2026-03-31) ──
        ("White Sapote", "Suebelle", "Low-seed white sapote cultivar with excellent flavor and dependable production in warm climates.", 730, 1095, "high", None, "Sweet, vanilla-banana custard", "Medium fruit", "Green to yellow", "Medium tree", 4, "Widely recommended for low-desert and coastal warm regions; benefits from deep, infrequent irrigation after establishment.", "CRFG/UC references"),
        ("White Sapote", "Vernon", "Productive white sapote known for high quality fruit and strong vigor.", 730, 1095, "high", None, "Rich sweet custard flavor", "Medium-large fruit", "Green", "Large tree", 4, "Performs well in hot inland climates with occasional frost protection while young.", "CRFG"),
        ("Carob", "Clifford", "High-yielding pod cultivar used for both fresh pod use and carob powder.", 1460, 2190, "excellent", None, "Mild cocoa-like sweetness", "Long pods", "Brown", "Large evergreen tree", 5, "Very strong heat and drought tolerance in Mediterranean and desert landscapes once established.", "UCANR/extension references"),
        ("Goji Berry", "Crimson Star", "Commercially selected goji berry with large sweet-tart berries.", 120, 180, "high", None, "Sweet-tart berry", "Small elongated berry", "Bright red", "Arching shrub", 3, "Can fruit in desert climates with afternoon shade and regular establishment water; prune to keep productive wood.", "Nursery and grower references"),
        ("Papalo", "Broadleaf", "Traditional broadleaf papalo used in Puebla-style tacos and sandwiches.", 50, 70, "excellent", None, "Cilantro-arugula, citrusy", "Leaf harvest", "Green", "Upright herb", 5, "Thrives in summer heat and low humidity where cilantro bolts quickly.", "Seed saver/community grower references"),
        ("Culantro", "Santo Domingo", "Heat-loving Caribbean culantro strain valued for long aromatic leaves.", 70, 95, "high", None, "Intense cilantro-like aroma", "Long strap leaves", "Green", "Rosette herb", 4, "More heat tolerant than cilantro, but still benefits from afternoon shade in low desert to slow bolting.", "Tropical herb production references"),

        # ── NEW DESERT VARIETIES (research run 2026-03-31, round 2) ──
        ("Jojoba", "Desert Male/Female Pair", "Selection planted as mixed-sex hedge for reliable nut set in low-desert landscapes.", 1095, 1825, "excellent", None, "Nutty oil seed (processed)", "Medium seed", "Tan-brown", "Evergreen shrub", 5, "Native Sonoran shrub with exceptional drought and heat resilience once roots establish.", "USDA NRCS / Sonoran native plant references"),
        ("Natal Plum", "Boxwood Beauty", "Compact ornamental/edible natal plum with dense branching and bright red fruit.", 365, 730, "high", None, "Tart cranberry-like", "Small oval fruit", "Red", "Dense thorny shrub", 4, "Performs well in reflected desert heat with occasional deep irrigation.", "Arizona nursery and extension references"),
        ("Passionfruit", "Frederick", "Purple passionfruit cultivar known for better fruit quality in warm inland climates.", 365, 540, "high", None, "Sweet-tart tropical", "Medium round fruit", "Purple", "Vigorous climbing vine", 3, "Needs afternoon shade and consistent moisture to fruit reliably in low-desert summer.", "UCANR / grower references"),
        ("Dragon Fruit", "Vietnamese White", "Reliable white-fleshed pitaya selection widely grown in hot climates.", 365, 730, "high", None, "Sweet mild melon-like", "Medium-large fruit", "Pink skin, white flesh", "Climbing cactus", 4, "Strong desert candidate with trellis support and summer sun protection.", "University extension and commercial pitaya grower references"),
        ("Pineapple Guava", "Coolidge", "Self-fertile feijoa cultivar with aromatic fruit and edible petals.", 730, 1095, "high", None, "Pineapple-mint tropical", "Medium oval fruit", "Green", "Evergreen shrub/tree", 4, "Heat-tolerant and drought-adapted once established; best with occasional deep water.", "California extension / CRFG references"),
        ("Surinam Cherry", "Zill Dark", "Dark-fruited Surinam cherry with sweeter flavor than standard red types.", 540, 1095, "high", None, "Sweet-tart, resinous", "Ribbed cherry-like fruit", "Dark red to maroon", "Evergreen shrub", 3, "Can be productive in protected desert microclimates with mulching and frost protection while young.", "Tropical fruit grower references"),
        ("Meyer Lemon", "Improved Meyer", "Standard home-orchard Meyer lemon with dependable winter fruiting.", 730, 1095, "high", None, "Sweet floral lemon", "Medium citrus fruit", "Yellow-orange", "Small evergreen tree", 5, "Excellent Zone 9b/10a citrus choice when micronutrients are managed in alkaline soils.", "University extension citrus references"),

        # ── NEW DESERT VARIETIES (research run 2026-04-01) ──
        ("Pepper", "Chiltepin", "Wild Sonoran chile and Arizona native with very high heat and exceptional drought/heat adaptation.", 90, 120, "excellent", None, "Bright, smoky, very hot", "Tiny berry pepper", "Green to red", "Perennial shrub-like pepper", 5, "Native desert chile. Handles intense heat and low humidity better than most cultivated peppers once established.", "University of Arizona / native food references"),
        ("Sweet Potato", "Murasaki", "Purple-skinned, white-fleshed sweet potato known for strong vigor in hot climates.", 95, 115, "high", None, "Chestnut-sweet, dense", "Medium tubers", "Purple skin, white flesh", "Spreading vine", 4, "Performs well in prolonged summer heat with deep irrigation; excellent storage quality.", "Extension and grower references"),
        ("Okra", "Jing Orange", "Orange-red podded okra with strong yields in high heat and prolonged summer conditions.", 55, 65, "excellent", None, "Mild, tender when young", "Medium pods (3-5 in)", "Orange-red", "Tall upright", 5, "Reliable producer in low-desert summers; pods stay tender if harvested frequently.", "Seed company and grower trial references"),
        ("Nopal", "Burbank Spineless", "Spineless prickly pear selected for edible pads and easier harvesting.", 365, 730, "excellent", None, "Mild, green-bean/asparagus notes", "Medium-large pads", "Green", "Upright clumping cactus", 5, "Excellent low-water edible cactus for Arizona gardens and food forests.", "Southwest extension and nursery references"),

        # ── NEW DESERT VARIETIES (research run 2026-04-01, herbs) ──
        ("Society Garlic", "Silver Lace", "Variegated foliage selection with lilac flowers and reliable desert landscape performance.", 95, 140, "excellent", None, "Mild garlic-onion flavor", "Medium clump (18-24 in)", "Green/cream variegated leaves, lilac flowers", "Clumping perennial", 5, "Excellent low-water edible ornamental for Phoenix landscapes and containers.", "Extension + nursery references"),
        ("Society Garlic", "Tricolor", "Compact variegated society garlic selection with pink-lilac blooms.", 90, 130, "excellent", None, "Mild onion-garlic, best fresh", "Compact clump (12-18 in)", "Green/cream/pink variegated foliage", "Clumping perennial", 4, "Strong heat tolerance; best color in bright morning light with afternoon summer protection.", "Nursery and grower references"),
        ("Summer Savory", "Satyr", "Improved summer savory strain for uniform growth and concentrated oils.", 55, 70, "high", None, "Peppery, warm, classic bean herb", "Small mound (10-14 in)", "Green", "Annual bushy herb", 4, "Reliable warm-season herb for low-desert spring and early monsoon windows.", "Seed company + herb production guides"),
        ("Winter Savory", "Montana", "Classic winter savory type with strong savory-thyme flavor and woody perennial habit.", 80, 110, "high", None, "Bold peppery-thyme", "Low shrub (10-14 in)", "Dark green", "Woody perennial", 4, "Overwinters well and handles reflected heat with drainage and moderate summer irrigation.", "Extension + herb farm references"),
        ("Sweet Marjoram", "Italian Sweet", "Sweet marjoram strain selected for compact, high-leaf culinary production.", 70, 100, "high", None, "Sweet, floral-oregano", "Mounded (12-18 in)", "Green", "Tender perennial", 4, "Performs well in desert spring/fall; provide midday protection in peak summer.", "Seed company + extension references"),
        ("Lemon Verbena", "Verbenaceae Select", "High-oil lemon verbena selection for tea and culinary use.", 80, 120, "high", None, "Intense lemon, bright citrus", "Shrub (36-60 in)", "Green", "Woody shrub", 4, "Excellent in low-desert herb gardens with deep irrigation and late-afternoon shade in summer.", "Extension + herb grower references"),
