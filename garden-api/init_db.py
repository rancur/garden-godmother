...
PLANTS = [
    ...
    # ── NEW PLANTS — Research batch 2026-06-01 (r5): native/desert-staple edibles ──
    {
        "name": "Pistachio",
        "category": "tree",
        "subcategory": "nut",
        "days_to_maturity_min": 1825,
        "days_to_maturity_max": 2920,
        "spacing_inches": 240,
        "sun": "full",
        "water": "low",
        "heat_tolerance": "excellent",
        ...
        "notes": "Pistacia vera. One of the few nut trees genuinely suited to hot, dry desert — thrives on long, hot summers and tolerates alkaline, saline soils. Dioecious: needs both a female (e.g. Kerman) and a male (Peters) for pollination, ~1 male per 8-11 females. Needs winter chill (~600-1000 hrs <45F) for good bloom; low-desert Phoenix is borderline on chill, higher-elevation AZ (Cochise County) is ideal. Wind-pollinated, deep taproot, bears in 5-8 yrs, alternate-bearing once mature.",
        "companions": [],
        "antagonists": [],
    },
    {
    ...
    },
    {
        ...
        "sow_indoor_weeks_before_transplant": 0,
        "desert_sow_outdoor": None,
        "desert_transplant": ["08-01", "11-30"],
        "desert_harvest": ["11-01", "05-31"],
        "notes": "Allium cepa var. aggregatum — a Tohono O'odham heirloom multiplier/bunching onion grown in southern AZ since the 1600s. Perfectly Sonoran-adapted: a perennial that goes dormant through the hottest, driest months and flushes with both summer monsoon and winter rains. Plant a single bulb and it divides into 8-10+ clumping shallot-like bulbs with spicy chive-like greens. Plant with the monsoon (Aug-Nov), harvest greens through the cool season, divide and replant clumps. Heavy feeder despite drought tolerance.",
    ...
    },
    {
        ...
        "desert_sow_outdoor": None,
        "desert_transplant": ["03-01", "04-30"],
        "desert_harvest": ["12-01", "02-28"],
        "notes": "Citrus maxima (pomelo) — the largest citrus, ancestor of the grapefruit, with thick rind and sweet, mild, non-bitter flesh. Heat-loving and well-suited to low-desert summers, but among the more frost-tender citrus: protect young trees below ~28F and site in a warm microclimate (south wall). Plant in spring after frost like other desert citrus; deep, infrequent irrigation; alkaline-soil chlorosis managed with chelated iron. Long-season fruit ripens through winter.",
        "companions": [],
        "antagonists": [],
    },
    {
    ...
    },
    {
        ...
        "desert_seasons": ["warm", "monsoon"],
        "sow_indoor_weeks_before_transplant": 0,
        "desert_sow_outdoor": ["04-15", "07-31"],
        "desert_transplant": None,
        "desert_harvest": ["08-01", "11-15"],
        "notes": "Eragrostis tef. A warm-season C4 grass — the tiny Ethiopian grain behind injera — that is genuinely heat- and drought-tolerant and fast (matures in ~3 months), fitting the monsoon window well. Broadcast surface-sow into a firm, moist seedbed after soil warms. MARGINAL as a home grain: seeds are minuscule and threshing/winnowing by hand is laborious, so most US production is for forage/hay. Excellent low-water summer cover/forage; grain harvest is for the dedicated.",
        "companions": [],
        "antagonists": [],
    },
]
...
def init_db():
    ...
    VARIETIES = [
        ...
        # ── ADDED 2026-06-01 (r5): varieties for new + existing desert plants ──
        ...
        ("Date Palm", "Medjool", "The premium large, soft, sweet date; the benchmark dessert date.", 1460, 2190, "excellent", None, "very sweet, caramel, soft", "large fruit", "amber to deep brown", "tall palm", 5, "The classic AZ/CA desert commercial date — thrives in extreme low-desert heat. Female; needs male pollen (hand-pollinated). Excellent fresh; commands premium prices.", "extension.arizona.edu; harvesttotable.com"),
        ...
        ("Date Palm", "Deglet Noor", "Semi-dry 'date of light' — firm, less sweet, the main commercial export date.", 1460, 2190, "excellent", None, "semi-sweet, nutty, firm", "medium fruit", "translucent amber", "tall palm", 5, "Drier, firmer date that stores and ships well; the standard grocery date. Excellent in extreme desert heat; female, needs male pollen.", "extension.arizona.edu"),
        ("Pomegranate", "Wonderful", "The leading commercial pomegranate; large, deep-red, tart-sweet arils.", 730, 1095, "excellent", None, "tangy-sweet, bold, juicy", "large fruit", "deep red rind, red arils", "multi-trunk shrub/tree", 5, "Extremely well adapted to low-desert heat and alkaline soil; the most widely planted variety. Self-fruitful, deep-water tolerant, productive with little fuss.", "extension.arizona.edu; extension.usu.edu"),
