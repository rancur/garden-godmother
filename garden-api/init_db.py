...
PLANTS = [
    ...
    # ── HOLY BASIL (TULSI) ──
    {
        ...
        "desert_transplant": ["03-15", "05-15"],
        "desert_harvest": ["04-15", "11-30"],
        "notes": "Ocimum tenuiflorum (syn. O. sanctum), also called tulsi. Sacred herb in Ayurveda — far more heat- and drought-tolerant than sweet basil and thrives through Phoenix summers where regular basil bolts. Light afternoon shade helps above 110F. Clove-peppery flavor for Thai cuisine, medicinal tea. Rama (green) and Krishna (purple) are common cultivars. Aromatic pest deterrent. Annual in desert but self-seeds readily; pinch flowers for bushier growth and extended harvest.",
    ...
    # NEW PLANTS — Research batch 2026-06-01-r2
    # Sonoran-adapted squash, native edibles, desert fruit, and a native herb
    {
        "name": "Cushaw Squash",
        "category": "vegetable",
        "subcategory": "fruit",
        ...
        "desert_transplant": None,
        "desert_harvest": ["08-01", "11-30"],
        "notes": "Cucurbita argyrosperma. A Sonoran Desert foodways staple — exceptional heat tolerance with little irrigation. Long sprawling vines, large green-striped or golden fruit (10-20 lbs). Direct sow; can plant for the monsoon and harvest into fall. Some squash-vine-borer resistance. Cure and store for months. Seeds are edible (pepitas).",
        "companions": ["Corn", "Bean (Bush)", "Tepary Bean", "Sunflower", "Nasturtium"],
        "antagonists": ["Potato"],
    },
    {
        "name": "Devil's Claw",
        ...
        "desert_transplant": None,
        "desert_harvest": ["06-15", "10-31"],
        "notes": "Proboscidea parviflora (i'ihug). Native Sonoran annual, drought-adapted. Young tender pods are cooked and eaten like okra; oily seeds are rich in protein. The Tohono O'odham domesticated var. hohokamiana for long-clawed dried pods used in basketry. Soak/scarify seed before sowing; germinates with summer heat and monsoon moisture. Harvest pods young (under ~6 in) for eating, or let dry on the plant for craft fiber.",
        "companions": ["Tepary Bean", "Cushaw Squash", "Amaranth"],
        "antagonists": [],
    },
    {
        "name": "Banana",
        ...
        "notes": "Musa spp. Grows in protected low-desert microclimates (courtyards, south/east block walls) in Zone 9b/10a. Choose dwarf cultivars (Dwarf Cavendish, Dwarf Orinoco, Blue Java). Needs rich soil, heavy mulch, frequent deep water, and afternoon shade to prevent leaf scorch above 110F. Protect pseudostem from frost — wrap before a freeze or cut back and mulch the crown. A pup-bearing clump fruits once per pseudostem.",
        "companions": ["Sweet Potato", "Ginger", "Turmeric", "Lemongrass", "Comfrey"],
        "antagonists": [],
    },
    {
        "name": "Pindo Palm",
        ...
        "desert_transplant": ["03-01", "05-31"],
        "desert_harvest": ["06-01", "08-31"],
        "notes": "Butia odorata (often sold as B. capitata), the jelly/pindo palm. Heat- and drought-tolerant feather palm hardy to ~15F, grown across Arizona (incl. UA campus arboretum). Sweet apricot-pineapple-vanilla fruit used for jelly and wine. Slow-growing; first fruit at ~8-10 years. Deep, infrequent water once established; excellent drainage. Messy fruit drop — site away from paving.",
        "companions": [],
        "antagonists": [],
    },
    {
        ...
        "desert_transplant": None,
        "desert_harvest": ["08-01", "11-30"],
        "notes": "Cucurbita moschata, cultivated for centuries by the Seminole. Among the most heat- and humidity-tolerant winter squash — thrives through monsoon season where other squash fail, with notable squash-vine-borer resistance. Extremely vigorous vines (10ft+) can be trellised; sweet orange butternut-like flesh. A single vine may set dozens of small 5-8 lb fruit. Stores for many months.",
    ...
    },
    {
        ...
        "desert_transplant": ["03-01", "04-30"],
        "desert_harvest": ["10-01", "01-31"],
        "notes": "Citrus australasica. Australian rainforest understory citrus with prized 'citrus caviar' pulp vesicles. Unusually shade-needing for citrus — give afternoon/filtered shade in the low desert to prevent sunburn. Frost-tender (hardy only to ~32-35F); best grown in a container that can be moved to a protected spot below freezing, or in a warm courtyard microclimate. Slow, thorny, slow to bear. Sold by AZ nurseries.",
        "companions": [],
        "antagonists": [],
    },
    {
        ...
        "desert_transplant": ["03-15", "05-15"],
        "desert_harvest": ["06-01", "11-15"],
        "notes": "Agastache rupestris. Arizona/New Mexico native perennial with licorice-root-beer-scented foliage and tubular orange-coral flowers. Genuinely desert-adapted (unlike anise hyssop) — drought-tolerant once established and demands excellent drainage; dislikes damp. Edible leaves and flowers make a fragrant tea. A premier hummingbird and native-bee magnet. Cold-hardy through Zone 9b winters; cut back in late winter.",
        "companions": ["Lavender", "Rosemary", "Sage", "Echinacea", "Yarrow"],
        "antagonists": [],
    },
]
...
def init_db():
    ...
    VARIETIES = [
        ...
        # ── NEW DESERT VARIETIES (research run 2026-06-01-r2) ──
        ("Banana", "Dwarf Cavendish", "Compact banana that can fruit in protected low-desert microclimates.", 300, 540, "high", None, "Sweet, classic banana", "Small-medium bunches", "Yellow", "Clumping, 6-8 ft pseudostem", 3, "Best dwarf for Phoenix courtyards; needs frost protection and afternoon shade above 110F.", "gardenofluma.com; phoenixtropicals.com"),
        ("Banana", "Ice Cream (Blue Java)", "Cold-hardier banana with vanilla-custard flavor.", 330, 540, "high", None, "Creamy, vanilla, ice-cream-like", "Medium bunches", "Blue-green ripening to pale yellow", "Clumping, 10-15 ft", 3, "More cold-tolerant than Cavendish; still needs frost protection in 9b. Outstanding fresh flavor.", "phoenixtropicals.com"),
        ("Cushaw Squash", "Green-Striped Cushaw", "Classic large green-and-white striped Sonoran cushaw.", 100, 120, "excellent", "Some vine borer resistance", "Mild, sweet, good for pies", "Very large (10-20 lbs)", "Green-and-white striped", "Long sprawling vine", 5, "Heritage Southwest squash; thrives on heat and minimal water. Stores for months.", "gardeningknowhow.com; sowtrueseed.com"),
        ("Cushaw Squash", "Golden Cushaw", "Orange-skinned crookneck cushaw with sweet flesh.", 95, 115, "excellent", None, "Sweet, rich", "Large (8-15 lbs)", "Orange", "Long sprawling vine", 5, "Heat- and drought-resilient; good keeper for fall and winter use.", "gardenerspath.com"),
        ("Seminole Pumpkin", "Classic Seminole", "Centuries-old Seminole landrace, extremely heat and humidity tolerant.", 95, 120, "excellent", "Vine borer resistant", "Sweet, butternut-like", "Small-medium (5-8 lbs)", "Tan to buff", "Vigorous trellisable vine", 5, "One of the toughest squash for monsoon-season heat and humidity; superb keeper.", "gardeningsolutions.ifas.ufl.edu; fairchildgarden.org"),
        ("Sunset Hyssop", "Apache Sunset", "First-year-blooming selection with root-beer-scented edible foliage.", 90, 110, "excellent", None, "Licorice / root-beer, minty", "Medium (24-30 in)", "Orange-coral", "Upright perennial", 5, "Hardy desert-native Agastache; blooms first year from seed. Hummingbird magnet.", "highcountrygardens.com; plants.ces.ncsu.edu"),
        ("Pindo Palm", "Standard (Butia odorata)", "Hardy jelly palm grown widely in Arizona landscapes.", 1825, 3650, "excellent", None, "Apricot-pineapple-vanilla", "Small fruit clusters", "Yellow-orange", "Feather palm", 4, "Heat-, drought-, and cold-hardy; sweet edible fruit for jelly and wine. Slow to first fruit.", "apps.cals.arizona.edu/arboretum; growables.org"),
        ("Pepper", "NuMex Big Jim", "Record-size mild New Mexico chile, excellent desert producer.", 75, 90, "excellent", None, "Mild-medium, classic green-chile", "Very large (8-12 in)", "Green to red", "Upright bush", 5, "Bred at NMSU for the Southwest; roasts beautifully. Reliable in low-desert heat.", "New Mexico State University"),
        ("Okra", "Burgundy", "Red-podded okra, ornamental and heat-loving.", 50, 65, "excellent", None, "Tender, mild", "Medium pods (5-7 in)", "Burgundy-red", "Tall upright", 5, "Thrives in extreme desert heat; pods stay tender slightly longer than green types.", "Open-pollinated"),
        ("Fig", "Black Mission", "Classic dark fig, superb low-desert producer with two crops.", 365, 730, "excellent", None, "Rich, sweet, jammy", "Medium fruit", "Purple-black", "Large shrub/tree", 5, "Outstanding Arizona fig; breba and main crop. Heat- and drought-tolerant once established.", "extension.arizona.edu AZ1636"),
