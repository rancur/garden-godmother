...
PLANTS = [
    ...
    },
    {
        ...
        "desert_transplant": ["09-15", "03-01"],
        "desert_harvest": ["11-01", "05-15"],
        "notes": "Brassica oleracea var. viridis. The most heat-tolerant of the brassicas — handles desert heat better than kale or cabbage. Southern classic. Cut-and-come-again: harvest outer leaves and plant keeps producing 6+ months. Flavor sweetens after frost. Georgia Southern and Champion are reliable in desert. Can extend into early summer with shade cloth.",
        "companions": ["Onion", "Garlic", "Dill", "Chamomile", "Nasturtium", "Marigold"],
        "antagonists": ["Tomato", "Pepper", "Strawberry"],
    },
    {
        "name": "Fava Bean",
        ...
        "notes": "Vicia faba. Outstanding desert cool-season crop — also called broad bean. Nitrogen fixer, excellent cover crop and soil builder. Tolerates frost to 15F. Pinch tops when flowering to deter aphids. Must finish before heat above 90F arrives — blossoms drop. Young leaves and shoots also edible. Bell Beans are a smaller cover-crop variety. Windsor and Broad Windsor are classic culinary types.",
        "companions": ["Carrot", "Celery", "Corn", "Lettuce", "Radish", "Spinach"],
        "antagonists": ["Onion", "Garlic", "Chive", "Fennel"],
    },
    {
        "name": "Endive",
        "category": "vegetable",
    ...
    },
    {
        ...
        "desert_transplant": ["10-01", "03-31"],
        "desert_harvest": ["01-01", "12-31"],
        "notes": "Laurus nobilis. Mediterranean evergreen tree/shrub — classic culinary bay leaves for soups, stews, stocks. Excellent desert performer once established: Mediterranean origin means it handles heat and drought. Slow-growing, can be kept as a shrub or trained as a small tree to 15-20 ft. Hardy to about 20F — fine for Phoenix lows. Harvest leaves anytime; flavor concentrates with drying. Container-friendly if you prefer to control size.",
        "companions": [],
        "antagonists": [],
    },
    {
...
def init_db():
    ...
    VARIETIES = [
        ...
        # ── PEACH varieties (low-chill for desert) ──
        ...
        # ── COLLARD GREENS varieties ──
        ("Collard Greens", "Georgia Southern", "Classic Southern heirloom, exceptional heat tolerance.", 60, 80, "excellent", None, "Mild, cabbage-like, sweeter after frost", "Large loose rosette (24-36 in)", "Blue-green", "Large loose plant", 5, "THE classic collard. Handles desert heat better than any brassica. Slow to bolt. Cut-and-come-again harvest.", "Heirloom (1880s)"),
        ...
        # ── MANDARIN companions — none separate ──
