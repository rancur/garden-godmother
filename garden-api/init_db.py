...
PLANTS = [
    ...
    # ── NEW DESERT PLANTS (research run 2026-05-08) ──
    {
        "name": "I'itoi Onion",
        "category": "vegetable",
        "subcategory": "allium",
        ...
        "sow_indoor_weeks_before_transplant": 0,
        "desert_sow_outdoor": None,
        "desert_transplant": ["09-01", "11-30"],
        "desert_harvest": ["02-01", "06-30"],
        "notes": "Tohono O'odham heirloom multiplier onion (Allium cepa var. aggregatum) from Baboquivari Mountains region. Perennial bunching shallot — single bulb divides into a clump that can be harvested for greens or pulled as small shallots. Goes summer-dormant in extreme heat then returns. Among the most desert-adapted alliums available; once established, needs almost no care. Plant bulblets September-November; harvest greens year-round, bulbs in spring.",
        "companions": ["Carrot", "Tomato", "Pepper", "Lettuce", "Beet", "Strawberry"],
    ...
    },
    {
        ...
        "notes": "Smallanthus sonchifolius — Andean tuber that produces sweet, crunchy storage roots tasting like a cross between apple and jicama. Top growth dies back at frost; harvest tubers after first light frost when they sweeten. Needs afternoon shade and consistent moisture in low desert; mulch heavily. Replant the small reddish 'crown' divisions from the base each year — eat the larger storage roots. Mild winters of Zone 9b allow the crown to overwinter in ground with mulch.",
        "companions": ["Sweet Potato", "Sunflower", "Corn"],
        "antagonists": [],
    },
    {
        "name": "Pepino Dulce",
        ...
        "desert_transplant": ["02-15", "04-15"],
        "desert_harvest": ["06-01", "11-30"],
        "notes": "Solanum muricatum — Andean melon-pear in the nightshade family. Yellow fruit with purple streaks tasting like honeydew/cucumber. Tender perennial: dies back below 28F, returns from roots if mulched, or grow as annual. Propagate easily from cuttings. Needs afternoon shade above 110F or fruit will sun-scald. Drip irrigation works well; avoid overhead watering (fungal issues). Container-friendly. Productive in low desert with light shade cloth in July-August.",
    ...
    },
    {
        ...
        "notes": "Rumex acetosa (common) and R. scutatus (French/buckler) — perennial leafy green with bright lemony oxalic-acid tang. Cool-season crop in Zone 9b: plant fall, harvest through spring, goes dormant in summer heat. Cut flower stalks to extend harvest. Provide afternoon shade and mulch; root crown survives summer if kept barely moist. Use sparingly raw (oxalic acid); excellent in soups (sorrel soup), sauces, fish accompaniment.",
        "companions": ["Strawberry", "Lettuce", "Mint"],
        "antagonists": [],
    },
    {
        "name": "Cardoon",
        ...
        "desert_seasons": ["cool"],
        "sow_indoor_weeks_before_transplant": 6,
        "desert_sow_outdoor": ["09-01", "10-31"],
        "desert_transplant": ["10-01", "12-01"],
        "desert_harvest": ["02-15", "05-15"],
        "notes": "Cynara cardunculus — Mediterranean artichoke relative grown for blanched leaf stalks, not buds. Large architectural plant (4-6 ft) with silver foliage. Far more drought-tolerant than artichoke. Plant in fall in Zone 9b; blanch stalks by wrapping with cardboard or burlap for 3-4 weeks before harvest to reduce bitterness. Stalks taste like artichoke heart, used in Italian and Spanish cuisine (cardi alla parmigiana). Can be perennial with summer dormancy if kept dry.",
    ...
    },
    {
        ...
        "desert_transplant": ["03-01", "04-15"],
        "desert_harvest": ["05-01", "10-31"],
        "notes": "Agastache foeniculum — North American native mint-family herb with anise-licorice scented foliage and lavender flower spikes. Major pollinator magnet (bees, hummingbirds, butterflies). Very drought tolerant once established; some afternoon shade helps in low desert. Leaves and flowers used fresh in salads, teas, and as garnish. Self-seeds. Cut back after flowering for second flush. Often confused with hyssop (Hyssopus officinalis) — different plant.",
        "companions": ["Tomato", "Pepper", "Squash (Summer)", "Cucumber", "Melon"],
        "antagonists": [],
    },
    {
        "name": "Mache",
    ...
    },
    {
        ...
        "desert_sow_outdoor": None,
        "desert_transplant": ["03-01", "05-15"],
        "desert_harvest": ["10-01", "01-15"],
        "notes": "Citrus australasica — Australian native 'caviar lime' with cylindrical fruit containing crisp vesicles ('lime caviar') prized by chefs. Smaller and more cold-sensitive than other citrus (damaged below 28F); plant on south side with frost cloth ready. Thorny, slow-growing. Reflected wall heat helps in low desert but afternoon shade in July-August prevents leaf scald. Container-friendly for frost protection. Pink/red-flesh varieties (Pink Ice, Crimson Tide) are popular.",
        "companions": ["Rosemary", "Lavender", "Marigold"],
        "antagonists": [],
    },
    {
        "name": "Pluot",
        ...
        "desert_sow_outdoor": None,
        "desert_transplant": ["12-01", "02-28"],
        "desert_harvest": ["05-15", "08-15"],
        "notes": "Plum-apricot interspecific hybrid (75% plum, 25% apricot) bred by Floyd Zaiger. Lower chill (300-500 hrs) varieties like Flavor Supreme, Splash, Dapple Dandy work in Zone 9b — verify chill hours match your microclimate. Most varieties need a Japanese plum (Santa Rosa, Burgundy) as pollinator. Heat-tolerant but appreciates light afternoon shade for fruit at 110F+. Excellent flavor — sweeter than plum with apricot complexity.",
        "companions": ["Garlic", "Chive", "Nasturtium"],
        "antagonists": [],
    },
    {
        "name": "Devil's Claw",
        ...
        "desert_transplant": None,
        "desert_harvest": ["07-15", "10-31"],
        "notes": "Proboscidea parviflora — Sonoran native used by Tohono O'odham and other Indigenous Southwestern peoples. Domesticated white-seeded form has long pliable claws used in basketry; wild yellow-seeded form is shorter. Young green pods edible like okra (mild, slightly fuzzy). Mature dried pods split into two curved black 'claws'. Extremely drought tolerant — perfectly adapted to monsoon rains. Direct-sow into warm soil after last frost. Sticky/musky foliage repels most pests.",
        "companions": ["Tepary Bean", "Corn", "Sunflower", "Amaranth"],
        "antagonists": [],
    },
]
...
def init_db():
    ...
    VARIETIES = [
        ...
        # ── NEW DESERT VARIETIES (research run 2026-05-08) ──
        ("Pomegranate", "Wonderful", "Industry-standard California pomegranate — large red fruit, ruby arils.", 730, 1095, "excellent", None, "Sweet-tart, balanced, juicy", "Large fruit (10-14 oz)", "Deep red", "Multi-trunk shrub/tree", 5, "The classic commercial pomegranate. Thrives in low desert heat and alkaline soil. Tolerates 115F+. Self-fertile. Harvest October-November.", "USDA/UC"),
        ("Pomegranate", "Eversweet", "Soft-seeded sweet pomegranate with clear non-staining juice.", 730, 1095, "excellent", None, "Very sweet, low acid, mild", "Medium fruit (8-10 oz)", "Pink-red", "Bushy", 4, "Soft seeds you can eat whole. Less tart than Wonderful. Earlier ripening (August-September). Great fresh-eating variety for desert gardens.", "California cultivar"),
        ("Fig", "Black Mission", "Classic California fig with rich, jammy flavor — desert workhorse.", 365, 730, "excellent", None, "Rich, sweet, jammy", "Medium fruit", "Black-purple skin, pink flesh", "Large tree", 5, "The standard desert fig. Two crops per year (breba in June, main in August-September). Drought tolerant once established. Provide afternoon shade for first 2 years.", "Heirloom"),
        ("Fig", "Brown Turkey", "Reliable, adaptable fig with consistent production in heat.", 365, 730, "excellent", None, "Sweet, mild, rich", "Medium fruit", "Brown-purple", "Compact tree", 5, "Most forgiving fig variety. Self-fertile. Container-friendly. Performs well in Phoenix heat with deep weekly irrigation.", "Heirloom"),
        ("Fig", "Desert King", "Green-skinned fig with strawberry-pink flesh, breba-only crop.", 365, 730, "excellent", None, "Honey-sweet, berry notes", "Large fruit", "Yellow-green skin, pink flesh", "Vigorous tree", 5, "Single huge breba crop in June-July. Skin stays green when ripe (look for soft droop). Excellent low-desert performer.", "Pacific Northwest origin"),
