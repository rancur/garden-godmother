...
PLANTS = [
    ...
    # ── HOLY BASIL (TULSI) ──
    {
        ...
        "desert_transplant": ["04-01", "05-15"],
        "desert_harvest": ["04-15", "11-30"],
        "notes": "Ocimum tenuiflorum (syn. O. sanctum), tulsi — sacred herb in Ayurveda. Far more heat and drought tolerant than sweet basil and thrives through Phoenix summers where regular basil bolts; light afternoon shade helps above 110F. Clove-peppery flavor for Thai/Indian cooking and medicinal tea. Rama and Krishna are common cultivars. Annual in the desert but self-seeds readily — pinch flowers for bushier growth and a longer harvest. Aromatic pest deterrent.",
    ...
    },
    {
        ...
        "desert_transplant": None,
        "desert_harvest": ["06-01", "11-15"],
        "notes": "Vigna aconitifolia (matki/dew bean). The most heat- and drought-hardy of the Asian Vignas — tolerates 45C/113F and 30-40 days of moisture depletion once its deep roots establish. A low creeping vine ideal for monsoon dry-farming alongside tepary bean. Direct sow only into warm soil; needs just 2-3 light irrigations all season. Fixes nitrogen, tolerates poor sandy and slightly saline/alkaline soil (pH 6.0-8.5). Sprouts are the matki used in misal pav.",
        "companions": ["Corn", "Sorghum", "Sunflower", "Squash (Summer)"],
        "antagonists": ["Onion", "Garlic", "Chive"],
    },
    {
        "name": "Winged Bean",
        ...
        "desert_seasons": ["warm", "monsoon"],
        "sow_indoor_weeks_before_transplant": 0,
        "desert_sow_outdoor": ["04-15", "06-15"],
        "desert_transplant": None,
        "desert_harvest": ["08-01", "11-30"],
        "notes": "Psophocarpus tetragonolobus. A vigorous heat-and-humidity-loving climber where nearly every part is edible — winged pods, leaves, flowers, shoots, and protein-rich tubers. Wants soil above 20C/68F to germinate and warm nights; pod set slows briefly above 38C/100F so light afternoon shade helps in peak Phoenix summer. Needs a sturdy 6-8ft trellis and steadier moisture than desert legumes. Many strains are short-day, flowering as monsoon days shorten into fall. Nitrogen fixer.",
        "companions": ["Corn", "Cucumber", "Squash (Summer)", "Nasturtium"],
        "antagonists": ["Onion", "Garlic", "Chive"],
    },
    {
        ...
        "desert_harvest": ["11-01", "05-15"],
        "notes": "Allium x proliferum (tree/topsetting onion). A trouble-free perennial that 'walks' — top clusters of bulbils bend over and self-replant. Plant topsets in fall; harvest green tops and small underground bulbs through the cool season. Use both the scallion-like greens and the pea-sized bulbils. Hardy to -24F and drought tolerant once established, but in low-desert summer give it afternoon shade and a little water as it goes semi-dormant above 100F. A single planting persists and spreads for years.",
        "companions": ["Carrot", "Beet", "Tomato", "Strawberry"],
        "antagonists": ["Bean (Bush)", "Pea", "Moth Bean"],
    },
    {
        "name": "Tree Collard",
        "category": "vegetable",
        ...
        "notes": "Brassica oleracea (perennial purple tree collard). A woody, non-flowering perennial kale/collard that can live 5+ years and reach 6ft, giving year-round greens without replanting. In the low desert it MUST have afternoon/part shade and steady water — plant in fall, never into summer heat, and site it as understory beneath fruit trees. Almost always grown from cuttings since it rarely sets seed; pinch tips to keep it bushy and for new propagation wood. Sweeter after cool snaps. The heat-hardy Zimbabwean 'Chomolia' strain copes best with summer.",
        "companions": ["Garlic Chives", "Nasturtium", "Calendula", "Dill"],
        "antagonists": ["Tomato", "Pepper", "Strawberry"],
    },
    {
        "name": "Garlic Chives",
        ...
        "desert_transplant": ["02-01", "03-15"],
        "desert_harvest": ["03-01", "11-30"],
        "notes": "Allium tuberosum (Chinese chives/nira). A tough flat-leaved perennial allium recommended for the Arizona low desert — far more heat-reliable than common chives and evergreen to semi-deciduous here. Mild garlic flavor in the leaves; the late-summer white star flowers and buds are edible too. Very heat, cold, and drought tolerant once established, though afternoon shade and water keep the blades tender above 100F. Deadhead the flowers — it reseeds and colonizes aggressively. Pollinator magnet.",
        "companions": ["Carrot", "Tomato", "Rosemary", "Tree Collard"],
        "antagonists": ["Bean (Bush)", "Pea", "Moth Bean"],
    },
    {
        "name": "Ash Gourd",
