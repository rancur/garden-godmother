...
PLANTS = [
    ...
    # ── 2026-06-01 PLANT RESEARCH (r7): desert-native & heat-adapted edibles ──
    {
        ...
        "desert_transplant": ["03-15", "04-30"],
        "desert_harvest": ["09-01", "11-30"],
        "notes": "Capsicum annuum var. glabriusculum — the Sonoran Desert's wild native chile and likely ancestor of all domesticated peppers. Tiny round berries at 50,000-100,000 SHU. A true perennial shrub (3-4 ft) in Zone 9b/10a that can live 35-50 years where frost is light; roots resprout if frosted. In the wild it grows as an understory plant beneath nurse trees (mesquite, ironwood, desert hackberry) — replicate with morning sun and afternoon shade. Slow, erratic germination: soak seed, keep at 85-90F, be patient (3-6 weeks). Very drought tolerant once established. Birds spread the fruit and are unaffected by the heat. Protected/regulated wild harvest — grow your own.",
        "companions": ["Mesquite", "Tomato", "Basil", "Desert Hackberry"],
        "antagonists": ["Fennel"],
    },
    {
