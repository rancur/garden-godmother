...
PLANTS = [
    ...
    },
    {
        ...
        "desert_seasons": ["cool", "warm"],
        "sow_indoor_weeks_before_transplant": 0,
        "desert_sow_outdoor": ["01-15", "03-15"],
        "desert_transplant": None,
        "desert_harvest": ["10-15", "01-31"],
        "notes": "Jerusalem artichoke (Helianthus tuberosus). Tough perennial grown for edible tubers; handles heat once established but needs periodic deep watering for larger tubers.",
        "companions": ["Corn", "Bean", "Sunflower"],
        "antagonists": ["Potato"],
    },
    {
        "name": "Jicama",
        ...
        "notes": "Pachyrhizus erosus. Long hot season crop grown for crisp edible tubers; remove flowers and pods to improve root size. Seeds/pods are not edible.",
    ...
    },
    {
        ...
        "notes": "Vigna unguiculata subsp. sesquipedalis. Heat-loving cowpea type with long tender pods; performs better than common green beans in high desert summer heat.",
        "companions": ["Corn", "Cucumber", "Marigold"],
        "antagonists": [],
    },
    {
        "name": "Society Garlic",
        ...
        "desert_transplant": ["10-01", "03-31"],
        "desert_harvest": ["01-01", "12-31"],
        "notes": "Tulbaghia violacea. Drought-tolerant clumping allium relative with edible leaves and flowers; useful as perennial culinary and pollinator plant in Zone 9b/10a.",
        "companions": ["Tomato", "Pepper", "Rosemary", "Lavender"],
        "antagonists": [],
    },
    {
        "name": "Lemon Verbena",
        ...
        "notes": "Aloysia citrodora. Highly aromatic tea herb that thrives in heat with afternoon shade and well-drained soil; can be grown as perennial shrub in frost-free microclimates.",
        "companions": ["Lavender", "Rosemary", "Basil"],
        "antagonists": [],
    },
]
...
def init_db():
    ...
    VARIETIES = [
        ...
        ("Pepper", "NuMex Joe E. Parker", "New Mexico-type green chile selected for heat and productivity.", 75, 85, "excellent", None, "Mild-medium, earthy, roasty", "Large (6-8 in)", "Green to red", "Upright bush", 5, "Reliable pod set in hot conditions and strong performer for roasting in low desert gardens.", "New Mexico State University"),
        ("Cucumber", "Armenian Striped", "Heat-loving Armenian cucumber selection with ribbed striped fruit.", 55, 70, "excellent", None, "Mild, sweet, never bitter", "Long (12-18 in)", "Light green striped", "Vigorous vine", 5, "Excellent desert summer cucumber substitute with strong heat resilience.", "Heirloom"),
        ("Basil", "Nufar", "Fusarium-resistant Genovese basil with good warm-climate productivity.", 60, 75, "high", "Fusarium wilt resistance", "Classic sweet basil", "Medium (18-24 in)", "Green", "Bushy", 4, "Stays productive in heat with irrigation; useful disease-resistant basil for desert spring/fall cycles.", "Rutgers release"),
    ]
