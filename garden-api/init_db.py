...
PLANTS = [
    ...
    # ── HOLY BASIL (TULSI) ──
    {
        ...
        "desert_transplant": ["03-15", "05-01"],
        "desert_harvest": ["04-15", "11-30"],
        "notes": "Ocimum tenuiflorum (syn. O. sanctum). Sacred herb in Ayurveda — more heat and drought tolerant than sweet basil. Thrives in Phoenix summer heat where regular basil bolts. Light afternoon shade helps above 110F. Medicinal tea, Thai/Indian cooking. Rama and Krishna are common cultivars. Aromatic pest deterrent. Annual in desert but self-seeds readily. Pinch flowers for bushier growth and extended harvest.",
        "companions": ["Pepper", "Tomato", "Eggplant", "Marigold"],
        "antagonists": ["Sage", "Rue"],
    },
    ...
    },
    {
        ...
        "notes": "Butia capitata (jelly palm / wine palm) — a cold-hardy feather palm (hardy to ~15F, USDA 8-11) that performs as well as Phoenix canariensis in Phoenix landscapes. Slow-growing, drought tolerant, disease resistant. Bears summer clusters of sweet-tart orange fruit tasting of apricot-pineapple, classically made into jelly. Full sun, well-drained soil, moderate-to-low water once established. Self-fruitful.",
        "companions": [],
        "antagonists": [],
    },
    {
    ...
    },
    {
        ...
        "desert_harvest": ["04-15", "11-30"],
        "notes": "Persicaria odorata (Polygonaceae). Moisture-loving tropical herb propagated from 4-6 inch stem cuttings rooted in water (viable seed is rare). NOT drought-tolerant — needs consistently moist, organic-rich soil and afternoon shade, thriving on monsoon humidity. An ideal hot-season cilantro substitute because it does not bolt. Frost-tender below ~45F; treat as a protected perennial in containers or a warm-season replant. Spicy, peppery, citrusy cilantro-like flavor; add at the end of cooking.",
        "companions": ["Lemongrass", "Ginger", "Mint"],
    ...
    },
    {
        ...
        'desert_transplant': ['03-01', '09-30'],
        'desert_harvest': ['06-01', '08-31'],
        'notes': 'Butia capitata / B. odorata — a cold-hardy feather palm with arching silvery-blue fronds and orange apricot-pineapple-flavored fruit used for jelly, jam, wine, and fresh eating. Bulletproof in Phoenix: full sun, well-drained soil, low water once established, and it shrugs off both extreme heat and rare hard freezes (hardy to ~10-15F). Slow-growing the first 2-3 years, then faster. Fruit drops messily, so site away from pavement.',
        'companions': [],
        'antagonists': [],
    },
    {
    ...
    },
    {
        ...
        'desert_transplant': ['03-01', '05-15'],
        'desert_harvest': ['04-01', '11-30'],
        'notes': 'Persicaria odorata (syn. Polygonum odoratum). Also called Rau Ram or laksa leaf. Cilantro-like flavor that does NOT bolt in heat — the perfect cilantro substitute for Phoenix summers. Perennial in zone 9b+. Needs consistent moisture and afternoon shade. Propagates easily from stem cuttings in water. Grow in containers with saucers to maintain moisture. Essential in Vietnamese salads, pho, spring rolls. Frost-tender — bring indoors or mulch heavily below 32F.',
        'companions': ['Mint', 'Lemongrass', 'Thai Basil', 'Cilantro'],
        'antagonists': [],
    },
    {
        'name': 'Winged Bean',
