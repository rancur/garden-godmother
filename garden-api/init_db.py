...
PLANTS = [
    ...
    # ── NEW PLANTS (research run 2026-06-02) ──
    {
        'name': 'Phalsa',
        'category': 'fruit',
        'subcategory': 'shrub fruit',
        ...
        'desert_transplant': ['02-15', '04-15'],
        'desert_harvest': ['05-15', '07-15'],
        'notes': "Grewia asiatica (phalsa/sherbet berry) — deciduous mallow-family shrub bearing tart-sweet purple berries that ripen in early summer, used for refreshing sherbet drinks. Well suited to hot arid regions and tolerates short light frost; drought-tolerant once established but fruits best with deep watering during set. Fruits on current-season wood, so prune hard (to ~3-4 ft) in winter to boost the crop. Full sun, well-drained soil. A mature plant yields 3-5 kg. Water new plants weekly the first season.",
        'companions': ['Marigold', 'Basil', 'Nasturtium'],
        'antagonists': [],
    },
    {
        'name': 'Gai Lan',
        ...
        'desert_transplant': ['10-01', '02-28'],
        'desert_harvest': ['11-01', '04-15'],
        'notes': "Brassica oleracea var. alboglabra (Chinese broccoli/kai-lan) — fast cool-season brassica grown for its thick flowering stems, leaves, and small flower buds, harvested before flowers fully open. More heat-tolerant than common broccoli (handles up to ~95F) but best flavor and texture come in cool weather; bolts and turns bitter in heat. Cut the main stem to encourage tender side shoots for repeat harvest. Direct sow or transplant in the low-desert cool season.",
        'companions': ['Beet', 'Onion', 'Cilantro', 'Dill', 'Nasturtium', 'Marigold'],
        'antagonists': ['Tomato', 'Pepper', 'Strawberry'],
    },
    {
        'name': 'Adzuki Bean',
        ...
        'desert_transplant': None,
        'desert_harvest': ['06-15', '11-15'],
        'notes': "Vigna angularis — bushy warm-season legume grown for its small sweet red beans (the base of Asian red bean paste). Needs soil above 60F to sow and produces best with consistent warmth above 70F; flower drop occurs above ~95F, so time plantings to flower outside peak June heat — an early-spring sowing or a monsoon sowing for fall harvest both work. Nitrogen-fixer. Keep evenly moist through flowering and pod set; predawn irrigation reduces heat stress. Dry the pods on the plant for storage beans.",
        'companions': ['Corn', 'Squash (Summer)', 'Cucumber', 'Marigold'],
        'antagonists': ['Onion', 'Garlic', 'Fennel'],
    },
    {
        'name': 'Celtuce',
        ...
        'desert_seasons': ['cool'],
        'sow_indoor_weeks_before_transplant': 4,
        'desert_sow_outdoor': ['09-15', '02-01'],
        'desert_transplant': ['10-01', '02-15'],
        'desert_harvest': ['11-15', '04-15'],
        'notes': "Lactuca sativa var. asparagina (celtuce/stem lettuce/asparagus lettuce) — grown for its thick, crisp peeled stem eaten raw or stir-fried, plus young leaves. A cool-season crop best at 55-75F; bolts above ~80F (slow-bolt strains like 'Summer 38' resist). One of the lettuce types commercially grown in Arizona's low-desert river valleys. Give afternoon shade as the season warms. Harvest the stem just before flower stalks elongate for best texture.",
        'companions': ['Carrot', 'Radish', 'Beet', 'Onion', 'Cilantro'],
        'antagonists': ['Fennel'],
    },
    {
        'name': 'Damiana',
        ...
        'desert_transplant': ['03-15', '05-31'],
        'desert_harvest': ['06-01', '10-31'],
        'notes': "Turnera diffusa — small woody desert shrub native from southern Texas through Mexico and Central America, with aromatic chamomile-scented leaves used in herbal teas, smoking blends, and traditional Mexican liqueurs. A true heat lover that does not wilt on hot days and is drought-tolerant once established; needs excellent drainage and warmth, frost-sensitive so protect or grow as a container plant where winters dip below freezing. Harvest leaves while flowering in summer. Note many plants sold as damiana are actually T. ulmifolia (false damiana).",
        'companions': ['Lavender', 'Rosemary', 'Brittlebush'],
        'antagonists': [],
    },
    {
        'name': 'Canaigre',
        ...
        'desert_transplant': None,
        'desert_harvest': ['02-01', '05-01'],
        'notes': "Rumex hymenosepalus (canaigre/wild rhubarb/Arizona dock) — Sonoran Desert native perennial dock that leafs out after winter rains and goes summer-dormant underground in a tuberous root. Young leaves and peeled flower/leaf stalks are eaten tart like rhubarb (cooked; high in oxalates so eat in moderation). Blooms Jan-May. Prefers sandy loose soil like arroyo banks and floodplains; needs no summer water. Roots are also a classic source of tanning tannin. Plant tubers or sow in fall to follow the natural rain cycle.",
        'companions': ['Globe Mallow', 'Brittlebush', 'Desert Marigold'],
        'antagonists': [],
    },
    {
        'name': 'Wormwood',
        ...
        'desert_transplant': ['10-01', '03-31'],
        'desert_harvest': ['04-01', '10-31'],
        'notes': "Artemisia absinthium — aromatic silver-gray sub-shrub (24-36 in) historically used to flavor absinthe and vermouth and as a bittering/medicinal herb; also a strong insect-repellent companion at garden edges. Thrives in full sun and poor, rocky, sharply drained soil. Drought-tolerant but in low-desert summers it looks best with infrequent deep summer soakings; no winter water needed. Thujone content means culinary use should be limited. Plant from starts or sow seed indoors and transplant in the cool season.",
        'companions': ['Sage', 'Rosemary', 'Lavender'],
        'antagonists': ['Bean (Bush)', 'Pea', 'Fennel', 'Anise Hyssop'],
    },
    {
        'name': 'Egusi Melon',
        'category': 'vegetable',
        ...
        'desert_transplant': None,
        'desert_harvest': ['07-15', '11-30'],
        'notes': "Citrullus lanatus var. citroides — West/Central African seed melon grown not for flesh but for its fat oil- and protein-rich seeds (egusi), ground into soups and stews. A sprawling vine well adapted to semi-arid heat, producing on as little as 250-500 mm of water; germinates in 4-7 days and matures over 90-120 days, with seeds curing as the inedible fruit dries down. Sow after soil warms; a sprawling ground cover that benefits from monsoon-season planting. Let fruits fully dry on the vine before extracting seeds.",
        'companions': ['Corn', 'Bean (Bush)', 'Sunflower', 'Okra'],
        'antagonists': ['Potato'],
    },
]
...
def init_db():
    ...
    VARIETIES = [
        ...
        # ── NEW DESERT VARIETIES (research run 2026-06-02) ──
        ('Gai Lan', 'Early Jade', 'Fast uniform F1 kai-lan with tender thick stems and blue-green leaves.', 45, 60, 'moderate', None, 'sweet, mild broccoli-mustard', 'stems 8-10 in', 'blue-green', 'upright', 4, 'Quick-maturing hybrid that crops reliably across the long low-desert cool season; cut-and-come-again side shoots after the main stalk. Direct sow Sep-Feb.', 'reneesgarden.com; kitchengardenseeds.com'),
        ('Gai Lan', 'White Flower', 'Traditional open-pollinated kai-lan with white blossoms and robust stems.', 60, 70, 'moderate', None, 'slightly bitter, classic', 'stems to 12 in', 'medium green', 'upright', 4, 'Heirloom Chinese type; a touch slower and more cold-hardy than Early Jade. Harvest stems just as buds show for best tenderness in winter desert beds.', 'westcoastseeds.com'),
        ('Adzuki Bean', 'Express', 'Short-season adzuki selected for cooler/shorter windows.', 90, 100, 'high', None, 'sweet, nutty red bean', 'small red dry bean', 'deep red', 'compact bush', 4, 'Earliest-maturing adzuki — fits a spring sowing that finishes podding before peak June heat, or a monsoon sowing for fall dry beans. Nitrogen-fixer.', 'Heirloom'),
        ('Adzuki Bean', 'Erimo', 'Productive Japanese cultivar prized for paste quality.', 95, 110, 'high', None, 'rich, classic an-paste flavor', 'small glossy red bean', 'deep red', 'erect bush', 4, 'Standard paste-making adzuki; needs warmth above 70F and even moisture at pod set. Predawn irrigation limits flower drop in desert heat.', 'Japanese heirloom'),
        ('Celtuce', 'Summer 38', 'Slow-bolt celtuce holding longer as temperatures rise.', 45, 55, 'moderate', None, 'mild, nutty, crisp stem', 'thick stem to 12 in', 'pale green', 'upright rosette then stalk', 4, 'The most heat-resistant celtuce strain, extending the low-desert harvest into the warm shoulder weeks; still give afternoon shade. Peel and eat the stem raw or stir-fried.', 'tomorrowseeds.com; trueloveseeds.com'),
        ('Egusi Melon', 'Bara', 'West African landrace grown for large, flat, oil-rich seeds.', 100, 120, 'very high', None, 'nutty ground-seed (egusi)', 'sprawling vine, inedible flesh', 'mottled green fruit, cream seed', 'sprawling vine', 4, 'Heat- and drought-hardy seed melon; let fruits dry on the vine, then extract and dry seeds. Ideal monsoon-season ground cover in the low desert.', 'trueloveseeds.com; echocommunity.org'),
    ]
