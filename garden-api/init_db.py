...
PLANTS = [
    ...
    # ── ADDED 2026-06-01: extension-grounded desert edibles ──
    {
        ...
        "desert_transplant": ["03-01", "04-15"],
        "desert_harvest": ["04-15", "11-30"],
        "notes": "Tropical bog herb that needs constant moisture and afternoon shade in low desert; leaves scorch above ~105F, so site under 30-40% shade cloth or beneath taller plants and keep soil wet. Frost-tender below 45F, so pot it or take cuttings to overwinter indoors before December frost. Easiest from rooted cuttings or grocery-store stems rather than seed.",
        "companions": ["Mint", "Lemongrass"],
        "antagonists": [],
    },
    {
        "name": "Cuban Oregano",
        ...
        "desert_transplant": ["03-01", "04-30"],
        "desert_harvest": ["04-01", "11-30"],
        "notes": "Succulent-leaved tropical herb that handles desert heat well, but full afternoon sun burns the leaves, so give it morning sun with afternoon shade for lusher foliage. Drought tolerant once established and prone to rot if overwatered, so let soil dry between waterings. Frost-tender below ~40F, so move pots indoors or take cuttings before December frost.",
    ...
    },
    {
        ...
        "desert_seasons": ["cool"],
        "sow_indoor_weeks_before_transplant": 0,
        "desert_sow_outdoor": ["10-15", "12-15"],
        "desert_transplant": None,
        "desert_harvest": ["03-15", "05-15"],
        "notes": "Cool-season pulse that must mature before low-desert heat arrives, so direct-sow mid-fall through early winter to harvest before May; blooms abort above ~90F. Tolerates light frost to ~21F and poor soil, fixing its own nitrogen, so needs little fertilizer. Plant in a firm, well-drained seedbed and keep water low to avoid foliar disease.",
    ...
    },
    {
        ...
        "desert_sow_outdoor": None,
        "desert_transplant": ["02-15", "03-31"],
        "desert_harvest": ["11-15", "12-11"],
        "notes": "Heat-tolerant Andean tuber that thrives in low desert with afternoon shade, deep rich soil, and steady moisture; large leaves droop in midday heat but rebound by evening, so don't overwater wilted plants whose soil is still moist. Plant rhizomes in late winter for a long season and harvest after foliage is frost-killed in December. Shelter from drying wind, which it tolerates poorly.",
    ...
    },
    {
        ...
        "desert_transplant": ["10-01", "02-28"],
        "desert_harvest": ["11-01", "04-30"],
        "notes": "Cool-season evergreen perennial that grows through the mild low-desert winter but suffers and bolts in summer heat, so treat it as a fall-through-spring crop or give it deep afternoon shade to carry it over. Tolerates poor, neutral-to-alkaline, well-drained soil and light frost. Pinch flower stalks to keep tender young leaves coming, since only young foliage has the cucumber flavor.",
        "companions": ["Thyme", "Mint", "Strawberry"],
        "antagonists": [],
    },
    {
        "name": "Calamondin",
        ...
        "heat_tolerance": "high",
        "cold_tolerance": "moderate",
        "desert_seasons": ["warm", "cool"],
        "sow_indoor_weeks_before_transplant": 0,
        "desert_sow_outdoor": None,
        "desert_transplant": ["02-15", "05-15"],
        "desert_harvest": ["11-01", "03-31"],
        "notes": "One of the most cold-hardy citrus for the low desert (tolerates brief dips near 20F), a strong choice for 9b; plant in spring after frost danger or in fall, and protect young trees with frost cloth their first winters. Whitewash or shade the trunk to prevent sunburn in extreme summer heat, and water deeply but let soil drain between irrigations. Nearly everbearing, so fruit is available much of the year.",
        "companions": ["Marigold", "Nasturtium"],
        "antagonists": [],
    },
]
...
def init_db():
    ...
    VARIETIES = [
        ...
        # ── NEW DESERT VARIETIES (research run 2026-06-01) ──
