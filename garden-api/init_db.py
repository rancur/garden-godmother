...
PLANTS = [
    ...
    },
    {
        ...
        "desert_transplant": ["03-01", "04-15"],
        "desert_harvest": ["05-15", "10-31"],
        "notes": "Mild Mexican chile (1,000-2,000 SHU); dried form is ancho. Heart-shaped 4-inch fruits. Reliable desert producer with afternoon shade. Use for chile rellenos, mole, stuffed peppers. Plants 24-30in; stake or cage. Pick green or let ripen to dark red. Tolerates monsoon humidity better than bell peppers.",
        "companions": ["Tomato", "Basil", "Onion", "Carrot", "Marigold"],
        "antagonists": ["Fennel", "Brassicas"],
    },
    {
    ...
    },
    {
        ...
        "desert_sow_outdoor": ["02-01", "03-15"],
        "desert_transplant": None,
        "desert_harvest": ["10-15", "12-31"],
        "notes": "Helianthus tuberosus — Jerusalem artichoke. Plant tubers Feb-Mar; harvest after fall frost when tops die back. Grows 6-10ft tall with sunflower-like blooms; provides shade and trellis for understory crops. Aggressive spreader — contain in dedicated bed or large container. Tubers store best in ground. Inulin causes gas; ferment or cook well. Drought-tolerant once established. One of the few perennial root crops for low desert.",
        "companions": ["Corn", "Sunflower", "Bean (Pole)", "Squash"],
    ...
    },
    {
        ...
        "desert_harvest": ["04-15", "10-31"],
        "notes": "Agastache foenicum — perennial mint-family herb with licorice-anise scented leaves and tall lavender flower spikes. Major pollinator/hummingbird magnet. Leaves for tea, salads, baking. Needs afternoon shade in low desert; mulch heavily. Drought-tolerant once established. Related desert species (Agastache cana, A. rupestris) are even better adapted and equally edible. Self-seeds. Cut back hard in winter.",
        "companions": ["Tomato", "Pepper", "Basil", "Lavender", "Yarrow"],
        "antagonists": [],
    },
]
