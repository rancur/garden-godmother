...
PLANTS = [
    ...
    },
    {
        ...
        "notes": "Subtropical fruit tree with custard-like fruit. Performs in low desert with afternoon protection while young and deep, infrequent irrigation.",
        "companions": ["Pomegranate", "Fig", "Lemongrass", "Marigold"],
        "antagonists": ["None known"],
    },
    {
        "name": "Lemon Verbena",
        ...
        "desert_transplant": ["03-15", "05-31"],
        "desert_harvest": ["05-15", "11-15"],
        "notes": "Aromatic herb for teas and desserts. Loves heat but appreciates light afternoon shade in extreme low-desert summers.",
        "companions": ["Basil", "Chamomile", "Lavender", "Marigold"],
        "antagonists": ["Mint"],
    },
    {
        "name": "Summer Savory",
        ...
        "desert_transplant": ["03-15", "05-15"],
        "desert_harvest": ["05-01", "10-31"],
        "notes": "Peppery annual herb that tolerates heat and dry air better than many tender culinary herbs.",
        "companions": ["Bean (Bush)", "Onion", "Tomato", "Rosemary"],
    ...
    },
    {
        ...
        "notes": "Highly drought-tolerant warm-season grain/forage crop with reliable production in extreme heat.",
        "companions": ["Cowpea", "Sesame", "Okra", "Pigeon Pea"],
        "antagonists": ["None known"],
    },
    {
        "name": "Lablab Bean",
        ...
        "desert_transplant": None,
        "desert_harvest": ["07-01", "11-15"],
        "notes": "Hyacinth bean (Lablab purpureus) is a vigorous heat-loving legume grown for pods, dry beans, and forage.",
        "companions": ["Corn", "Okra", "Amaranth", "Sesame"],
        "antagonists": ["Onion"],
    },
    {
        "name": "Jute Mallow",
    ...
    },
    {
        ...
        "desert_transplant": ["02-15", "04-30"],
        "desert_harvest": ["08-01", "11-15"],
        "notes": "Mediterranean drought-tolerant tree producing sweet pods usable as flour/cocoa substitute. Performs in alkaline desert soils.",
        "companions": ["Olive", "Pomegranate", "Fig", "Mesquite"],
        "antagonists": ["None known"],
    },
...
def init_db():
    ...
    VARIETIES = [
        ...
        # ── NEW DESERT VARIETIES (research run 2026-03-30) ──
        ("Pepper", "NuMex Big Jim", "New Mexico chile with long mild-hot pods and strong heat-set in arid summers.", 75, 85, "high", None, "Earthy, mild-to-medium heat, great roasted", "Large (8-12 in)", "Green to red", "Upright bush", 4, "Classic Southwestern chile that performs well in desert heat with regular deep irrigation.", "New Mexico State breeding"),
        ("Pepper", "Aji Amarillo", "Peruvian C. baccatum pepper known for fruity heat and long productive season.", 90, 120, "high", None, "Fruity, citrusy, medium-hot", "Medium (4-5 in)", "Orange-yellow ripe", "Tall bush", 4, "Tolerates high heat better than many specialty peppers and keeps producing into warm fall weather.", "Andean heirloom"),
        ("Okra", "Louisiana Green Velvet", "Spineless heirloom okra with tender dark-green pods.", 55, 65, "excellent", None, "Mild, classic okra", "Medium pods (6-8 in)", "Green", "Tall upright (5-6 ft)", 5, "Extremely reliable in low-desert heat -- continuous harvest when pods are picked young.", "Open-pollinated"),
        ("Basil", "Mrs. Burns Lemon", "Heirloom lemon basil with intense citrus aroma and heat tolerance.", 55, 70, "high", None, "Strong lemon-citrus, sweet herbaceous", "Medium (18-24 in)", "Green", "Bushy", 4, "Handles desert heat better than many sweet basils when mulched and irrigated consistently.", "Heirloom"),

        # ── NEW VARIETIES (research run 2026-03-30 PM) ──
        ("Pomegranate", "Eversweet", "Low-acid pomegranate with very sweet arils and pale juice.", 730, 1095, "excellent", None, "Very sweet, low acid, mild", "Medium fruit", "Pink to light red", "Multi-trunk shrub/tree", 5, "Excellent desert adaptation with reliable fruit set and reduced tartness compared with Wonderful.", "Arizona grower selection"),
        ("Fig", "Brown Turkey", "Reliable common fig with extended harvest and good heat tolerance.", 365, 730, "excellent", None, "Honey-sweet, mild berry notes", "Medium fruit", "Brown-purple skin, amber-pink flesh", "Small tree", 4, "Dependable in low-desert heat with deep, infrequent irrigation and summer mulch.", "Heirloom"),
        ("Cowpea", "Mississippi Silver", "High-yield southern pea with heat and drought resilience.", 62, 82, "excellent", None, "Rich, creamy cowpea flavor", "Medium pods", "Cream seed", "Bush", 5, "Strong pod set under high temperatures and low humidity; well suited to Arizona summer production.", "Open-pollinated"),
