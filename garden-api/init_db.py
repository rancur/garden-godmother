...
PLANTS = [
    ...
    },
    {
        ...
        "desert_transplant": ["03-01", "05-01"],
        "desert_harvest": ["05-15", "10-15"],
        "notes": "Melothria scabra — Mexican sour gherkin, mouse melon, sandita. Grape-sized cucumber-watermelon-look fruit with citrusy crunch. Vining 8-10 ft, needs trellis. Heat and drought tolerant once established — outperforms regular cucumber through Sonoran summer. Tuberous root overwinters in mild zones, can be replanted. Few pests in desert. Eat raw, pickle, or add to salsas.",
        "companions": ["Bean", "Corn", "Radish", "Sunflower", "Nasturtium", "Marigold"],
    ...
    },
    {
        ...
        "sow_indoor_weeks_before_transplant": 0,
        "desert_sow_outdoor": ["10-01", "01-31"],
        "desert_transplant": [None, None],
        "desert_harvest": ["03-01", "05-15"],
        "notes": "Chenopodium quinoa — Andean pseudocereal. Drought tolerant and salt tolerant but flowers abort above ~95F, so direct-sow in fall for harvest before May. Cherry Vanilla, Brightest Brilliant, and Biobio varieties handle desert best. Saponin coating must be rinsed off seeds before eating. Leaves edible like spinach. Heads ready when seeds resist thumbnail crush.",
    ...
    },
    {
        ...
        "desert_transplant": ["03-01", "04-15"],
        "desert_harvest": ["05-15", "11-15"],
        "notes": "Capsicum annuum 'Shishito' — thin-walled Japanese frying pepper, mild with ~1 in 10 hot. Highly productive in desert if shade-clothed (30-40%) at peak. Pick at 2-4 in green. Single plant can yield 50+ peppers per season. Best blistered in hot pan with sea salt. Outlasts bell peppers through the Sonoran summer.",
        "companions": ["Tomato", "Basil", "Carrot", "Onion", "Marigold"],
        "antagonists": ["Fennel", "Brassicas"],
    },
    {
        ...
        "notes": "Cynara cardunculus — Mediterranean artichoke relative grown for blanched leaf stalks rather than buds. Hardy perennial in 9b/10a, often treated as annual. Striking 4-5 ft silver-leaved architectural plant — also doubles as ornamental. Blanch stalks by wrapping with cardboard for 3-4 weeks before harvest to reduce bitterness. Stalks braised like celery in Italian cuisine. Drought tolerant once established.",
        "companions": ["Pea", "Bean", "Sunflower"],
        "antagonists": [],
    },
    {
        "name": "Komatsuna",
        ...
        "desert_transplant": [None, None],
        "desert_harvest": ["10-15", "04-15"],
        "notes": "Brassica rapa var. perviridis — Japanese mustard spinach. Faster, more bolt-resistant, and more heat tolerant than spinach or bok choy — performs through warm shoulder weeks where spinach fails. Mild flavor between mustard and spinach. Cut-and-come-again or harvest whole head at 6-8 in. Direct sow every 2-3 weeks for continuous baby greens. Flea beetles can be a problem — use row cover.",
        "companions": ["Carrot", "Beet", "Onion", "Dill", "Chamomile"],
        "antagonists": ["Tomato", "Pepper", "Strawberry"],
    },
    {
        "name": "Devil's Claw",
        ...
        "desert_transplant": [None, None],
        "desert_harvest": ["07-01", "10-31"],
        "notes": "Proboscidea parviflora — Sonoran native, traditional Tohono O'odham crop (i:hug). Young green pods (3-6 in) eaten like okra; dried mature pods split into the iconic black claws used in basketry. Domesticated white-seed strain has longer claws than wild form. Extremely heat and drought tolerant — needs only monsoon rains once established. Direct sow after soil hits 70F; soak seeds 24h to improve germination. Sticky glandular foliage traps small insects.",
        "companions": ["Tepary Bean", "Amaranth", "Sorghum", "Sunflower"],
        "antagonists": [],
    },
    {
        "name": "Anise Hyssop",
        ...
        "desert_transplant": ["10-15", "03-31"],
        "desert_harvest": ["03-01", "11-30"],
        "notes": "Agastache foeniculum — short-lived perennial mint relative with licorice-anise scent. Hardy and drought tolerant once established; best with afternoon shade in Phoenix summers. Edible leaves and lavender flower spikes for teas, salads, baked goods. Top-tier pollinator plant — pulls bees, hummingbirds, and predatory wasps. Self-seeds. Cut back after first bloom flush for repeat. Seeds need light to germinate — surface sow.",
        "companions": ["Tomato", "Pepper", "Eggplant", "Squash (Summer)", "Cucumber"],
        "antagonists": [],
    },
    {
        "name": "Pineapple Sage",
        ...
        "desert_transplant": ["03-01", "05-01"],
        "desert_harvest": ["04-01", "11-30"],
        "notes": "Salvia elegans — tender perennial with intense pineapple-scented leaves and brilliant red tubular flowers in fall. Survives mild 9b/10a winters with light protection; freezes back below 25F but typically returns. Afternoon shade preferred when summer highs exceed 110F. Leaves for teas, fruit salads, garnish; flowers edible and a major hummingbird draw. Honey Melon and Tangerine Sage cultivars also worth growing.",
        "companions": ["Tomato", "Pepper", "Basil", "Rosemary"],
        "antagonists": ["Cucumber"],
    },
]
