...
PLANTS = [
    ...
    },
    {
        ...
        "desert_transplant": ["03-01", "04-15"],
        "desert_harvest": ["05-15", "10-15"],
        "notes": "Melothria scabra — Mexican sour gherkin, also called mouse melon. Native to Mexico/Central America so well-adapted to heat. Vines grow 8-10 ft and need a trellis. Tiny grape-sized fruit looks like miniature watermelon, tastes like cucumber with a citrus tang. Drought-tolerant once established and largely pest-free. Forms tubers that can overwinter and resprout. Trellis vertically; afternoon shade helps in extreme heat. Good monsoon producer.",
    ...
    },
    {
        ...
        "desert_transplant": None,
        "desert_harvest": ["02-15", "05-15"],
        "notes": "Chenopodium quinoa — Andean pseudo-grain. Grown as a fall/winter crop in low desert; pollen drops above 95F so it must mature before late spring heat. Drought-tolerant once established and tolerates poor and saline soils. Direct-sow shallow in cool weather. Heads change color when ripe; harvest when seeds resist a thumbnail. Rinse seeds thoroughly to remove bitter saponins. Leaves are edible like spinach. Cherry Vanilla and Brightest Brilliant Rainbow are reliable colorful varieties.",
        "companions": ["Bean", "Corn", "Sunflower", "Amaranth"],
    ...
    },
    {
        ...
        "desert_transplant": ["10-01", "03-31"],
        "desert_harvest": None,
        "notes": "Chilopsis linearis — Sonoran/Chihuahuan native small tree to 25 ft. Not a true willow; orchid-like trumpet blooms in pink, lavender, burgundy, or white through summer feed hummingbirds and native bees. Deciduous in winter. Extremely drought-tolerant once established but blooms heavier with deep monthly summer water. Prefers well-drained soil; intolerant of frequent shallow irrigation and lawn turf. Cultivars 'Bubba', 'Burgundy', 'Warren Jones' are popular sterile or heavy-blooming selections.",
        "companions": ["Texas Sage", "Globe Mallow", "Desert Milkweed", "Penstemon"],
        "antagonists": [],
    },
    {
        "name": "Sorrel",
        ...
        "desert_sow_outdoor": ["09-15", "02-28"],
        "desert_transplant": ["10-01", "03-15"],
        "desert_harvest": ["10-15", "05-15"],
        "notes": "Rumex acetosa (common) and Rumex scutatus (French) — perennial lemony green. In low desert grow as cool-season; goes dormant or dies back under triple-digit heat, often returning from the taproot in fall with mulch and afternoon shade. Pinch flower stalks to keep tender. High in oxalic acid — eat in moderation. Excellent in soups, sauces (sauce verte), and salads. Easy from seed; divides readily.",
        "companions": ["Strawberry", "Lettuce", "Spinach", "Mint"],
        "antagonists": [],
    },
    {
        "name": "Anise Hyssop",
        ...
        "desert_sow_outdoor": ["09-15", "03-15"],
        "desert_transplant": ["10-01", "03-31"],
        "desert_harvest": ["03-15", "11-15"],
        "notes": "Agastache foeniculum — North American prairie native, hardy USDA 4-9 and surprisingly tough in low desert with afternoon shade. Licorice-anise scented leaves and tall lavender flower spikes. One of the top pollinator magnets — feeds native bees, honeybees, and hummingbirds nonstop. Use leaves and flowers fresh in salads, teas, and as garnish. Drought-tolerant once established, dislikes wet feet. Self-seeds modestly. For pure desert heat consider sister species Agastache rupestris (Sunset Hyssop).",
        "companions": ["Lavender", "Yarrow", "Echinacea", "Tomato", "Pepper"],
        "antagonists": [],
    },
]
