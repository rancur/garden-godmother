...
PLANTS = [
    ...
    },
    {
        ...
        "notes": "Cicer arietinum. Cool-season pulse for low desert; direct sow in fall/winter and finish before sustained heat.",
        "companions": ["Carrot", "Cilantro", "Cumin", "Lettuce"],
...
def init_db():
    ...
    VARIETIES = [
        ...
        # ── NEW VARIETIES (research run 2026-04-02) ──
        ("Chaya", "Estrella", "Spineless chaya selection with high leaf production in heat.", 75, 110, "excellent", None, "Mild when cooked, spinach-like", "Leaf harvest", "Green", "Shrubby perennial", 5, "Strong low-desert performer with afternoon shade in peak summer and deep weekly irrigation.", "Regional selection"),
        ("Jicama", "San Juan", "Early jicama line adapted for shorter warm-season windows.", 120, 150, "high", None, "Mild, crisp, sweet", "Medium roots", "Tan skin, white flesh", "Vining", 4, "Start early in spring and trellis vines; harvest before first cold snap for best root size.", "Heirloom"),
        ("Purslane", "Golden", "Tender yellow-green purslane for salad and stir-fry use.", 28, 40, "excellent", None, "Lemony, succulent", "Small succulent leaves", "Chartreuse-gold", "Low spreading", 5, "One of the most heat- and drought-adapted edible greens for summer desert beds and containers.", "Open-pollinated"),

        # ── NEW VARIETIES (research run 2026-04-02b) ──
        ("Sorghum", "Macia", "Early grain sorghum known for drought resilience and reliable yields.", 95, 115, "excellent", None, "Mild nutty grain flavor", "Medium grain heads", "Cream-tan grain", "Upright", 5, "Strong performer in hot, low-water environments; suitable for summer grain production in low desert.", "ICRISAT"),
        ("Chickpea", "Sarah", "Kabuli-type chickpea selected for heat and disease tolerance.", 95, 110, "high", "Ascochyta tolerance", "Nutty, creamy", "Medium seed", "Beige", "Bushy", 4, "Best when planted for cool-season finish; handles spring heat better than many chickpea lines.", "Breeding line"),
        ("Guar", "Matador", "High-vigor guar selection for hot dry climates and low-input systems.", 85, 105, "excellent", None, "Mild green bean flavor when young", "Medium pods", "Green", "Upright branching", 5, "Excellent drought adaptation and heat set under monsoon-season temperatures.", "Open-pollinated"),
        ("Lablab Bean", "Rongai", "Dual-purpose lablab bean with strong summer vigor and forage value.", 75, 95, "excellent", None, "Beany, slightly sweet when young", "Medium pods", "Green to purple", "Vigorous vine", 5, "Thrives in heat and can be used as edible pod, dry bean, or summer cover crop in low desert.", "East African selection"),
        ("Sesame", "S-34", "Compact sesame selection with good seed set under heat stress.", 95, 110, "excellent", None, "Rich, nutty", "Small capsules", "Cream-white seed", "Upright", 5, "Reliable in low-humidity desert summers; reduce irrigation near maturity for clean dry-down.", "Open-pollinated"),
