...
def init_db():
    ...
    VARIETIES = [
        ...
        # ── NEW VARIETIES (research run 2026-04-03) ──
        ("Tomato", "Phoenix VFN", "Improved Phoenix-type heat-set tomato with added disease package.", 67, 80, "excellent", "VFN", "Balanced, classic slicer flavor", "Medium (6-8 oz)", "Red", "Determinate", 5, "Bred for hot, arid production; dependable fruit set in late spring desert heat.", "Regional release"),
        ("Pepper", "NuMex Joe E. Parker", "New Mexico chile with strong heat tolerance and roasting quality.", 75, 85, "excellent", None, "Mild-medium heat, rich chile flavor", "Long pods (6-8 in)", "Green to red", "Upright bush", 5, "Very reliable pod set in high heat with regular deep irrigation.", "New Mexico State University"),
        ("Okra", "Cajun Jewel", "Compact spineless okra suited to container or small-bed summer production.", 50, 60, "excellent", None, "Tender, mild", "Medium pods (3-5 in)", "Green", "Compact upright", 5, "Handles 100F+ with continued pod set; harvest frequently for tenderness.", "Open-pollinated"),
        ("Basil", "Prospera DMR", "Downy mildew resistant sweet basil with strong summer vigor.", 55, 70, "high", "Downy mildew resistant", "Sweet Genovese profile", "Medium leaves", "Green", "Bushy upright", 4, "Good hot-weather basil option for desert gardens when regularly irrigated.", "Hybrid"),
        ("Pomegranate", "Eversweet", "Low-acid soft-seeded pomegranate with excellent home-garden flavor.", 730, 1095, "excellent", None, "Sweet, very low acidity", "Medium-large fruit", "Pink-red", "Multi-trunk shrub/tree", 5, "Excellent low-desert adaptation and dependable production in alkaline soils.", "Heirloom cultivar"),
