...
PLANTS = [
    ...
    },
    {
        ...
        "desert_transplant": ["03-01", "04-15"],
        "desert_harvest": ["05-15", "10-31"],
        "notes": "Melothria scabra, also called Mexican Sour Gherkin or Mouse Melon. Grape-sized fruits taste like cucumber with a citrus tang. Native to Mexico/Central America — much more drought and heat tolerant than common cucumber. Vigorous vining plant — needs a trellis (6-8 ft). Forms tubers that can be overwintered for earlier production next year. Pest-resistant, almost no spider mite problems unlike standard cucumbers. Slow to start but extremely productive once established.",
        "companions": ["Bean (Bush)", "Corn", "Sunflower", "Marigold", "Nasturtium", "Radish"],
    ...
    },
    {
        ...
        "desert_harvest": ["10-15", "05-31"],
        "notes": "Allium × proliferum — perennial onion that produces topsets (bulbils) at the top of the stalk that bend over and 'walk' to root in new ground. Plant bulbils or divisions in fall. Extremely cold-hardy and heat-tolerant once established. In desert, give afternoon shade and mulch heavily through summer — goes semi-dormant in extreme heat but rarely dies out. Use green tops year-round, harvest bulbils for replanting or pickling. One of the lowest-maintenance allium choices for the low desert.",
        "companions": ["Carrot", "Beet", "Lettuce", "Strawberry", "Tomato", "Chamomile"],
        "antagonists": ["Bean (Bush)", "Pea", "Asparagus"],
    },
    {
        "name": "Saffron Crocus",
        "category": "herb",
        ...
        "sow_indoor_weeks_before_transplant": None,
        "desert_sow_outdoor": None,
        "desert_transplant": ["08-15", "09-30"],
        "desert_harvest": ["10-15", "11-30"],
        "notes": "Crocus sativus — produces the world's most expensive spice from three red stigmas per flower. Plant corms 4 inches deep in late summer. Blooms in fall, foliage persists through winter, dormant through hot summer (which mimics its native Mediterranean climate). Low desert is well-suited because of dry summer dormancy. Needs excellent drainage — rot is the main risk. Harvest stigmas at dawn as flowers open. ~150 flowers per gram of dried saffron. Lift and divide corms every 4-5 years.",
        "companions": ["Rosemary", "Lavender", "Thyme", "Sage"],
        "antagonists": [],
    },
    {
        ...
        "desert_harvest": ["04-15", "11-30"],
        "notes": "Persicaria odorata, also called rau ram or laksa leaf. Cilantro substitute that thrives in summer when cilantro bolts. Tropical perennial — does not tolerate frost, treat as warm-season annual or overwinter in container indoors. Loves heat AND moisture — best in partial shade with consistent water (won't tolerate drought). Roots easily from cuttings in water. Essential in Vietnamese cuisine: pho garnish, salads, spring rolls. In Phoenix area, grow in dappled shade or east-facing exposure for best results.",
        "companions": ["Mint", "Lemongrass", "Basil", "Ginger", "Turmeric"],
        "antagonists": [],
    },
    {
        "name": "Poblano Pepper",
    ...
    },
    {
        ...
        "desert_transplant": None,
        "desert_harvest": ["02-15", "05-15"],
        "notes": "Chenopodium quinoa — Andean pseudo-cereal, complete protein. Native to high-elevation cool dry climates. In low desert, treat as a cool-season crop: plant Oct-Jan, harvest Feb-May before summer heat shuts down seed set (won't pollinate above 95F). 'Cherry Vanilla' and 'Brightest Brilliant Rainbow' tolerate more heat than 'Faro'. Drought tolerant once established. Looks like a spinach relative early on (it is — both are Chenopodium). Rinse seeds thoroughly to remove bitter saponins before cooking. Birds love the seedheads — net or harvest at first sign of dropping.",
        "companions": ["Bean (Bush)", "Corn", "Sunflower"],
        "antagonists": ["Spinach", "Beet"],
    },
    {
        "name": "Thai Basil",
        "category": "herb",
        ...
        "desert_transplant": ["03-01", "05-01"],
        "desert_harvest": ["04-15", "10-31"],
        "notes": "Ocimum basilicum var. thyrsiflora — sturdier and more heat-tolerant than sweet basil. Anise/licorice notes with a clovey finish. Purple stems and flowers. Essential in pho, drunken noodles, green curry. Holds up to high heat better than Genovese basil — sets seed instead of bolting in extreme conditions. Pinch flowers to prolong leaf production, or let bloom for pollinators (bees love it). Does not tolerate frost. Provide afternoon shade above 110F to keep leaves tender.",
        "companions": ["Tomato", "Pepper", "Oregano", "Marigold", "Lemongrass"],
        "antagonists": ["Rue", "Sage"],
    },
]
