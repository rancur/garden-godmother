...
PLANTS = [
    ...
    },
    {
        ...
        "desert_transplant": None,
        "desert_harvest": ["06-01", "10-15"],
        "notes": "Phaseolus lunatus — also called butter bean. One of the better hot-weather beans for the low desert. Sets pods at higher temperatures than common beans. Pole types ('Christmas', 'King of the Garden') outperform bush types in heat. Direct sow after soil reaches 65F. Nitrogen-fixing legume. Inoculate seeds with rhizobium for best yields. Soak seeds overnight before planting. Avoid overhead watering during flowering to prevent blossom drop.",
        "companions": ["Corn", "Squash (Summer)", "Cucumber", "Radish", "Marigold"],
        "antagonists": ["Onion", "Garlic", "Fennel"],
    },
    {
        "name": "Cardoon",
        ...
        "desert_seasons": ["cool", "warm"],
        "sow_indoor_weeks_before_transplant": 6,
        "desert_sow_outdoor": ["09-15", "10-31"],
        "desert_transplant": ["10-01", "11-30"],
        "desert_harvest": ["02-15", "05-15"],
        "notes": "Cynara cardunculus — Mediterranean relative of artichoke grown for edible blanched leaf stalks rather than flower buds. Excellent for low desert as a cool-season perennial; survives mild winters and grows huge (4-6ft). Blanch stalks 3-4 weeks before harvest by wrapping with cardboard or burlap to reduce bitterness. Tolerates alkaline soils. Reseeds aggressively — deadhead unwanted flowers. Striking silver-grey foliage doubles as ornamental.",
    ...
    },
    {
        ...
        "desert_harvest": ["05-01", "10-31"],
        "notes": "Agastache foeniculum — drought-tolerant perennial herb with anise-licorice flavored leaves used in teas, salads, and desserts. Magnet for native bees, honeybees, and hummingbirds — one of the highest-nectar pollinator plants. Tolerates desert heat with afternoon shade and infrequent deep watering. Hardy perennial in Zone 9b/10a. Cold-stratify seeds for 30 days before sowing. 'Blue Fortune' and 'Golden Jubilee' are robust cultivars.",
        "companions": ["Tomato", "Pepper", "Squash (Summer)", "Cucumber", "Basil"],
        "antagonists": [],
    },
    {
        "name": "Pistachio",
        ...
        "notes": "Pistacia vera — exceptionally well-suited to Sonoran low desert. Requires hot dry summers and cold winters with 600-1000 chill hours; some southern AZ sites are marginal on chill but cultivars like 'Kerman' (female) with 'Peters' (male) pollinator are productive. Dioecious — must plant male and female trees, ratio about 1 male per 8-10 females. Bears 5-7 years from grafted trees. Deep taproot tolerates poor caliche soils. Avoid overwatering — root rot is the #1 killer. Alternate bears: heavy crop one year, light the next.",
        "companions": [],
        "antagonists": [],
    },
    {
        ...
        "notes": "Citrus maxima — largest citrus fruit, ancestor of grapefruit. Sweeter and less bitter than grapefruit. Reliable producer in Zone 9b/10a. Protect young trees from frost below 28F. Bloom in spring, fruit ripens through winter. 'Chandler' is the premier cultivar with pink flesh and excellent flavor. 'Reinking' has white flesh. Self-fruitful but bears better with pollinator. Same care as grapefruit — deep infrequent watering, citrus fertilizer 3x/year (Feb, May, Aug), whitewash trunks to prevent sunscald.",
        "companions": ["Nasturtium", "Borage", "Marigold"],
        "antagonists": [],
    },
    {
        "name": "Calamondin",
        ...
        "desert_sow_outdoor": None,
        "desert_transplant": ["02-15", "04-15"],
        "desert_harvest": ["10-01", "04-30"],
        "notes": "Citrus × microcarpa — also called calamansi or Philippine lime. Compact citrus tree (8-15ft) excellent for containers and small yards. Almost-everbearing — produces fruit year-round in low desert with peak in winter. Tart juice used in Filipino cuisine, marinades, beverages. More cold-tolerant than lime, hardy to about 25F when established. Self-fruitful. Heavy bloomer attracts bees. Standard citrus care: deep water every 7-14 days in summer, citrus fertilizer 3x/year. Excellent ornamental — glossy leaves, fragrant white blossoms, bright orange fruit.",
        "companions": ["Nasturtium", "Borage", "Marigold"],
        "antagonists": [],
    },
    {
        ...
        "desert_transplant": ["10-01", "02-28"],
        "desert_harvest": ["11-01", "04-30"],
        "notes": "Rumex acetosa (garden sorrel) and Rumex scutatus (French sorrel). Tangy lemon-flavored leaves used in soups, salads, and sauces. Cool-season perennial — treat as winter annual in low desert; goes dormant or dies back in summer heat. Plant in afternoon shade for longest harvest window. Cut flower stalks to keep leaves tender. High in oxalic acid; eat in moderation. Reseeds and spreads from rhizomes — contain or harvest aggressively to manage.",
        "companions": ["Strawberry", "Lettuce", "Spinach"],
        "antagonists": [],
    },
    {
        "name": "Magenta Spreen",
    ...
    },
    {
        ...
        "notes": "Smallanthus sonchifolius — Andean tuber crop also called Peruvian ground apple. Crisp, sweet, juicy tubers eaten raw like jicama or apple; sweetness comes from inulin (prebiotic, low glycemic — diabetic-friendly). Frost kills tops but tubers are harvested after first light frost when sugars develop. Plant rhizome divisions in spring; mulch heavily and provide afternoon shade in low desert. Yields 10-30 lbs per plant. Save crowns (separate from edible tubers) for replanting next season. No common pests in desert.",
        "companions": ["Corn", "Sunflower", "Bean (Bush)"],
        "antagonists": [],
    },
]
