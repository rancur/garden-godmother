...
PLANTS = [
    ...
    # === 2026-05-18 RESEARCH BATCH ===
    {
        ...
        "desert_transplant": ["03-01", "05-01"],
        "desert_harvest": ["05-15", "10-15"],
        "notes": "Melothria scabra — also called Mexican sour gherkin or mouse melon. Grape-sized cucumber-like fruit with citrus tang. Native to Mexico/Central America, well-adapted to AZ heat. Vigorous vine needs trellis. Drought-tolerant once established. Tuberous roots can overwinter underground and resprout. Pickle or eat fresh. Highly productive through monsoon.",
        "companions": ["Bean", "Corn", "Radish", "Sunflower", "Nasturtium"],
        "antagonists": ["Potato"],
    },
    {
        "name": "Lablab Bean",
        ...
        "desert_transplant": None,
        "desert_harvest": ["06-01", "11-15"],
        "notes": "Lablab purpureus — also called hyacinth bean. Extreme heat- and drought-tolerant tropical legume. Beautiful purple flowers and pods, ornamental and edible (mature beans MUST be boiled, water changed, to remove cyanogenic glycosides; young pods are safer). Excellent N-fixer and monsoon cover crop. Perennial in frost-free spots, grown as annual elsewhere. Direct sow when soil is warm.",
    ...
    },
    {
        ...
        "heat_tolerance": "high",
        "cold_tolerance": "low",
        "desert_seasons": ["monsoon"],
        "sow_indoor_weeks_before_transplant": 4,
        "desert_sow_outdoor": ["06-15", "07-31"],
        "desert_transplant": ["07-01", "08-15"],
        "desert_harvest": ["09-15", "12-01"],
        "notes": "Psophocarpus tetragonolobus — tropical legume where every part is edible: pods, leaves, flowers, seeds, and tuberous roots. Loves heat and humidity, so plant for monsoon and short-day-induced flowering in fall. Needs sturdy trellis (8+ ft). Short-day plant; flowers as days shorten in fall. Nitrogen fixer. Strong drought tolerance once established.",
        "companions": ["Corn", "Squash", "Okra", "Sorghum"],
        "antagonists": ["Onion", "Garlic", "Fennel"],
    },
    {
        "name": "Pepino Melon",
        ...
        "notes": "Solanum muricatum — Andean fruit relative of tomato and eggplant, melon-honeydew flavor with purple-streaked yellow skin. Tender perennial, hardy to ~28F. Afternoon shade essential in desert summer; fruit set stalls above 95F like tomato. Propagate from cuttings — much faster than seed. Best on a trellis or staked. Mulch heavily. Produces in cool months and shoulder seasons.",
        "companions": ["Basil", "Marigold", "Nasturtium", "Carrot"],
        "antagonists": ["Fennel", "Brassicas"],
    },
    {
        "name": "Yacon",
        ...
        "notes": "Smallanthus sonchifolius — Andean tuber with sweet, crunchy, apple-pear flavor. Stores inulin (FOS) rather than starch, so it's low-glycemic. Propagated from rhizome divisions, not seeds or tubers. Needs afternoon shade in low desert; tops die back at frost but rhizomes survive light freezes if mulched. Harvest tubers after first frost when sugars develop. Highly productive (10-20+ lbs per plant).",
        "companions": ["Bean", "Corn", "Squash", "Marigold"],
        "antagonists": [],
    },
    {
        "name": "Sorrel",
        ...
        "notes": "Rumex acetosa (common sorrel) and Rumex scutatus (French sorrel) — perennial lemony-tart green. Treat as cool-season in low desert; goes dormant or struggles in extreme summer heat. French sorrel tolerates more heat than common sorrel. Afternoon shade and consistent moisture extend harvest. Remove flower stalks to prolong leaf production. Use fresh in soups, sauces, salads — oxalic acid is high so eat moderately.",
        "companions": ["Strawberry", "Lettuce", "Chive"],
        "antagonists": [],
    },
    {
        "name": "Galangal",
    ...
    },
    {
        ...
        "notes": "Levisticum officinale — tall perennial with intense celery-anise flavor; one plant supplies a household. Cold-hardy but suffers in low-desert summer; treat as cool-season annual or place in deep afternoon shade with heavy mulch to summer over. Hollow stalks usable as straws for Bloody Marys. Leaves, seeds, and roots all edible. Heavy feeder, deep rooted, prefers consistent moisture.",
        "companions": ["Bean", "Brassicas", "Tomato"],
        "antagonists": [],
    },
    {
        "name": "Caraway",
