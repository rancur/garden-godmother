...
PLANTS = [
    ...
    },
    {
        ...
        "companions": ["Okra", "Amaranth", "Black-eyed Pea", "Basil"],
        "antagonists": ["None significant"],
    },
    {
        "name": "Guava",
    ...
    # Duplicate Amaranth removed (kept entry at line ~2532)
    {
        "name": "Cassava",
        "category": "vegetable",
        "subcategory": "root",
    ...
    # Duplicate Sesame removed (kept entry at line ~2572)
    {
        "name": "Fenugreek",
        "category": "herb",
    ...
    # ── ANAHEIM PEPPER ──
        ...
        "desert_transplant": ["03-01", "04-15"],
        "desert_harvest": ["06-01", "10-31"],
        "notes": "Reliable Southwestern chile for roasting and green chile sauces. More productive than bells in summer heat.",
        "companions": ["Tomato", "Basil", "Onion", "Carrot", "Marigold"],
        "antagonists": ["Fennel", "Brassicas"],
    },
    # ── APRICOT ──
        {
        ...
        "desert_sow_outdoor": None,
        "desert_transplant": ["12-01", "02-28"],
        "desert_harvest": ["05-01", "06-30"],
        "notes": "Use low-chill cultivars in low desert and place in frost-protected sites to avoid bloom loss.",
        "companions": ["Garlic", "Chive", "Yarrow", "Marigold"],
        "antagonists": ["Walnut"],
    },
    # ── BITTER MELON ──
        {
        ...
        "sow_indoor_weeks_before_transplant": 3,
        "desert_sow_outdoor": ["03-15", "06-30"],
        "desert_transplant": ["04-01", "07-15"],
        "desert_harvest": ["06-15", "10-31"],
        "notes": "Heat-loving cucurbit that thrives in long hot summers. Trellis for straighter fruit and lower disease pressure.",
        "companions": ["Bean (Bush)", "Marigold", "Nasturtium", "Basil"],
        "antagonists": ["Potato"],
    },
    # Duplicate Black-Eyed Pea removed (kept "Black-eyed Pea" entry at line ~2452)
    # ── BLOOD ORANGE ──
        {
        "name": "Blood Orange",
        "category": "fruit",
        "subcategory": "citrus tree",
        "days_to_maturity_min": 1095,
        "days_to_maturity_max": 1460,
        "spacing_inches": 144,
        "sun": "full",
        ...
        "sow_indoor_weeks_before_transplant": 0,
        "desert_sow_outdoor": None,
        "desert_transplant": ["02-01", "04-01"],
        "desert_harvest": ["12-15", "03-31"],
        "notes": "Productive citrus option for low desert with deep irrigation, iron support in alkaline soils, and frost protection while young.",
        "companions": ["Basil", "Marigold", "Comfrey", "Clover"],
        "antagonists": ["Black Walnut"],
    },
    # ── BOTTLE GOURD ──
        {
        ...
        "desert_transplant": ["04-01", "07-15"],
        "desert_harvest": ["06-15", "11-15"],
        "notes": "Vigorous heat-loving vine (calabash) grown for tender immature fruit and mature hard-shell gourds. Excellent monsoon-season productivity on trellis.",
        "companions": ["Black-eyed Pea", "Corn", "Sunflower", "Marigold"],
        "antagonists": ["Potato"],
    },
    # ── CAPER ──
        {
        ...
        "desert_transplant": ["03-01", "04-30"],
        "desert_harvest": ["05-01", "09-30"],
        "notes": "Capparis spinosa. Xeric shrub prized for edible flower buds (capers); thrives in reflected heat and lean soil.",
        "companions": ["Rosemary", "Lavender", "Thyme", "Oregano"],
        "antagonists": [],
    },
    # ── CAROB ──
        {
        ...
        "sow_indoor_weeks_before_transplant": 0,
        "desert_sow_outdoor": None,
        "desert_transplant": ["02-15", "04-30"],
        "desert_harvest": ["08-01", "11-30"],
        "notes": "Ceratonia siliqua is a classic Mediterranean dryland tree used for edible pods and shade. Very drought tolerant after establishment and handles alkaline soils well.",
        "companions": ["Olive", "Pomegranate", "Rosemary", "Lavender"],
        "antagonists": ["None known"],
    },
    # Duplicate Tamarind removed (kept entry at line ~2935; comment said "Chickpea" but was Tamarind)
    # ── CRANBERRY HIBISCUS ──
        {
        "name": "Cranberry Hibiscus",
        "category": "herb",
        "subcategory": "edible ornamental",
        "days_to_maturity_min": 70,
        "days_to_maturity_max": 100,
        "spacing_inches": 24,
        "sun": "full to partial",
        ...
        "desert_seasons": ["warm", "monsoon"],
        "sow_indoor_weeks_before_transplant": 6,
        "desert_sow_outdoor": ["03-15", "06-15"],
        "desert_transplant": ["04-01", "07-01"],
        "desert_harvest": ["06-01", "11-15"],
        "notes": "Hibiscus acetosella. Tangy red leaves for salads and tea blends; reliable in heat with afternoon shade in peak summer.",
        "companions": ["Roselle", "Basil", "Pepper", "Marigold"],
        "antagonists": ["Rosemary"],
    },
    # ── CULANTRO ──
        {
        "name": "Culantro",
        ...
        "desert_seasons": ["warm", "monsoon"],
        "sow_indoor_weeks_before_transplant": 6,
        "desert_sow_outdoor": ["04-01", "07-31"],
        "desert_transplant": ["04-15", "08-15"],
        "desert_harvest": ["06-01", "10-31"],
        "notes": "Eryngium foetidum has cilantro-like flavor and far better heat performance. In low desert, grow with afternoon shade and steady moisture to delay bolting.",
        "companions": ["Pepper", "Eggplant", "Basil", "Okra"],
        "antagonists": ["None known"],
    },
    # ── DESERT HACKBERRY ──
        {
        ...
        "desert_sow_outdoor": ["02-15", "04-15"],
        "desert_transplant": ["03-01", "05-01"],
        "desert_harvest": ["08-01", "10-31"],
        "notes": "Celtis pallida. Sonoran native shrub/tree with sweet orange berries and exceptional drought/heat tolerance.",
        "companions": ["Mesquite", "Desert Chia", "Globe Mallow", "Baja Fairy Duster"],
        "antagonists": [],
    },
    # ── DESERT WOLFBERRY ──
        {
        "name": "Desert Wolfberry",
        "category": "fruit",
        "subcategory": "native edible",
        "days_to_maturity_min": 730,
        "days_to_maturity_max": 1460,
        ...
        "desert_seasons": ["warm", "monsoon"],
        "sow_indoor_weeks_before_transplant": 8,
        "desert_sow_outdoor": ["02-15", "04-30"],
        "desert_transplant": ["03-01", "05-15"],
        "desert_harvest": ["05-15", "08-31"],
        "notes": "Lycium fremontii. Native desert shrub with edible berries for fresh use and wildlife support; highly drought resilient.",
        "companions": ["Mesquite", "Desert Chia", "Globe Mallow", "Baja Fairy Duster"],
        "antagonists": ["None known"],
    },
    # ── DRAGON FRUIT ──
        ...
        "sow_indoor_weeks_before_transplant": 0,
        "desert_sow_outdoor": None,
        "desert_transplant": ["03-01", "06-01"],
        "desert_harvest": ["07-01", "11-15"],
        "notes": "Hylocereus spp. are climbing cacti producing pitaya fruit. In Zone 9b/10a, provide shade cloth during extreme heat and a sturdy post/trellis.",
        "companions": ["Aloe Vera", "Rosemary", "Basil", "Marigold"],
        "antagonists": ["None known"],
    },
    # ── FENNEL ──
        {
        ...
        "sow_indoor_weeks_before_transplant": 4,
        "desert_sow_outdoor": ["10-01", "02-15"],
        "desert_transplant": ["10-15", "03-01"],
        "desert_harvest": ["12-01", "05-31"],
        "notes": "Grow in cool season in low desert for bulbs and fronds. Can bolt quickly as days heat up; regular moisture improves bulb size.",
        "companions": ["Lettuce", "Onion", "Dill", "Chamomile"],
        "antagonists": ["Tomato", "Bean (Bush)"],
    },
    # ── FOURWING SALTBUSH ──
        {
        "name": "Fourwing Saltbush",
        "category": "native edible",
        "subcategory": "shrub",
        "days_to_maturity_min": 365,
        "days_to_maturity_max": 730,
        "spacing_inches": 72,
        ...
        "sow_indoor_weeks_before_transplant": 0,
        "desert_sow_outdoor": ["02-15", "04-30"],
        "desert_transplant": ["02-15", "05-15"],
        "desert_harvest": ["03-01", "11-30"],
        "notes": "Southwestern native shrub with edible seeds and young leaves. Exceptional drought and alkaline-soil tolerance for xeric foodscapes.",
        "companions": ["Mesquite", "Prickly Pear", "Globe Mallow", "Desert Chia"],
        "antagonists": ["None known"],
    },
    # ── GUAR ──
        {
        ...
        "desert_sow_outdoor": ["03-15", "07-31"],
        "desert_transplant": None,
        "desert_harvest": ["06-01", "10-15"],
        "notes": "Cyamopsis tetragonoloba (cluster bean). Exceptional heat and drought tolerance; edible young pods plus nitrogen fixation.",
        "companions": ["Corn", "Okra", "Sesame", "Eggplant"],
        "antagonists": ["Onion"],
    },
    # Duplicates "Guar (Cluster Bean)" and "Guar Bean" removed (kept "Guar" entry at line ~3292)
    # ── ICE PLANT ──
        {
        "name": "Ice Plant",
        "category": "vegetable",
        ...
        "desert_seasons": ["cool", "warm"],
        "sow_indoor_weeks_before_transplant": 4,
        "desert_sow_outdoor": ["10-01", "04-15"],
        "desert_transplant": ["10-15", "04-30"],
        "desert_harvest": ["11-15", "05-31"],
        "notes": "Mesembryanthemum crystallinum. Succulent edible leaves with saline-crisp flavor; does well in arid climates and poor soils.",
        "companions": ["Arugula", "Beet", "Radish", "Swiss Chard"],
        "antagonists": ["None known"],
    },
    # ── JOJOBA ──
        {
        ...
        "desert_transplant": ["02-15", "04-30"],
        "desert_harvest": ["08-01", "11-30"],
        "notes": "Native Sonoran shrub producing edible/usable oil seeds. Extremely drought tolerant once established; needs male and female plants for seed set.",
        "companions": ["Mesquite", "Desert Milkweed", "Baja Fairy Duster", "Parry's Penstemon"],
        "antagonists": ["None known"],
    },
    # ── JUTE MALLOW ──
        {
        ...
        "desert_transplant": None,
        "desert_harvest": ["05-01", "10-31"],
        "notes": "Corchorus olitorius (molokhia) produces tender nutrient-dense leaves through extreme summer heat.",
        "companions": ["Okra", "Basil", "Amaranth", "Black-eyed Pea"],
        "antagonists": ["None known"],
    },
    # Duplicate "Jute Mallow (Molokhia)" removed (kept "Jute Mallow" entry at line ~3397)
    # ── KATUK ──
        {
        "name": "Katuk",
        "category": "vegetable",
        ...
        "desert_transplant": ["03-15", "05-31"],
        "desert_harvest": ["05-15", "11-15"],
        "notes": "Sauropus androgynus is a perennial tropical leafy vegetable with strong heat performance; best in morning sun and afternoon shade in low desert.",
        "companions": ["Basil", "Sweet Potato", "Roselle", "Okra"],
        "antagonists": ["Rosemary"],
    },
    # ── KIWANO ──
        {
        ...
        "desert_transplant": ["04-01", "07-01"],
        "desert_harvest": ["08-01", "11-15"],
        "notes": "Cucumis metuliferus (horned melon). Performs well in heat and lower humidity once vines are established.",
        "companions": ["Basil", "Bean (Bush)", "Marigold", "Sunflower"],
        "antagonists": ["Potato"],
    },
    # ── LABLAB BEAN ──
        {
        ...
        "desert_transplant": None,
        "desert_harvest": ["06-15", "10-31"],
        "notes": "Lablab purpureus (hyacinth bean). Vigorous heat-loving edible pod/seed vine for monsoon-season production.",
        "companions": ["Corn", "Okra", "Amaranth", "Sunflower"],
        "antagonists": ["Onion", "Garlic"],
    },
    # ── LEMON VERBENA ──
        {
        ...
        "desert_transplant": ["10-01", "03-31"],
        "desert_harvest": ["04-01", "11-30"],
        "notes": "Aloysia citrodora. Heat-loving aromatic shrub for teas and desserts; thrives in Phoenix with deep, infrequent irrigation and light afternoon shade in peak summer.",
        "companions": ["Lavender", "Rosemary", "Sage", "Basil"],
        "antagonists": [],
    },
    # ── LONGEVITY SPINACH ──
        {
        ...
        "desert_sow_outdoor": None,
        "desert_transplant": ["03-15", "06-01"],
        "desert_harvest": ["05-01", "11-15"],
        "notes": "Gynura procumbens is a heat-loving perennial leafy green. In Zone 9b/10a it grows best with filtered afternoon shade and consistent irrigation.",
        "companions": ["Pepper", "Eggplant", "Basil", "Sweet Potato"],
        "antagonists": ["Sage"],
    },
    # ── MARJORAM ──
        {
        ...
        "desert_transplant": ["03-15", "05-15"],
        "desert_harvest": ["05-01", "11-15"],
        "notes": "Origanum majorana (sweet marjoram). Tender perennial in low desert with sweet citrus-oregano flavor. Handles desert heat in fast-draining soil; benefits from afternoon shade in extreme summer.",
        "companions": ["Tomato", "Pepper", "Basil", "Oregano"],
    ...
    # ── MEYER LEMON ──
        ...
        "desert_transplant": ["02-15", "04-30"],
        "desert_harvest": ["11-01", "04-30"],
        "notes": "Meyer lemon is one of the most adaptable citrus types for low-desert home orchards. Protect trunks from sunburn and manage micronutrients in alkaline soils.",
        "companions": ["Basil", "Lavender", "Marigold", "Chive"],
        "antagonists": ["Walnut"],
    },
    # Duplicate "Molokhia" removed (kept "Jute Mallow" entry at line ~3397)
    # ── NATAL PLUM ──
        {
        "name": "Natal Plum",
        "category": "fruit",
        "subcategory": "shrub fruit",
        "days_to_maturity_min": 365,
        "days_to_maturity_max": 730,
        "spacing_inches": 72,
        "sun": "full",
        ...
        "desert_transplant": ["03-15", "05-15"],
        "desert_harvest": ["05-01", "10-31"],
        "notes": "Carissa macrocarpa. Drought-tolerant evergreen shrub with edible red fruit; thrives in reflected heat once established.",
        "companions": ["Rosemary", "Lavender", "Thyme", "Pomegranate"],
        "antagonists": [],
    },
    # ── NOPAL ──
        {
        ...
        "sow_indoor_weeks_before_transplant": 0,
        "desert_sow_outdoor": None,
        "desert_transplant": ["03-01", "06-15"],
        "desert_harvest": ["04-01", "10-31"],
        "notes": "Opuntia ficus-indica pads (nopales) are highly drought-adapted and productive in low-desert food gardens with minimal irrigation.",
        "companions": ["Agave Americana", "Chile Pepper", "Tepary Bean", "Mesquite"],
        "antagonists": ["None known"],
    },
    # ── PAPALO ──
        {
        ...
        "sow_indoor_weeks_before_transplant": 3,
        "desert_sow_outdoor": ["03-15", "08-15"],
        "desert_transplant": ["04-01", "09-01"],
        "desert_harvest": ["05-01", "10-31"],
        "notes": "Porophyllum ruderale is a Mexican heat-loving herb used fresh in tacos and cemitas. It thrives in desert heat where cilantro fails.",
        "companions": ["Tomato", "Pepper", "Bean (Bush)", "Tomatillo"],
        "antagonists": ["None known"],
    },
    # ── PASSIONFRUIT ──
        {
        ...
        "desert_seasons": ["warm", "monsoon"],
        "sow_indoor_weeks_before_transplant": 8,
        "desert_sow_outdoor": ["03-01", "05-15"],
        "desert_transplant": ["03-15", "06-01"],
        "desert_harvest": ["08-15", "11-30"],
        "notes": "Passiflora edulis can perform in low desert with afternoon shade, strong trellis, and regular deep irrigation.",
        "companions": ["Basil", "Marigold", "Nasturtium", "Strawberry"],
        "antagonists": ["None known"],
    },
    # ── PINEAPPLE GUAVA ──
        {
        ...
        "desert_transplant": ["03-01", "05-15"],
        "desert_harvest": ["09-15", "11-30"],
        "notes": "Acca sellowiana (feijoa). Best with morning sun/afternoon shade in low desert; fruits in fall and flowers are edible.",
        "companions": ["Pomegranate", "Fig", "Rosemary", "Lavender"],
        "antagonists": [],
    },
    # ── SISSOO SPINACH ──
        {
        ...
        "desert_seasons": ["warm", "monsoon"],
        "sow_indoor_weeks_before_transplant": 6,
        "desert_sow_outdoor": ["03-01", "06-30"],
        "desert_transplant": ["03-15", "07-15"],
        "desert_harvest": ["05-01", "11-15"],
        "notes": "Alternanthera sissoo. Heat-loving perennial leafy green that thrives in low desert summers and tolerates drought once established.",
        "companions": ["Amaranth", "Basil", "Black-eyed Pea", "Purslane"],
        "antagonists": ["None known"],
    },
    # ── SOCIETY GARLIC ──
        {
        ...
        "desert_transplant": ["10-01", "03-31"],
        "desert_harvest": ["01-01", "12-31"],
        "notes": "Tulbaghia violacea. Heat- and drought-tolerant clumping allium relative used as an edible and ornamental in low-desert landscapes. Harvest leaves and flowers year-round once established.",
        "companions": ["Tomato", "Pepper", "Rosemary", "Sage"],
        "antagonists": [],
    },
    # ── SORGHUM ──
        {
        ...
        "desert_transplant": None,
        "desert_harvest": ["07-01", "11-15"],
        "notes": "Sorghum bicolor. Heat-resilient grain with deep roots and strong drought tolerance for low-desert summers.",
        "companions": ["Black-eyed Pea", "Lablab Bean", "Sesame"],
        "antagonists": ["Tomato"],
    },
    # ── SUMMER SAVORY ──
        {
        ...
        "desert_sow_outdoor": ["03-15", "05-15"],
        "desert_transplant": None,
        "desert_harvest": ["05-15", "09-30"],
        "notes": "Satureja hortensis. Fast-growing annual culinary herb that handles low humidity and heat well with light mulch. Classic bean herb.",
        "companions": ["Bean (Bush)", "Bean (Pole)", "Onion", "Tomato"],
        "antagonists": [],
    },
    # ── SURINAM CHERRY ──
        {
        ...
        "desert_transplant": ["03-01", "05-15"],
        "desert_harvest": ["04-15", "10-31"],
        "notes": "Eugenia uniflora is a tropical/subtropical fruit shrub that can do well in low desert with mulch, regular water, and occasional frost protection when young.",
        "companions": ["Barbados Cherry", "Guava", "Rosemary", "Basil"],
        "antagonists": ["None known"],
    },
    # Duplicate "Sweet Marjoram" removed (kept "Marjoram" entry at line ~3543)
    # ── TINDA ──
        {
        "name": "Tinda",
        "category": "vegetable",
        ...
        "sow_indoor_weeks_before_transplant": 3,
        "desert_sow_outdoor": ["03-15", "07-15"],
        "desert_transplant": ["04-01", "08-01"],
        "desert_harvest": ["06-01", "10-31"],
        "notes": "Praecitrullus fistulosus (Indian round gourd). Prolific warm-season cucurbit adapted to high heat and long summers.",
        "companions": ["Bean (Bush)", "Marigold", "Nasturtium", "Sunflower"],
        "antagonists": ["Potato"],
    },
    # ── WHITE SAPOTE ──
        {
        ...
        "desert_sow_outdoor": None,
        "desert_transplant": ["02-15", "04-30"],
        "desert_harvest": ["10-01", "03-31"],
        "notes": "Casimiroa edulis is highly adapted to low-desert heat once established. Fruit is custardy and sweet. Young trees need wind and frost protection. Avoid overwatering in heavy soils.",
        "companions": ["Pomegranate", "Fig", "Mulberry", "Rosemary"],
        "antagonists": ["None known"],
    },
    # ── WINTER SAVORY ──
        {
        ...
        "desert_transplant": ["10-01", "03-31"],
        "desert_harvest": ["01-01", "12-31"],
        "notes": "Satureja montana. Woody perennial savory with stronger flavor than summer savory and strong drought resilience once established.",
        "companions": ["Bean (Bush)", "Onion", "Cabbage", "Rosemary"],
        "antagonists": [],
    },
    # ── MUNG BEAN ──
    {
        ...
        "desert_transplant": None,
        "desert_harvest": ["06-01", "10-31"],
        "notes": "Vigna radiata. Outstanding heat and drought tolerance for desert summers. Produces edible sprouts, green pods, or dried beans. Nitrogen fixer and short-season crop.",
        "companions": ["Corn", "Okra", "Sunflower", "Amaranth"],
        "antagonists": ["Onion", "Garlic"],
    },
    # ── ASHWAGANDHA ──
    {
        ...
        "desert_sow_outdoor": ["03-15", "05-15"],
        "desert_transplant": ["04-01", "05-31"],
        "desert_harvest": ["10-01", "12-31"],
        "notes": "Withania somnifera (Indian ginseng). Thrives in arid heat, alkaline sandy soil, and low water. Roots harvested after first frost. Drought-tolerant perennial in Zone 9b+.",
    ...
    # ── HOLY BASIL (TULSI) ──
    {
        ...
        "desert_transplant": ["04-01", "05-15"],
        "desert_harvest": ["05-15", "11-15"],
        "notes": "Ocimum tenuiflorum (syn. O. sanctum), tulsi. Sacred Ayurvedic herb, more heat- and drought-tolerant than sweet basil and thrives through Phoenix summers where regular basil bolts. Light afternoon shade helps above 110F. Clove-peppery flavor for Thai/Indian cooking and medicinal tea. Rama and Krishna are common cultivars. Pinch flowers for bushier growth and extended harvest; reseeds readily.",
    ...
    # ── MEXICAN OREGANO ──
    {
        ...
        "desert_transplant": ["02-15", "04-30"],
        "desert_harvest": ["05-01", "11-30"],
        "notes": "Lippia graveolens. Native Sonoran desert shrub, not true oregano. Bolder citrusy flavor, ideal for Mexican and Tex-Mex cuisine. Extremely drought tolerant once established. Tubular flowers attract hummingbirds.",
        "companions": ["Chiltepin Pepper", "Rosemary", "Sage", "Lavender"],
        "antagonists": ["None known"],
    },
    # ── AGAVE ──
    {
        "name": "Agave",
        "category": "edible_native",
        ...
        "desert_sow_outdoor": None,
        "desert_transplant": ["10-01", "03-31"],
        "desert_harvest": ["01-01", "04-30"],
        "notes": "Sonoran native. Harvest leaves in winter/spring when sap is highest. Roast for sweet pineapple-like flavor. Quiotes (immature flower stalks) are edible cooked. Plant dies after flowering (monocarpic) but produces pups.",
        "companions": ["Prickly Pear", "Desert Chia", "Chiltepin Pepper"],
        "antagonists": [],
    },
    # ── CHOLLA ──
    {
        ...
        "desert_transplant": ["10-01", "04-30"],
        "desert_harvest": ["03-01", "05-15"],
        "notes": "Harvest immature flower buds in spring (March-May). Must be boiled 15+ min to remove oxalic acid. Taste like green bean meets artichoke heart. Excellent calcium source. Staghorn and buckhorn cholla are most commonly harvested.",
        "companions": ["Prickly Pear", "Agave", "Desert Wolfberry"],
        "antagonists": [],
    },
    # ── PALO VERDE ──
    {
        ...
        "desert_transplant": ["10-01", "03-31"],
        "desert_harvest": ["04-01", "06-30"],
        "notes": "Arizona state tree. Seeds are edible when pods are green and seeds are small and sweet. Flowers are also edible. Nitrogen-fixing legume tree that provides filtered shade for understory plants. Blue palo verde (Parkinsonia florida) is preferred for edible seeds.",
        "companions": ["Chiltepin Pepper", "Desert Chia", "Agave"],
        "antagonists": [],
    },
    # ── SAGUARO ──
    {
        ...
        "category": "edible_native",
        "subcategory": "cactus",
        "days_to_maturity_min": 18250,
        "days_to_maturity_max": 27375,
        "spacing_inches": 180,
        "sun": "full",
        "water": "very low",
        "heat_tolerance": "very high",
        ...
        "desert_sow_outdoor": None,
        "desert_transplant": None,
        "desert_harvest": ["06-01", "07-15"],
        "notes": "Iconic Sonoran Desert cactus. Fruit ripens in June and has been harvested by Tohono O'odham for millennia. Sweet red pulp is eaten fresh, made into syrup, jam, or ceremonial wine. Protected under AZ Native Plant Law — cannot be removed from state/federal land. Grows extremely slowly (1 inch/year for first 8 years).",
        "companions": ["Palo Verde", "Ironwood"],
        "antagonists": [],
    },
    # ── IRONWOOD ──
    {
        ...
        "category": "edible_native",
        "subcategory": "tree",
        "days_to_maturity_min": 3650,
        "days_to_maturity_max": 7300,
        "spacing_inches": 240,
        "sun": "full",
        "water": "very low",
        "heat_tolerance": "very high",
        ...
        "desert_transplant": ["10-01", "03-31"],
        "desert_harvest": ["06-01", "08-31"],
        "notes": "Olneya tesota. Seeds are edible roasted — nutty, rich flavor similar to peanuts. Keystone Sonoran Desert species that creates microhabitats and nurse-tree shade. Nitrogen-fixing legume. Extremely hard, dense wood. Protected under AZ Native Plant Law.",
        "companions": ["Saguaro", "Palo Verde", "Cholla"],
        "antagonists": [],
    },
    # ── BAY LAUREL ──
    {
        ...
        "desert_transplant": ["10-01", "03-31"],
        "desert_harvest": ["01-01", "12-31"],
        "notes": "Laurus nobilis. Best with morning sun and afternoon shade in desert. Slow-growing evergreen. Harvest leaves year-round once established. Excellent drought tolerance once established. Can be container-grown. Leaves are more flavorful fresh than dried.",
        "companions": ["Rosemary", "Thyme", "Oregano", "Sage"],
        "antagonists": [],
    },
    # ── CURRY LEAF ──
    {
        ...
        "desert_transplant": ["03-01", "05-15"],
        "desert_harvest": ["05-01", "11-30"],
        "notes": "Murraya koenigii. Tolerates 46-117F once established. Needs afternoon shade and consistent moisture in desert. Aromatic leaves essential in South Indian cuisine. Protect from frost.",
        "companions": ["Basil", "Moringa", "Lemongrass", "Marigold"],
        "antagonists": ["None known"],
    },
    # ── KUMQUAT ──
    {
        ...
        "sow_indoor_weeks_before_transplant": 0,
        "desert_sow_outdoor": None,
        "desert_transplant": ["02-15", "05-01"],
        "desert_harvest": ["11-01", "02-28"],
        "notes": "Citrus japonica. Among the most cold-hardy citrus; survives brief dips to 18F. Deep water to 3ft every 1-2 weeks when fruiting. Prone to zinc deficiency in alkaline desert soils; apply micronutrients. Fruit ripe when fully orange with no green.",
        "companions": ["Basil", "Lavender", "Marigold", "Chive"],
        "antagonists": ["Black Walnut"],
        "desert_transplant": ["03-01", "05-31"],
        "desert_harvest": ["04-01", "11-30"],
        "notes": "Murraya koenigii. Thrives in desert heat but killed by hard freeze below 25F. In Zone 9b can overwinter outdoors with frost protection. Essential in South Indian and Sri Lankan cuisine. Highly aromatic fresh leaves — dried leaves lose most flavor. Grows fast in warm months.",
        "companions": ["Pepper", "Lemongrass", "Ginger"],
        "antagonists": [],
    },
    # ── GINGER ──
    {
        ...
        "desert_sow_outdoor": ["03-01", "04-15"],
        "desert_transplant": ["03-15", "05-01"],
        "desert_harvest": ["11-01", "01-31"],
        "notes": "Zingiber officinale. Needs afternoon shade in desert — leaves sunburn easily. Plant rhizome pieces with eyes 2 inches deep. Needs consistent moisture and rich soil with good drainage. Harvest after leaves yellow and die back. Can also harvest 'baby ginger' earlier for milder flavor.",
        "companions": ["Curry Leaf", "Lemongrass", "Turmeric"],
        "antagonists": [],
    },
    # ── CUMIN ──
    {
        ...
        "desert_sow_outdoor": ["02-15", "03-31"],
        "desert_transplant": ["03-01", "04-15"],
        "desert_harvest": ["06-01", "07-31"],
        "notes": "Cuminum cyminum. Native to arid Mediterranean/Middle East — naturally suited to desert conditions. Direct sow or transplant after last frost. Harvest when seeds turn brown and before they shatter. Needs long hot growing season — desert is ideal. Cut seed heads and dry upside down in paper bag.",
        "companions": ["Cilantro", "Fennel", "Dill"],
        "antagonists": ["Tomato"],
    },
    # ── PEANUT ──
    {
        ...
        "desert_transplant": None,
        "desert_harvest": ["08-01", "10-31"],
        "notes": "Arachis hypogaea. Thrives in desert heat. Direct sow after soil reaches 65F. Needs loose, sandy soil (common in desert) for pegs to penetrate. Nitrogen-fixing legume that improves soil. Harvest when leaves yellow — dig entire plant, shake off soil, and cure in warm dry spot for 1-2 weeks. Valencia and Spanish types mature fastest.",
        "companions": ["Corn", "Squash (Summer)", "Sweet Potato"],
        "antagonists": ["Onion", "Garlic"],
    },
    # ── CHICKPEA ──
    {
        ...
        "desert_seasons": ["cool"],
        "sow_indoor_weeks_before_transplant": 0,
        "desert_sow_outdoor": ["10-15", "01-15"],
        "desert_transplant": None,
        "desert_harvest": ["02-01", "05-15"],
        "notes": "Cicer arietinum. Excellent cool-season legume for desert. Drought-tolerant once established — needs far less water than most beans. Nitrogen-fixing. Direct sow in fall or winter for spring harvest. Desi types are more heat-tolerant than Kabuli types.",
        "companions": ["Corn", "Cucumber", "Lettuce", "Pea"],
        "antagonists": ["Onion", "Garlic"],
    },
    # ── EDAMAME ──
    {
        ...
        "desert_transplant": None,
        "desert_harvest": ["05-15", "07-31"],
        "notes": "Glycine max. Vegetable soybean that handles desert heat well. Direct sow after last frost. Inoculate seeds with soybean-specific rhizobium for nitrogen fixation. Harvest pods when plump but still green. Midori Giant and Butterbeans are good desert varieties.",
        "companions": ["Corn", "Squash (Summer)", "Cucumber", "Potato"],
        "antagonists": ["Onion", "Garlic"],
    },
    # ── DAIKON RADISH ──
    {
        ...
        "desert_transplant": None,
        "desert_harvest": ["11-01", "04-15"],
        "notes": "Raphanus sativus var. longipinnatus. Deep-rooted cool-season crop that breaks up compacted soil. Excellent for desert fall/winter gardens. Seed pods are also edible. Miyashige and Minowase are reliable varieties. Also a great cover crop — roots penetrate 12-18 inches deep.",
        "companions": ["Lettuce", "Spinach", "Carrot", "Pea", "Bean (Bush)"],
    ...
    # ── MUSTARD GREENS ──
    {
        ...
        "desert_sow_outdoor": ["09-15", "02-28"],
        "desert_transplant": None,
        "desert_harvest": ["10-15", "04-30"],
        "notes": "Brassica juncea. Fast-growing spicy green for desert cool season. Bolts quickly in heat — stick to fall through early spring. Red Giant and Tatsoi types are popular. Baby leaves are milder; mature leaves are pungent. Seeds can be ground for homemade mustard.",
        "companions": ["Lettuce", "Spinach", "Onion", "Garlic", "Celery"],
        "antagonists": ["Strawberry"],
    },
    # ── FAVA BEAN ──
    {
        ...
        "desert_sow_outdoor": ["10-01", "01-31"],
        "desert_transplant": None,
        "desert_harvest": ["02-01", "04-30"],
        "notes": "Vicia faba. Premier cool-season legume for desert gardens. Direct sow in fall — tolerates light frost. Nitrogen-fixing cover crop that enriches soil. Stake tall varieties when pod-laden. Harvest pods when beans are plump. Shoots and young pods are also edible.",
        "companions": ["Potato", "Corn", "Lettuce", "Spinach", "Dill"],
        "antagonists": ["Onion", "Garlic"],
    },
    # ── KOHLRABI ──
    {
        ...
        "desert_seasons": ["cool"],
        "sow_indoor_weeks_before_transplant": 4,
        "desert_sow_outdoor": ["09-15", "12-31"],
        "desert_transplant": ["09-15", "01-31"],
        "desert_harvest": ["11-01", "03-31"],
        "notes": "Brassica oleracea var. gongylodes. Fast-maturing cool-season crop for desert fall/winter. Harvest bulbs at 2in diameter before heat arrives for best flavor. Succession plant every 2-3 weeks.",
        "companions": ["Beet", "Onion", "Lettuce", "Spinach", "Dill"],
        "antagonists": ["Tomato", "Pepper", "Strawberry"],
    },
    # ── STEVIA ──
    {
        ...
        "sow_indoor_weeks_before_transplant": 8,
        "desert_sow_outdoor": None,
        "desert_transplant": ["09-15", "03-31"],
        "desert_harvest": ["11-01", "05-31"],
        "notes": "Stevia rebaudiana. Natural sweetener herb, tender perennial in Zone 9b+. Needs dappled afternoon shade in desert and well-drained soil. Do not let soil dry completely but avoid waterlogging.",
        "companions": ["Basil", "Mint", "Marigold", "Lettuce"],
        "antagonists": ["None known"],
    },
    # ── MIZUNA ──
    {
        ...
        "desert_transplant": None,
        "desert_harvest": ["10-15", "04-15"],
        "notes": "Brassica rapa var. nipponosinica. Fast-growing Japanese mustard green, mild peppery flavor. Excellent cut-and-come-again crop for desert cool season. Bolts quickly in heat.",
        "companions": ["Lettuce", "Spinach", "Radish", "Carrot", "Onion"],
        "antagonists": ["Strawberry"],
    },
    # ── SNAKE GOURD ──
    {
        ...
        "sow_indoor_weeks_before_transplant": 4,
        "desert_sow_outdoor": ["04-01", "07-15"],
        "desert_transplant": ["04-15", "07-31"],
        "desert_harvest": ["06-15", "10-31"],
        "notes": "Trichosanthes cucumerina. Tropical vine that thrives in desert heat with warm nights. Needs strong trellis for 1-3ft long fruits. Harvest young and green for mild zucchini-like flavor. Night-blooming fragrant flowers.",
        "companions": ["Corn", "Okra", "Bean (Bush)", "Marigold"],
        "antagonists": ["Potato"],
    },
    # ── PERSIMMON ──
    {
        ...
        "sow_indoor_weeks_before_transplant": 0,
        "desert_sow_outdoor": None,
        "desert_transplant": ["01-15", "03-15"],
        "desert_harvest": ["10-01", "12-31"],
        "notes": "Diospyros kaki. Non-astringent varieties like Fuyu are best for fresh eating. Trees may take 3-7 years to bear. Low-chill varieties recommended for Phoenix. Deciduous — tolerates desert heat well once established.",
        "companions": ["Pomegranate", "Fig", "Grape"],
        "antagonists": ["None known"],
    },
    # ── QUINCE ──
    {
        ...
        "desert_transplant": ["01-15", "03-15"],
        "desert_harvest": ["09-15", "11-30"],
        "notes": "Cydonia oblonga. Extremely hardy fruit tree (zones 5-9). Fragrant golden fruit cooked into preserves, jelly, and paste. Beautiful spring blossoms help pollinate nearby fruit trees. Drought tolerant once established.",
        "companions": ["Apple", "Pomegranate", "Fig"],
        "antagonists": ["None known"],
    },
    # ── PAPAYA ──
    {
        ...
        "desert_transplant": ["03-01", "04-15"],
        "desert_harvest": ["11-01", "03-31"],
        "notes": "Carica papaya. Mexican varieties (Maradol) outperform Hawaiian types in Phoenix heat. Must survive at least one winter to fruit. Root rot is the top killer — never let soil stay cold and wet. Protect from frost.",
        "companions": ["Banana Yucca", "Moringa", "Sweet Potato"],
        "antagonists": ["None known"],
    },
    # ── PECAN ──
    {
        "name": "Pecan",
        "category": "fruit",
        "subcategory": "nut tree",
        "days_to_maturity_min": 1460,
        "days_to_maturity_max": 2555,
        "spacing_inches": 480,
        "sun": "full",
        "water": "high",
        ...
        "sow_indoor_weeks_before_transplant": 0,
        "desert_sow_outdoor": None,
        "desert_transplant": ["01-15", "03-31"],
        "desert_harvest": ["10-01", "12-31"],
        "notes": "Carya illinoinensis. Thrives in Phoenix heat. Western Schley is self-fruitful, bears in 4-5 years, and is best for single-tree home gardens. Needs deep watering from April-September. Zinc foliar spray critical for nut production. Needs <600 chill hours.",
        "companions": ["Grape", "Fig"],
        "antagonists": ["None known"],
        "desert_sow_outdoor": ["09-15", "02-15"],
        "desert_transplant": ["10-01", "03-01"],
        "desert_harvest": ["11-01", "04-30"],
        "notes": "Brassica oleracea var. gongylodes. Underused cool-season brassica perfect for desert fall/winter. Swollen stem is crisp and sweet raw or cooked. Harvest at tennis-ball size before it gets woody. Purple varieties (Kolibri) and white varieties (Winner) both do well.",
        "companions": ["Beet", "Onion", "Celery", "Lettuce", "Cucumber"],
        "antagonists": ["Tomato", "Pepper", "Strawberry"],
    },
    # ── LIME ──
    {
        ...
        "desert_transplant": ["02-15", "04-30"],
        "desert_harvest": ["11-01", "03-31"],
        "notes": "Citrus aurantiifolia. Most frost-sensitive citrus — needs warmest microclimate in Zone 9b. Mexican/Key lime is most cold-sensitive; Bearss/Persian lime slightly hardier. Protect when temps drop below 32F. Excellent in containers that can be moved under cover. Feed with citrus fertilizer 3x per year.",
        "companions": ["Lemon", "Orange", "Lavender", "Nasturtium"],
        "antagonists": [],
    },
    # ── TURMERIC ──
    {
        ...
        "desert_sow_outdoor": ["03-15", "05-15"],
        "desert_transplant": ["04-01", "05-31"],
        "desert_harvest": ["12-01", "01-31"],
        "notes": "Curcuma longa. Pre-sprout rhizomes indoors in January. Needs afternoon shade and consistent moisture in Phoenix. Harvest when leaves yellow in late fall/winter. Use shade cloth in summer.",
        "companions": ["Ginger", "Lemongrass", "Bean (Bush)", "Cilantro"],
        "antagonists": [],
        "desert_sow_outdoor": ["03-01", "04-15"],
        "desert_transplant": ["03-15", "05-01"],
        "desert_harvest": ["12-01", "01-31"],
        "notes": "Curcuma longa. Pre-sprout rhizomes indoors in January. Needs ~10 months frost-free. Afternoon shade essential in Phoenix summer. Rich soil with lots of organic matter. Harvest when leaves yellow and die back in late fall/winter.",
        "companions": ["Ginger", "Lemongrass", "Moringa"],
        "antagonists": ["None known"],
    },
    # ── TATSOI ──
    {
        ...
        "desert_sow_outdoor": ["09-15", "02-15"],
        "desert_transplant": None,
        "desert_harvest": ["10-15", "03-31"],
        "notes": "Brassica rapa var. rosularis. Spoon-shaped leaves in a rosette pattern. Mild mustardy flavor, excellent raw or stir-fried. Tolerates light frost well. Direct sow in fall for winter harvesting in low desert.",
        "companions": ["Lettuce", "Arugula", "Bok Choy", "Radish", "Onion"],
        "antagonists": ["Tomato", "Pepper", "Strawberry"],
    },
    # ── ALOE VERA ──
    {
        ...
        "sow_indoor_weeks_before_transplant": 0,
        "desert_sow_outdoor": None,
        "desert_transplant": ["03-01", "10-31"],
        "desert_harvest": ["01-01", "12-31"],
        "notes": "Lippia graveolens. NOT the same as Mediterranean oregano (Origanum vulgare). Sonoran native with stronger, more citrusy flavor essential in Mexican and Tex-Mex cuisine. Extremely drought-tolerant once established. Semi-deciduous shrub to 4-5 ft. Attractive to pollinators.",
        "companions": ["Pepper", "Tomato", "Chiltepin Pepper", "Rosemary", "Lavender"],
        "antagonists": [],
        "desert_transplant": ["03-01", "05-31"],
        "desert_harvest": ["01-01", "12-31"],
        "notes": "Aloe barbadensis miller. Thrives in desert conditions. Grow in partial or filtered shade to prevent sunburn. Gel used medicinally and in beverages. Extremely drought tolerant. Propagate from offsets (pups).",
        "companions": ["Lavender", "Rosemary", "Agave"],
        "antagonists": ["None known"],
    },
    # ── ECHINACEA ──
    {
        ...
        "sow_indoor_weeks_before_transplant": 8,
        "desert_sow_outdoor": ["10-01", "02-28"],
        "desert_transplant": ["11-01", "03-15"],
        "desert_harvest": ["04-01", "06-30"],
        "notes": "Echinacea purpurea. Purple coneflower. Seeds need cold stratification to germinate. Often blooms second year. Excellent pollinator plant. Roots and flowers used in herbal tea for immune support. Drought tolerant once established.",
        "companions": ["Lavender", "Yarrow", "Black-eyed Pea", "Marigold"],
        "antagonists": ["None known"],
    },
    # ── YARROW ──
    {
        ...
        "desert_sow_outdoor": ["10-01", "02-28"],
        "desert_transplant": ["11-01", "03-15"],
        "desert_harvest": ["03-15", "06-30"],
        "notes": "Achillea millefolium. Excellent pollinator attractor — draws butterflies, bees, and hummingbirds. Extremely drought tolerant. Leaves used in herbal tea. Spreads readily; container growing or edging recommended.",
        "companions": ["Echinacea", "Lavender", "Rosemary", "Sage"],
        "antagonists": ["None known"],
    },
    # ── HOREHOUND ──
    {
        ...
        "sow_indoor_weeks_before_transplant": 6,
        "desert_sow_outdoor": ["10-01", "03-15"],
        "desert_transplant": ["11-01", "04-01"],
        "desert_harvest": ["02-01", "06-30"],
        "notes": "Marrubium vulgare. Traditional cough remedy herb. Extremely hardy — thrives in poor, dry, alkaline soils that are common in Phoenix. Self-seeds readily. Attractive woolly gray-green foliage. Bitter leaves used in lozenges and tea.",
        "companions": ["Lavender", "Sage", "Yarrow"],
        "antagonists": ["None known"],
        "sow_indoor_weeks_before_transplant": 4,
        "desert_sow_outdoor": ["03-01", "04-15"],
        "desert_transplant": ["03-15", "05-01"],
        "desert_harvest": ["11-01", "01-31"],
        "notes": "Curcuma longa. Ginger relative that needs afternoon shade in desert. Plant rhizome pieces 2 inches deep after soil warms. Needs consistent moisture and rich organic soil. Harvest 8-10 months after planting when leaves yellow and die back. Fresh turmeric is far more potent than dried. Pairs well with ginger in same bed.",
        "companions": ["Ginger", "Lemongrass", "Curry Leaf", "Bean (Bush)"],
        "antagonists": [],
    },
    # ── ALMOND ──
    {
        ...
        "sow_indoor_weeks_before_transplant": 0,
        "desert_sow_outdoor": None,
        "desert_transplant": ["12-15", "02-28"],
        "desert_harvest": ["07-01", "09-30"],
        "notes": "Prunus dulcis. Excellent desert nut tree — thrives in hot, dry climate and alkaline soil. Low-chill varieties: Garden Prince (250hrs, dwarf, self-pollinating), All-in-One (500hrs, semi-dwarf, self-fruitful), Ne Plus Ultra (250hrs, needs pollinator). Appreciates afternoon shade first season. Deep infrequent watering once established — overwatering causes root rot. Bears at 2-4 years. Well-drained soil essential.",
        "companions": ["Comfrey", "Lavender", "Nasturtium"],
        "antagonists": [],
    },
    # ── NECTARINE ──
    {
        ...
        "sow_indoor_weeks_before_transplant": 0,
        "desert_sow_outdoor": None,
        "desert_transplant": ["12-15", "02-15"],
        "desert_harvest": ["05-01", "07-31"],
        "notes": "Prunus persica var. nucipersica. Low-chill varieties thrive in desert: Double Delight, Desert Delight, May Grand, Sunraycer (all ~250 chill hours). Self-pollinating. Sensitive to full sun first season but acclimated trees handle extreme heat well. Use drip irrigation — deep water, let soil dry between. Enrich with organic matter. Slightly acidic well-drained soil ideal. Produces reliably every year once established.",
        "companions": ["Comfrey", "Nasturtium", "Marigold", "Garlic"],
        "antagonists": [],
    },
    # ── HOLY BASIL (TULSI) ──
    # NEW PLANTS — Research batch 2026-04-10
    # FRUIT TREES
    {
        "name": "Avocado",
        "category": "fruit",
        ...
        "sow_indoor_weeks_before_transplant": None,
        "desert_sow_outdoor": None,
        "desert_transplant": ["02-01", "03-31"],
        "desert_harvest": ["09-01", "02-28"],
        "notes": "Mexican varieties (Mexicola, Mexicola Grande) are most cold-hardy to 18F and best suited for Phoenix. Plant on east side of property for morning sun and afternoon shade — critical in desert. Young trees need 50% shade cloth. Deep, infrequent watering. Protect from frost with blankets. Takes 3-5 years to fruit from nursery stock. Avoid western exposures.",
        "companions": ["Nasturtium", "Lavender", "Marigold"],
        "antagonists": [],
    },
    {
        "name": "Apple",
        ...
        "desert_sow_outdoor": None,
        "desert_transplant": ["10-01", "03-01"],
        "desert_harvest": ["05-15", "07-15"],
        "notes": "Low-chill varieties only — Phoenix gets 300-400 chill hours. Anna (200hrs) and Dorsett Golden (100hrs) are the top picks and cross-pollinate each other for bigger harvests. Ein Shemer is another good option. Plant Oct-Mar for root establishment before summer. Harvest by early July before fruit cooks on tree. Thin aggressively for larger fruit.",
        "companions": ["Chive", "Nasturtium", "Marigold", "Garlic"],
        "antagonists": ["Potato"],
    },
    {
        "name": "Plum",
        ...
        "desert_sow_outdoor": None,
        "desert_transplant": ["10-01", "03-01"],
        "desert_harvest": ["05-01", "07-01"],
        "notes": "Japanese plum types do best in low desert. Santa Rosa (250 chill hrs, self-pollinating) and Methley (250 hrs, self-pollinating) are top picks. Gulf Gold, Gulf Ruby, and Beauty also work. Plant bare-root in Jan-Feb or container stock Oct-Mar. Harvest by early July — soft fruit cooks on the tree in extreme heat. Needs annual pruning for best production.",
        "companions": ["Marigold", "Garlic", "Nasturtium"],
        "antagonists": [],
    },
    {
        "name": "Mexican Elderberry",
        "category": "fruit",
        "subcategory": "shrub",
        "days_to_maturity_min": 365,
        "days_to_maturity_max": 730,
        ...
        "desert_sow_outdoor": None,
        "desert_transplant": ["10-01", "03-31"],
        "desert_harvest": ["06-01", "09-30"],
        "notes": "Sambucus mexicana — native to Sonoran Desert, also called Arizona Elderberry. One of the best desert-adapted fruiting shrubs. Self-fruitful, only one plant needed. Tolerates native clay soil. Heat and drought tolerant but loses leaves under drought stress — water deeply when flowering for best fruit set. Shallow-rooted. Berries used for syrup, wine, immune-boosting preparations. Do NOT eat raw berries.",
        "companions": ["Nasturtium", "Sunflower"],
        "antagonists": [],
    },
    {
        "name": "Shiso",
        ...
        "desert_transplant": ["03-01", "04-15"],
        "desert_harvest": ["04-01", "06-30"],
        "notes": "Perilla frutescens — Japanese herb also called perilla. Green (ao-shiso) and red (aka-shiso) varieties. Used in sushi, salads, tempura, umeboshi. Needs afternoon shade in desert — bolts fast in full sun and extreme heat. Direct sow or transplant in spring for harvest before summer peak. Self-seeds readily. Unique minty-basil flavor. Annual in desert. Pinch regularly to delay bolting.",
        "companions": ["Tomato", "Pepper", "Basil", "Cucumber"],
        "antagonists": [],
    },
    # ── ADDED 2026-06-01: heat/desert-adapted edibles (zone 9b low desert) ──
    {
        "name": "Cucamelon",
        "category": "vegetable",
        "subcategory": "fruit",
        ...
        "sow_indoor_weeks_before_transplant": 6,
        "desert_sow_outdoor": None,
        "desert_transplant": ["02-15", "04-15"],
        "desert_harvest": ["05-01", "11-15"],
        "notes": "Slow to start; transplant after frost. Give afternoon shade and a trellis in the low desert; vines can survive summer for a fall flush. Tuberous root may overwinter for an earlier second-year start.",
        "companions": ["Corn", "Bean (Bush)", "Nasturtium", "Radish"],
        "antagonists": ["Potato"],
    },
    {
        "name": "Pepino Melon",
        ...
        "desert_sow_outdoor": None,
        "desert_transplant": ["02-15", "03-31"],
        "desert_harvest": ["05-01", "12-15"],
        "notes": "Propagated from cuttings, not seed. Hardy to ~25F so it overwinters in 9b as a short-lived perennial. Provide afternoon shade in peak summer; fruit set drops above ~95F but resumes in fall. Stake or cage the floppy stems.",
    ...
    },
    {
        ...
        "desert_sow_outdoor": None,
        "desert_transplant": ["02-15", "03-31"],
        "desert_harvest": ["06-01", "12-01"],
        "notes": "Distinct from annual ground cherry (P. pruinosa): larger, sprawling tender perennial that often overwinters in 9b. Sets fruit best in spring/fall; afternoon shade helps through peak summer. Fruit ripens when the papery husk dries and berries drop.",
        "companions": ["Basil", "Nasturtium", "Marigold"],
        "antagonists": ["Fennel"],
    },
    {
        ...
        "sow_indoor_weeks_before_transplant": 0,
        "desert_sow_outdoor": None,
        "desert_transplant": ["09-15", "10-31"],
        "desert_harvest": ["10-15", "11-30"],
        "notes": "Plant corms 3-4in deep in fall; flowers Oct-Nov, then foliage grows over winter and goes summer-dormant (keep dry). Loves alkaline desert soil and dry summers. Harvest the three red stigmas each morning. Divide every 3-4 years.",
        "companions": ["Rosemary", "Lavender"],
        "antagonists": [],
    },
    {
        "name": "Cardoon",
        ...
        "desert_sow_outdoor": None,
        "desert_transplant": ["09-15", "11-15"],
        "desert_harvest": ["02-01", "05-01"],
        "notes": "Grow as a cool-season crop in the low desert: transplant in fall for late-winter/spring harvest of blanched leaf stalks. Mediterranean plant tolerant of alkaline soil; give afternoon shade if carried into summer heat. Blanch stalks 2-4 weeks before harvest.",
        "companions": ["Pea", "Bean (Bush)", "Sunflower"],
        "antagonists": [],
    },
    {
        "name": "French Sorrel",
        ...
        "desert_sow_outdoor": ["09-15", "02-28"],
        "desert_transplant": ["10-01", "02-28"],
        "desert_harvest": ["11-01", "05-15"],
        "notes": "Cool-season perennial in the low desert; flavor and growth suffer above ~85F. Plant fall through late winter, harvest leaves through spring, then give heavy afternoon shade and steady water to carry it (often semi-dormant) through summer. Remove flower stalks to prolong leaf production.",
        "companions": ["Strawberry", "Mint"],
        "antagonists": [],
    },
    {
        "name": "Lovage",
        ...
        "desert_sow_outdoor": ["10-01", "01-31"],
        "desert_transplant": ["10-15", "02-15"],
        "desert_harvest": ["12-01", "05-15"],
        "notes": "Marginal in 9b: hardy but hates desert heat. Establish in cool months in a part-shade spot with consistently moist soil; provide shadecloth and keep watered through summer or it will go dormant/decline. Cut leaves young; soil drying turns leaves bitter.",
        "companions": ["Bean (Bush)", "Tomato"],
        "antagonists": [],
    },
    {
        "name": "Cherimoya",
        ...
        "desert_sow_outdoor": None,
        "desert_transplant": ["03-15", "04-30"],
        "desert_harvest": ["10-01", "01-31"],
        "notes": "Marginal/expert-only in low-desert 9b: subtropical, heat tolerance is questionable above 110F and young trees are frost-tender to 25F. Needs filtered light/afternoon shade, wind protection, and hand-pollination for good fruit set; bears in 4-5 years. Better suited to coastal CA than Phoenix.",
        "companions": [],
        "antagonists": [],
    },
    # ── 2026-06-01 PLANT RESEARCH: desert-adapted natives & heat-loving edibles ──
    {
        ...
        "desert_sow_outdoor": ["03-15", "05-15"],
        "desert_transplant": None,
        "desert_harvest": ["08-01", "10-15"],
        "notes": "Cucurbita foetidissima — native Sonoran/Southwest perennial vine with a massive tuberous taproot. Extreme drought tolerance; thrives on rainfall alone once established. Grown for the protein- and oil-rich SEEDS (~31% protein). CAUTION: the flesh and roots are bitter and toxic from cucurbitacins — only the cleaned, processed seeds are eaten. Sprawls aggressively (vines 20+ ft); give it room or train along the ground. Dies back to the root in winter and resprouts.",
        "companions": ["Mesquite", "Sunflower", "Tepary Bean"],
        "antagonists": [],
    },
    {
        "name": "Devil's Claw",
        "category": "edible_native",
        "subcategory": "native annual",
        "days_to_maturity_min": 60,
        "days_to_maturity_max": 120,
        "spacing_inches": 36,
        "sun": "full",
        ...
        "desert_transplant": None,
        "desert_harvest": ["06-15", "09-30"],
        "notes": "Proboscidea parviflora — native Sonoran annual, a traditional Tohono O'odham (i'ihuk) crop domesticated by the Hohokam. Young, tender green pods are boiled and eaten like okra; the oily seeds are also edible. Mature dried pods split into the black 'claws' used for basketry fiber. Plant after soil warms / with monsoon onset. The domesticated white-seeded var. hohokamiana germinates faster and grows longer pods than the wild black-seeded form. Drought-hardy once established.",
        "companions": ["Corn", "Tepary Bean", "Sunflower"],
        "antagonists": [],
    },
    {
        "name": "Tigernut",
        ...
        "desert_seasons": ["warm", "monsoon"],
        "sow_indoor_weeks_before_transplant": 0,
        "desert_sow_outdoor": ["03-15", "05-31"],
        "desert_transplant": None,
        "desert_harvest": ["10-15", "12-15"],
        "notes": "Cyperus esculentus var. sativus (chufa) — a heat-loving sedge grown for its sweet, almond-flavored tubers (the base of Spanish horchata de chufa). Plant once soil is consistently above 65F. Tolerates extreme heat but is NOT drought tolerant — needs steady moisture or it goes dormant. Harvest tubers after the grassy tops yellow in fall. CAUTION: spreads readily and can become weedy/perennial — grow in a contained bed or pot. Frost kills the tops.",
        "companions": [],
        "antagonists": [],
    },
    {
        ...
        "desert_seasons": ["warm", "monsoon"],
        "sow_indoor_weeks_before_transplant": 0,
        "desert_sow_outdoor": ["04-15", "07-15"],
        "desert_transplant": None,
        "desert_harvest": ["05-15", "10-15"],
        "notes": "Ipomoea aquatica (kangkong / ong choy) — a vigorous heat-loving green that thrives above 100F where lettuce and spinach fail. The premier desert summer/monsoon leafy green. Grows in wet soil, large pots, or shallow water; keep it consistently moist. Cut-and-come-again harvest of tender shoots. CAUTION: a USDA federal noxious weed — a permit is required to grow it in some states (including possession restrictions); confirm local legality and never let it escape into waterways.",
        "companions": [],
        "antagonists": [],
    },
    {
        ...
        "desert_transplant": None,
        "desert_harvest": ["05-01", "10-31"],
        "notes": "Chenopodium berlandieri (Aztec broccoli / Aztec spinach) — an ancient Mexican goosefoot, close cousin to quinoa and lamb's quarters. Excellent heat and drought tolerance, a great warm-season spinach substitute that resists bolting. Eat the tender young leaves like spinach and the immature flower-bud clusters like tiny broccoli. Grows 3-5 ft; keep harvested to stay bushy. Tolerates poor and alkaline soils. Self-seeds readily.",
        "companions": ["Corn", "Bean (Bush)"],
        "antagonists": [],
    },
    {
        "name": "Orach",
        ...
        "desert_seasons": ["cool", "warm"],
        "sow_indoor_weeks_before_transplant": 0,
        "desert_sow_outdoor": ["02-01", "03-31"],
        "desert_transplant": None,
        "desert_harvest": ["03-15", "05-31"],
        "notes": "Atriplex hortensis (mountain spinach / French spinach) — a warm-season spinach alternative in the saltbush family. Notably tolerant of saline and very alkaline desert soils. Handles warmth far better than true spinach and, unlike spinach, keeps its flavor after bolting. Not a true heat-lover though: leaves toughen and plants bolt in extreme summer heat, so grow it in the cool/warm shoulder seasons (late winter–spring, and fall). Red, green, and gold types. Also fall-sow Sep–Nov.",
        "companions": [],
        "antagonists": [],
    },
    {
        ...
        "desert_sow_outdoor": None,
        "desert_transplant": ["10-15", "03-15"],
        "desert_harvest": ["07-15", "09-30"],
        "notes": "Diospyros texana — a drought-tolerant native small tree/large shrub (10-15 ft) of the Texas–Chihuahuan borderlands, well suited to low-desert xeriscapes. Loves full sun and well-drained alkaline soil; very low water once established. Smooth mottled gray peeling bark is ornamental. CAUTION: dioecious — you need both a male and a female tree to set the sweet, round, ~1-inch black fruit (ripe July–Sept). Fruit is eaten fresh or made into pudding/jam.",
        "companions": [],
        "antagonists": [],
    },
    {
        ...
        "desert_sow_outdoor": None,
        "desert_transplant": ["03-01", "05-31"],
        "desert_harvest": ["06-01", "08-15"],
        "notes": "Butia capitata / B. odorata (jelly palm / wine palm) — a cold-hardy feather palm (hardy to ~10-15F, USDA 8-11) with arching silvery-blue fronds that performs as well as Phoenix canariensis in Phoenix landscapes. Slow-growing the first 2-3 years then faster, drought tolerant, disease resistant. Bears summer clusters of sweet-tart orange fruit tasting of apricot-pineapple, classically made into jelly, jam, and wine. Full sun, well-drained soil, moderate-to-low water once established. Self-fruitful. Fruit drops messily, so site away from pavement.",
        "companions": [],
        "antagonists": [],
    },
    {
        ...
        "desert_transplant": None,
        "desert_harvest": ["06-15", "10-31"],
        "notes": "Canavalia gladiata — a robust tropical climbing legume with dramatic 12-15 inch flat pods. Loves heat (optimal 68-86F) and its deep root system shrugs off dry spells, making it a strong warm-season/monsoon crop. Nitrogen fixer. Eat the tender YOUNG green pods boiled like green beans, harvested before the seeds swell. CAUTION: mature seeds contain toxins (concanavalin) and require thorough cooking/processing before eating. Vigorous vine to 30 ft — needs a strong, tall trellis.",
        "companions": ["Corn", "Squash (Summer)", "Sunflower"],
        "antagonists": ["Onion", "Garlic"],
    },
    # NEW PLANTS — Research batch 2026-06-01 (second batch)
    {
        "name": "Lima Bean",
        "category": "vegetable",
        "subcategory": "legume",
        ...
        "desert_transplant": None,
        "desert_harvest": ["05-15", "11-15"],
        "notes": "Phaseolus lunatus. Direct sow only (beans resent transplant). In the low desert plant a spring crop (Mar 1-Apr 15) to harvest before June, and a second monsoon crop (Jul 1-Aug 15) that sets pods as temps drop in fall. Blossoms abort above ~80-90F, so productive set happens in the shoulder seasons, not midsummer. Heat-proven cultivars: bush 'Henderson's Bush'/'Fordhook 242'; pole 'King of the Garden'. Nitrogen fixer — use afternoon shade and heavy mulch in June.",
        "companions": ["Corn", "Squash (Summer)", "Cucumber", "Summer Savory", "Sunflower", "Carrot", "Radish"],
        "antagonists": ["Onion", "Garlic", "Beet", "Fennel"],
    },
    {
        "name": "Quinoa",
        "category": "grain",
        ...
        "desert_seasons": ["cool"],
        "sow_indoor_weeks_before_transplant": None,
        "desert_sow_outdoor": ["11-01", "01-15"],
        "desert_transplant": None,
        "desert_harvest": ["03-15", "05-15"],
        "notes": "Chenopodium quinoa. MARGINAL/experimental in the low desert — absent from UA Extension calendars, and pollen sterilizes so seed won't set above ~90-95F. Only viable winter-sown (Nov-mid-Jan) racing to maturity before May heat. Most dependable as a fast cut-and-come-again green rather than for grain; treat grain yield as a bonus. Tolerates alkaline/saline soil. Heat-leaning cultivars: 'Cherry Vanilla' (shortest, most drought-tolerant) and 'Brightest Brilliant Rainbow'. Stake tall heads against wind.",
        "companions": ["Bean (Bush)", "Corn", "Spinach", "Sunflower"],
        "antagonists": ["Beet", "Swiss Chard", "Spinach", "Amaranth"],
    },
    {
        "name": "Cuban Oregano",
        "category": "herb",
        ...
        "desert_sow_outdoor": None,
        "desert_transplant": ["02-15", "04-15"],
        "desert_harvest": ["03-15", "11-30"],
        "notes": "Plectranthus amboinicus (Lamiaceae). Fleshy-leaved tender perennial propagated from 2-3 inch stem cuttings (does not come true from seed). MUST have afternoon shade above ~105-110F or the thick succulent leaves scorch — grow against an east wall or in a movable container. Drought-adapted and intolerant of soggy soil: water deeply but infrequently in fast-draining mix. Frost-sensitive below ~40F; protect or move indoors during winter cold snaps. Pungent oregano-thyme flavor with camphor notes — use sparingly.",
        "companions": ["Pepper", "Eggplant", "Tomato", "Basil"],
        "antagonists": [],
    },
    {
        "name": "Anise Hyssop",
        ...
        "sow_indoor_weeks_before_transplant": 8,
        "desert_sow_outdoor": ["09-15", "11-15"],
        "desert_transplant": ["02-01", "03-15"],
        "desert_harvest": ["03-15", "06-15"],
        "notes": "Agastache foeniculum (Lamiaceae). A cool-prairie native that is MARGINAL in the low desert — behaves as a cool-season annual/short-lived perennial here. Give sharp drainage, full sun only in cool months, and afternoon shade through summer where it may go semi-dormant or die out. Most reliable fall-sown for a Mar-Jun harvest. For a true desert perennial substitute the AZ-native Agastache rupestris. Sweet anise/licorice leaves and flowers for tea; exceptional bee and hummingbird plant; deer-resistant.",
        "companions": ["Squash (Summer)", "Cucumber", "Melon"],
        "antagonists": [],
    },
    {
        ...
        "category": "edible_native",
        "subcategory": "cactus",
        "days_to_maturity_min": 12775,
        "days_to_maturity_max": 18250,
        "spacing_inches": 180,
        "sun": "full",
        "water": "low",
        "heat_tolerance": "excellent",
        ...
        "sow_indoor_weeks_before_transplant": None,
        "desert_sow_outdoor": None,
        "desert_transplant": ["04-01", "06-15"],
        "desert_harvest": ["06-15", "07-31"],
        "notes": "Stenocereus thurberi. The iconic multi-stemmed columnar cactus of the Sonoran Desert, reaching 16-20 ft. Night-blooming white flowers are pollinated by bats and moths; the sweet red-purple fruit (pitaya dulce) tastes like watermelon and was a Tohono O'odham staple eaten fresh or made into syrup, jam, and wine. Extremely slow — ~35 years to first bloom from seed (faster from cuttings) — and frost-tender below ~25F, so it is a heritage landscape crop, not an annual planting. Needs gritty, fast-draining soil; rots if overwatered. Use gravel top-dressing, never organic mulch.",
        "companions": ["Palo Verde", "Saguaro", "Mesquite"],
        "antagonists": [],
    },
    {
        "name": "Finger Lime",
        ...
        "desert_transplant": ["03-01", "04-15"],
        "desert_harvest": ["11-01", "02-28"],
        "notes": "Citrus australasica. A rainforest understory shrub, not a true desert citrus — in Phoenix/Tucson it MUST have afternoon/dappled shade or it scorches, yet too much shade suppresses fruiting (east-facing or under high canopy is ideal). Best grown in a large container so it can be pulled under cover during frosts below 30F; whitewash exposed trunk wood (1:1 latex:water) against sunburn. Dislikes alkaline caliche — use an acidified well-draining mix and chelated iron/zinc/manganese. Keep evenly moist. Vesicles burst like 'citrus caviar'. Cultivars: 'Rainforest Pearl', 'Pink Ice', 'Red Champagne'.",
        "companions": ["Nasturtium", "Marigold", "Borage"],
        "antagonists": [],
    },
    {
        "name": "Sour Orange (Seville)",
        "category": "fruit",
        "subcategory": "citrus",
        "days_to_maturity_min": 730,
        "days_to_maturity_max": 1460,
        ...
        "desert_sow_outdoor": None,
        "desert_transplant": ["03-01", "04-30"],
        "desert_harvest": ["12-01", "03-31"],
        "notes": "Citrus x aurantium. The classic low-desert street/dooryard citrus — exceptionally adapted to alkaline soil, heat, drought, and neglect, and the standard rootstock for grafting sweet citrus in Arizona (handles frost to ~25F with minor damage). Fruit is too sour/bitter to eat fresh but prized for marmalade, agua de Seville, and as a souring agent; blossoms yield neroli. Whitewash young trunks (1:1 latex:water) against sunburn and stake the first 1-2 years. Supplement iron/zinc/manganese for alkaline chlorosis. Note: highly susceptible to Citrus Tristeza Virus.",
        "companions": ["Nasturtium", "Marigold", "Sweet Alyssum", "Borage"],
        "antagonists": [],
    },

    # ── CONSOLIDATED PLANT RESEARCH (28 plant-research PRs, 2026-04-14 → 2026-06-01) ──
    {
        'name': 'Achocha',
        'category': 'vegetable',
        ...
        'desert_transplant': ['04-01', '05-31'],
        'desert_harvest': ['06-15', '11-15'],
        'notes': 'Cyclanthera pedata — Andean cucurbit also called slipper gourd or stuffing cucumber. Largely pest-free in desert — cucumber beetles ignore it. Vigorous vine reaches 15-20 ft, needs sturdy trellis. Young fruits eaten raw like cucumber; mature hollow fruits stuffed and baked like peppers. Tolerates heat much better than regular cucumbers. Day-length neutral — produces all summer. Self-seeds. Soak seeds 24 hours. Drought-stressed plants drop fruit — water consistently during fruit set.',
        'companions': ['Corn', 'Bean (Bush)', 'Sunflower', 'Nasturtium'],
        'antagonists': ['Potato'],
    },
    {
        'name': 'Ajwain',
        ...
        'desert_seasons': ['cool'],
        'sow_indoor_weeks_before_transplant': 0,
        'desert_sow_outdoor': ['10-15', '11-30'],
        'desert_transplant': None,
        'desert_harvest': ['03-15', '05-15'],
        'notes': 'Trachyspermum ammi (carom) — an Apiaceae herb whose thyme-scented seeds are a staple of Indian cooking. A cool-and-dry-season (rabi) crop that grows best at 60-80F, making the low-desert winter ideal: direct sow Oct-Nov, harvest seed heads as they brown in spring before the heat. Drought tolerant with wide climatic adaptability. Avoid high humidity during flowering/seed set, which hurts seed quality — the arid desert spring suits it well. White umbel flowers also draw beneficial insects. Leaves are edible too, with a stronger thyme-cumin flavor. Let seed heads dry fully, then thresh and store airtight.',
        'companions': ['Carrot', 'Dill', 'Cilantro', 'Fennel'],
        'antagonists': [],
    },
    {
        'name': 'Ash Gourd',
        ...
        'desert_sow_outdoor': ['03-15', '07-31'],
        'desert_transplant': ['04-01', '05-15'],
        'desert_harvest': ['07-15', '11-30'],
        'notes': 'Benincasa hispida (winter melon / wax gourd / petha / dong gua). A vigorous warm-season vine needing a long stretch of heat (100-160 days). Direct sow once soil hits 70F, or restart with the monsoon; give it 4-6ft of room and a trellis or wide ground run. Pale yellow bee-pollinated flowers set huge 10-40lb fruits with a waxy bloom that lets them store for months unrefrigerated. Keep evenly moist while fruiting and mulch heavily — fruit set drops in extreme dry heat, so afternoon water matters. Used in Asian soups, curries, and petha sweets.',
        'companions': ['Corn', 'Bean (Bush)', 'Nasturtium', 'Marigold'],
        'antagonists': ['Potato'],
    },
    {
        ...
        'sow_indoor_weeks_before_transplant': 8,
        'desert_sow_outdoor': ['10-01', '03-15'],
        'desert_transplant': ['10-01', '04-15'],
        'desert_harvest': None,
        'notes': "Salvia greggii — Chihuahuan Desert native subshrub, top-tier hummingbird and native bee plant, blooms spring through fall (and through winter in 9b/10a). Cultivars in red, pink, white, coral, purple ('Furman's Red', 'Wild Watermelon', 'Hot Lips', 'Ultraviolet'). Tolerates 115F and 10F, fully drought-tolerant once established. Cut back by 1/3 in late winter to keep tidy and bloom-heavy. Avoid overwatering and amended soil — both shorten lifespan. Pairs beautifully with desert food gardens to bring in pollinators. Lightly fragrant foliage. Lifespan 5-8 years.",
        'companions': ['Lavender', 'Rosemary', 'Penstemon', 'Yarrow', 'Tomato', 'Pepper'],
        'antagonists': [],
    },
    {
        ...
        'desert_seasons': ['warm', 'monsoon'],
        'sow_indoor_weeks_before_transplant': 0,
        'desert_sow_outdoor': ['04-01', '06-15'],
        'desert_transplant': None,
        'desert_harvest': ['08-15', '11-30'],
        'notes': "Vigna subterranea. An African drought legume that yields where even peanuts fail — famously grown on the Sahara's southern fringe near Timbuktu. Like peanut it is geocarpic: after pollination the flower stalks push the pods underground to ripen, so it needs loose sandy or loamy soil for easy pod fill and harvest. Direct sow into warm soil; tolerates marginal fertility and limited rain, fixing its own nitrogen. The complete-protein seeds are boiled, roasted, or milled. Long season (110-150 days) — start by mid-June at the latest in the low desert.",
        'companions': ['Sorghum', 'Corn', 'Sunflower', 'Squash (Summer)'],
        'antagonists': ['Onion', 'Garlic', 'Chive'],
    },
    {
        'name': 'Banana',
        ...
        'desert_sow_outdoor': None,
        'desert_transplant': ['03-15', '05-31'],
        'desert_harvest': ['09-01', '03-31'],
        'notes': 'Musa spp. Dwarf Cavendish, Ice Cream (Blue Java), and Dwarf Red are best for Phoenix. Plant in protected courtyard or against south-facing wall for frost protection. Extremely heavy water user — daily deep watering in summer. Heavy feeder — fertilize monthly with balanced fertilizer. Pseudostem dies after fruiting; new pups replace it. Wrap trunk in winter below 32F. Takes 12-18 months from planting to first bunch. Wind protection essential.',
        'companions': ['Sweet Potato', 'Lemongrass', 'Papaya', 'Taro'],
        'antagonists': [],
    },
    {
        'name': 'Brittlebush',
        ...
        'heat_tolerance': 'very high',
        'cold_tolerance': 'moderate',
        'desert_seasons': ['cool', 'warm', 'hot'],
        'sow_indoor_weeks_before_transplant': None,
        'desert_sow_outdoor': ['10-01', '02-28'],
        'desert_transplant': ['10-01', '03-31'],
        'desert_harvest': None,
        'notes': 'Encelia farinosa — iconic Sonoran/Mojave native subshrub with silvery felted leaves and brilliant yellow daisy flowers Feb–May. Mounds to 3-4 ft. Drought-deciduous: drops leaves in extreme heat/drought then leafs out with rain. Hardy to ~20°F. Critical early-spring nectar source for native bees and butterflies. Self-seeds readily. Zero supplemental water after establishment. Pair with palo verde, desert lavender, globe mallow.',
        'companions': ['Desert Lavender', 'Globe Mallow', 'Palo Verde', 'Penstemon'],
        'antagonists': [],
    },
    {
        'name': 'Calamondin',
        ...
        'desert_transplant': ['02-15', '04-30'],
        'desert_harvest': ['11-01', '04-30'],
        'notes': 'Citrofortunella microcarpa. Compact ornamental citrus producing small, very sour fruits year-round once established. Excellent for container growing — one of the best patio citrus for Phoenix. More cold-hardy than most citrus (to 20F). Fruits used in Filipino cuisine (calamansi juice), marinades, and as lemon/lime substitute. Almost always in fruit. Thrives in reflected heat. Low maintenance once established. Extremely productive.',
        'companions': ['Marigold', 'Lavender', 'Nasturtium'],
        'antagonists': [],
    },
    {
        'name': 'Caraway',
        ...
        'desert_transplant': None,
        'desert_harvest': ['04-15', '06-30'],
        'notes': 'Carum carvi — biennial seed crop in Apiaceae family. Direct sow in fall; produces foliage first season, seeds second season (or treat as fast-bolting annual in desert where heat triggers bolting in spring of year one). Harvest umbels when seeds turn brown, dry indoors. Leaves and taproot also edible. Drought-tolerant once established; bolts in extreme heat — finish before May.',
        'companions': ['Pea', 'Coriander', 'Strawberry'],
    ...
    },
    {
        ...
        'desert_seasons': ['warm', 'monsoon'],
        'sow_indoor_weeks_before_transplant': 10,
        'desert_sow_outdoor': ['01-15', '02-28'],
        'desert_transplant': ['03-01', '04-15'],
        'desert_harvest': ['06-15', '11-15'],
        'notes': "Capsicum chinense 'Carolina Reaper' — once-record-holding superhot averaging 1.6 million SHU. Long indoor start (8-12 weeks) needed because germination is slow at 80-90F. Like all chinense peppers, drops flowers above 95F daytime — afternoon shade cloth and mulched soil help. Best fruit set comes in monsoon humidity. Wear gloves when handling ripe pods. Often produces best in second year as a perennial in protected microclimates.",
        'companions': ['Basil', 'Carrot', 'Onion', 'Marigold', 'Nasturtium', 'Tomato'],
        'antagonists': ['Fennel', 'Brassicas'],
    },
    {
        'name': 'Chia',
        ...
        'desert_sow_outdoor': ['02-15', '03-31'],
        'desert_transplant': None,
        'desert_harvest': ['05-15', '06-30'],
        'notes': "Salvia hispanica — drought-resistant Mexican sage grown for omega-3-rich seed. Frost-tender and short-day flowering: traditional cultivars only set seed late in the season, so in the low desert sow in late winter for a spring crop ahead of summer heat, or grow simply for nutritious microgreens and sprouts year-round (cool season outdoors). Adaptable to most well-drained soils, thrives on low fertilizer and minimal irrigation. Direct sow shallow (1/4 in); plants reach 3-5 ft with blue flower spikes that draw bees. Let spikes dry on the plant, then thresh for seed. Day-neutral 'Black-seeded' selections set seed more reliably at this latitude.",
        'companions': ['Bean', 'Squash', 'Sunflower'],
        'antagonists': [],
    },
    {
        'name': 'Choy Sum',
        'category': 'vegetable',
        'subcategory': 'asian green',
        'days_to_maturity_min': 30,
        'days_to_maturity_max': 50,
        'spacing_inches': 6,
        'sun': 'full to partial',
        ...
        'desert_transplant': None,
        'desert_harvest': ['10-15', '04-30'],
        'notes': 'Brassica rapa var. parachinensis — flowering Chinese cabbage. Tender stems and yellow flowers are the prize, harvested just as buds open. Fast-maturing winter crop in low desert; bolts immediately in heat. Succession sow every 2-3 weeks October through January. Stir-fry whole stems. Tatsoi and pak choi relative.',
        'companions': ['Onion', 'Garlic', 'Beet', 'Carrot'],
        'antagonists': ['Tomato', 'Pepper', 'Strawberry'],
    },
    {
        'name': 'Chuparosa',
        ...
        'desert_transplant': ['10-01', '03-31'],
        'desert_harvest': ['01-01', '04-30'],
        'notes': 'Justicia californica. Sonoran Desert native with tubular red-orange flowers that taste like fresh cucumber. Primary hummingbird plant — blooms late winter through spring when little else flowers. Extremely drought-tolerant, zero supplemental water once established. Deciduous in drought, evergreen with occasional deep watering. Propagates from cuttings. No pests, no diseases. Flowers edible raw in salads or as garnish. Attracts hummingbirds, butterflies, and native bees.',
        'companions': ['Globe Mallow', 'Blackfoot Daisy', 'Prickly Pear', 'Desert Milkweed'],
        'antagonists': [],
    },
    {
        'name': 'Cowpea',
        ...
        'desert_transplant': None,
        'desert_harvest': ['06-01', '11-15'],
        'notes': 'Vigna unguiculata — black-eyed peas, southern peas, crowder peas. One of the most heat- and drought-tolerant legumes. Direct sow when soil is 70F+. Excellent monsoon-season crop in low desert; fixes nitrogen. Pick green for shelling, dry for storage. Varieties: California Blackeye #5, Pinkeye Purple Hull, Mississippi Silver. Avoid overwatering. Cover crop value high.',
        'companions': ['Corn', 'Squash', 'Sunflower', 'Okra', 'Sorghum'],
        'antagonists': ['Onion', 'Garlic', 'Fennel'],
    },
    {
        'name': 'Creosote Bush',
        'category': 'herb',
        'subcategory': 'native medicinal',
        'days_to_maturity_min': 365,
        'days_to_maturity_max': 730,
        'spacing_inches': 72,
        'sun': 'full',
        ...
        'desert_transplant': ['10-01', '04-30'],
        'desert_harvest': ['01-01', '12-31'],
        'notes': "Larrea tridentata (chaparral, gobernadora). The iconic, intensely 'rain-smell' Sonoran shrub and one of the most drought-tolerant plants on Earth. Leaves are used traditionally as a medicinal/topical tea (chaparral) and the plant is a keystone native habitat shrub. IMPORTANT: internal use is NOT food-safe — chaparral tea is linked to liver toxicity (FDA warning); treat as ornamental/medicinal-with-caution, not an edible. Effectively no irrigation once established.",
        'companions': ['Mesquite', 'Palo Verde', 'Brittlebush'],
        'antagonists': [],
    },
    {
        'name': 'Curry Plant',
        ...
        'desert_transplant': ['10-15', '03-31'],
        'desert_harvest': ['01-01', '12-31'],
        'notes': 'Helichrysum italicum — a Mediterranean evergreen subshrub (to 2 ft tall, 3 ft wide) with fine silvery foliage that smells strongly of curry. Ideal for the desert: thrives in full sun and poor, sandy, alkaline, well-drained soil, is drought tolerant once established, and actually prefers to stay dry in summer (rot is the main risk — never overwater). Hardy roughly Zones 7-11 but dislikes hard frost. Not a true culinary curry, but finely chopped fresh leaves lend a mild curry aroma to eggs, mild cheeses, rice, fish, vinegars, and dressings (often added then removed before serving). Lemon-yellow summer flower clusters are everlasting and dry well. Drought- and deer-resistant, draws pollinators.',
        'companions': ['Lavender', 'Rosemary', 'Sage', 'Thyme'],
        'antagonists': [],
    },
    {
        'name': 'Cushaw Squash',
        ...
        'desert_seasons': ['warm', 'monsoon'],
        'sow_indoor_weeks_before_transplant': 0,
        'desert_sow_outdoor': ['03-01', '07-31'],
        'desert_transplant': None,
        'desert_harvest': ['07-01', '11-15'],
        'notes': 'Cucurbita argyrosperma (silver-seed gourd / kershaw). A distinct squash species from C. moschata/maxima — heat-tolerant, drought-tolerant, and notably resistant to squash vine borer, making it one of the best storage squashes for the low desert. Long vigorous vines; fruit stores for months. Direct-sow after frost or for a monsoon (Jul) crop. Flowers, immature fruit (as summer squash), seeds, and vine tips are all edible. Native Southwest/Mexican landrace staple.',
        'companions': ['Corn', 'Bean (Bush)', 'Tepary Bean', 'Sunflower'],
        'antagonists': ['Potato'],
    },
    {
        ...
        'desert_transplant': ['10-01', '03-31'],
        'desert_harvest': None,
        'notes': 'Hyptis emoryi — Sonoran Desert native shrub to 6-10 ft with fragrant gray-green foliage and tiny lavender flowers nearly year-round. Outstanding pollinator plant: hummingbirds, native bees, butterflies. Extremely drought-tolerant once established (1-2x/month deep summer water). Not a true lavender but lavender-scented. Hardy to ~25°F. Light prune after main bloom flush. No supplemental water needed after year 2.',
        'companions': ['Desert Milkweed', 'Globe Mallow', 'Brittlebush'],
        'antagonists': [],
    },
    {
        'name': 'Desert Willow',
        'category': 'ornamental',
        'subcategory': 'native tree',
        'days_to_maturity_min': 730,
        'days_to_maturity_max': 1460,
        'spacing_inches': 180,
        'sun': 'full',
        ...
        'desert_transplant': ['10-01', '03-31'],
        'desert_harvest': None,
        'notes': "Chilopsis linearis — small native Sonoran/Chihuahuan desert tree with orchid-like pink-lavender trumpet flowers May through October. Major hummingbird and native bee magnet; cornerstone pollinator plant for desert food gardens. Deciduous, fast-growing, extremely drought-tolerant. Flowers traditionally used in mild tea for antioxidant properties. Not a true willow. 'Bubba' and 'Burgundy' are popular sterile cultivars.",
        'companions': ['Mesquite', 'Palo Verde', 'Desert Milkweed', 'Globe Mallow'],
        'antagonists': [],
    },
    {
        ...
        'sow_indoor_weeks_before_transplant': None,
        'desert_sow_outdoor': None,
        'desert_transplant': ['09-15', '11-30'],
        'desert_harvest': ['10-01', '06-30'],
        'notes': "Allium x proliferum — perennial topsetting onion, also called tree onion. Reproduces by topset bulbils that fall and root themselves, hence 'walking'. Hardy USDA 3-10. In low desert, plant bulbils in fall; goes summer-dormant under extreme heat then returns. Use young greens like scallions year-round; harvest topsets late spring for pickling or replanting. Extremely low-maintenance and pest-resistant. Provide afternoon shade and mulch heavily for best summer survival.",
        'companions': ['Carrot', 'Beet', 'Lettuce', 'Tomato', 'Strawberry', 'Chamomile'],
        'antagonists': ['Bean', 'Pea', 'Asparagus'],
    },
    {
        'name': 'Endive',
        ...
        'desert_seasons': ['cool'],
        'sow_indoor_weeks_before_transplant': 4,
        'desert_sow_outdoor': ['09-15', '01-31'],
        'desert_transplant': ['10-01', '02-15'],
        'desert_harvest': ['11-15', '04-15'],
        'notes': 'Cichorium endivia. Cool-season leafy green in the chicory family. Curly types (frisée) and broadleaf types (escarole). Bitter flavor mellows after frost and with blanching — tie outer leaves over the heart 2-3 weeks before harvest to blanch. Bolts fast when temps exceed 80F. More heat-tolerant than lettuce but still strictly cool season in desert.',
        'companions': ['Carrot', 'Beet', 'Onion', 'Radish'],
        'antagonists': [],
    },
    {
        'name': 'Fremont Wolfberry',
        'category': 'fruit',
        'subcategory': 'berry',
        'days_to_maturity_min': 365,
        'days_to_maturity_max': 730,
        ...
        'desert_transplant': ['10-15', '03-15'],
        'desert_harvest': ['03-01', '05-31'],
        'notes': "Lycium fremontii — Sonoran Desert native thornbush (also called desert-thorn or salicieso) in the nightshade family. Among the largest and sweetest of the native wolfberries: round 1cm berries ripen yellow to orange-red in spring, with small lavender flowers preceding them. A traditional O'odham food, rich in vitamins A, B2, and C plus calcium, potassium, iron, and zinc. Flavor varies plant to plant (some bitter) and sweetens markedly when dried or cooked into soups, syrups, and jams — berries are perishable, process the day they're picked. Extremely drought-hardy, tolerates mildly acidic to strongly alkaline soil, grows below 3000 ft. Drought-deciduous: drops leaves in heat/drought and releafs after rain. Mind the thorns when harvesting.",
        'companions': ['Mesquite', 'Palo Verde', 'Brittlebush', 'Desert Lavender'],
        'antagonists': [],
    },
    {
        'name': 'Galangal',
        ...
        'desert_transplant': ['03-01', '04-30'],
        'desert_harvest': ['11-01', '02-28'],
        'notes': 'Alpinia galanga — Thai/Indonesian rhizome with sharper, more pine-citrus flavor than ginger. Loves humidity and warmth; afternoon shade essential in low desert summers. Grow in deep pots that can move under cover for winter — rhizomes rot below 50F. Heavy feeder, rich soil with consistent moisture. Harvest mature rhizomes after 9-12 months. Treat like ginger but with even more shade.',
        'companions': ['Turmeric', 'Ginger', 'Lemongrass', 'Curry Leaf'],
        'antagonists': [],
    },
    {
        'name': 'Garlic Chives',
        ...
        'sow_indoor_weeks_before_transplant': 6,
        'desert_sow_outdoor': ['09-15', '02-28'],
        'desert_transplant': ['09-15', '03-15'],
        'desert_harvest': ['11-01', '06-30'],
        'notes': "Allium tuberosum — flat-leaved perennial allium with mild garlic flavor. Hardy and long-lived in desert gardens; goes semi-dormant in peak summer heat but reliably returns. White late-summer flowers attract pollinators and are edible. Divide clumps every 3-4 years. Self-seeds aggressively — deadhead if you don't want volunteers. Good understory planting near fruit trees.",
        'companions': ['Carrot', 'Tomato', 'Rose', 'Apple'],
        'antagonists': ['Bean (Bush)', 'Pea'],
    },
    {
        'name': 'Goldenberry',
        'category': 'fruit',
        ...
        'desert_transplant': ['02-15', '04-15'],
        'desert_harvest': ['06-15', '11-15'],
        'notes': 'Physalis peruviana — Cape Gooseberry or Inca Berry. Tender perennial grown as annual; can survive mild low-desert winters with mulch. Husk-covered golden fruit with sweet-tart pineapple flavor. Self-fertile and far more heat-tolerant than tomatillos. Will sprawl 3-4 ft so cage or stake. Light afternoon shade boosts production above 105F. Fruit drops to ground when ripe. High in antioxidants and vitamin C.',
        'companions': ['Basil', 'Marigold', 'Nasturtium', 'Onion'],
        'antagonists': ['Fennel'],
    },
    {
        'name': 'Hatch Chile',
        ...
        'desert_sow_outdoor': ['02-15', '03-31'],
        'desert_transplant': ['03-01', '04-15'],
        'desert_harvest': ['07-01', '10-15'],
        'notes': 'Capsicum annuum — New Mexico chile (NuMex) varieties grown in the Hatch valley. Common cultivars: Big Jim (mild, 2,000-4,000 SHU), Sandia (hot), Lumbre (very hot), NuMex Joe E. Parker (mild). Bred for the desert SW — among the best peppers for low desert. Roast on a flame for the iconic Hatch chile flavor. Direct desert ancestry (NMSU breeding program at Las Cruces) makes them well-suited to Phoenix heat. Provide afternoon shade above 110F to prevent fruit drop. Harvest green or red.',
        'companions': ['Tomato', 'Basil', 'Carrot', 'Onion', 'Spinach', 'Marigold', 'Corn'],
        'antagonists': ['Fennel', 'Brassicas'],
    },
    {
        'name': 'Hoja Santa',
        ...
        'desert_transplant': ['03-01', '04-30'],
        'desert_harvest': ['05-01', '11-30'],
        'notes': 'Large-leaved tropical perennial that needs afternoon shade and steady moisture in low desert; full sun scorches the big leaves, so site on an east side or under filtered light. Roots love water but not standing puddles. Dies back to roots after frost in 9b but regrows from heavy mulch; treat as evergreen in 10a or grow in a pot to overwinter. Spreads by rhizome, so contain it.',
        'companions': ['Ginger', 'Lemongrass'],
        'antagonists': [],
    },
    {
        'name': 'Horse Gram',
        ...
        'desert_sow_outdoor': ['03-15', '08-15'],
        'desert_transplant': None,
        'desert_harvest': ['10-01', '12-15'],
        'notes': 'Macrotyloma uniflorum (kulthi). A highly drought-tolerant, underused pulse that thrives on poor gravelly and saline soils where little else grows on 300-900mm of rain — a natural monsoon dry-farm crop. Direct sow into warm soil with minimal inputs and no weeding; it fixes nitrogen and matures in 90-120 days. The hard reddish-brown seeds are cooked as a protein-rich dal or sprouted; foliage doubles as livestock forage. Pairs well behind tepary and moth bean in a desert legume rotation.',
        'companions': ['Sorghum', 'Corn', 'Sunflower', 'Tepary Bean'],
        'antagonists': ['Onion', 'Garlic', 'Chive'],
    },
    {
        'name': 'Hyacinth Bean',
        ...
        'desert_transplant': None,
        'desert_harvest': ['06-15', '11-15'],
        'notes': 'Lablab purpureus — vigorous perennial vine (annual in frost areas) with purple stems, lavender flowers, and edible purple pods. Excellent monsoon-season legume for low desert; fixes nitrogen. Young pods, immature seeds, and dried beans all edible — but DRIED BEANS MUST BE BOILED in 2 changes of water (contains cyanogenic glycosides). Heat- and drought-tolerant. Climbs 10-15ft; needs strong trellis. Ornamental enough for front-yard edible landscaping. Pollinator magnet.',
        'companions': ['Corn', 'Squash', 'Sunflower', 'Sorghum'],
        'antagonists': ['Onion', 'Garlic'],
    },
    {
        'name': 'Hyssop',
        ...
        'desert_transplant': ['03-01', '04-30'],
        'desert_harvest': ['05-01', '10-31'],
        'notes': "Hyssopus officinalis — Mediterranean perennial herb in the mint family, anise-mint flavor used in liqueurs (chartreuse, absinthe) and Middle Eastern za'atar blends. Extremely drought-tolerant once established, thrives in poor alkaline soil typical of desert. Blue flower spikes are major pollinator magnet — attracts bees, butterflies, hummingbirds. Cut back by half in late winter to maintain shape. Companion to brassicas: repels cabbage moth. Do not confuse with Anise Hyssop (Agastache foeniculum), a different North American native.",
        'companions': ['Cabbage', 'Broccoli', 'Cauliflower', 'Grape'],
        'antagonists': ['Radish'],
    },
    {
        'name': "I'itoi Onion",
        ...
        'sow_indoor_weeks_before_transplant': 0,
        'desert_sow_outdoor': None,
        'desert_transplant': ['09-15', '02-28'],
        'desert_harvest': ['05-01', '07-31'],
        'notes': "Allium cepa var. aggregatum. Traditional Tohono O'odham multiplier onion — the ultimate desert-adapted allium. Uses 1/3 the water of standard onions. Plant bulbs 1 inch deep in fall or early spring. Each bulb multiplies into a cluster of 6-12 bulblets. Goes dormant in summer heat, regrows when fall rains arrive. Perennial — leave some in ground to multiply. Flavor similar to shallot — mild, sweet. Greens harvestable in winter. Extremely low-maintenance.",
        'companions': ['Carrot', 'Lettuce', 'Tomato', 'Pepper', 'Beet'],
        'antagonists': ['Bean (Bush)', 'Pea'],
    },
    {
        ...
        'sow_indoor_weeks_before_transplant': 0,
        'desert_sow_outdoor': None,
        'desert_transplant': ['03-01', '08-15'],
        'desert_harvest': ['06-01', '11-15'],
        'notes': "Coccinia grandis (tindora, tendli, scarlet gourd) — a tropical perennial vine grown for small cucumber-like fruits and tender shoots used in South/Southeast Asian curries and stir-fries. Genuinely thrives in Phoenix heat and monsoon humidity, regrowing from deep tuberous roots after frost. CAUTION: extremely vigorous (to ~4 in/day) and a noxious invasive in Hawaii/Florida/Texas — NOT on Arizona's noxious weed list, but contain it, never plant near washes or canals, and remove tubers if discontinuing. Usually grown from cuttings; plant a self-fruitful clone or both sexes for fruit.",
        'companions': [],
        'antagonists': [],
    },
    {
        ...
        'desert_transplant': ['03-01', '04-30'],
        'desert_harvest': ['01-01', '12-31'],
        'notes': 'Citrus hystrix — also called Makrut lime. Grown primarily for its aromatic double-lobed leaves, which are essential in Thai and Southeast Asian cooking (tom kha, tom yum, curry paste). Fruit is knobby and bitter but zest is prized. Most cold-sensitive citrus — protect or bring indoors below 32F. Container-grown is ideal in desert: dappled afternoon shade and frost protection in winter. Harvest leaves year-round; fresh or frozen retain flavor best.',
        'companions': ['Basil', 'Lemongrass', 'Nasturtium'],
        'antagonists': [],
    },
    {
        'name': 'Komatsuna',
        ...
        'desert_transplant': ['10-01', '03-15'],
        'desert_harvest': ['10-15', '04-30'],
        'notes': 'Brassica rapa var. perviridis — Japanese mustard spinach. Faster, more heat- and cold-tolerant than spinach or bok choy. Mild mustard flavor; use raw young or cooked mature. Cut-and-come-again. Frost-hardy to ~20°F. Bolts in desert heat above ~85°F — strictly cool-season here. Succession sow every 2-3 weeks Oct–Feb. Less prone to flea beetles than other brassicas.',
        'companions': ['Carrot', 'Beet', 'Onion', 'Dill'],
        'antagonists': ['Strawberry'],
    },
    {
        'name': 'Lambsquarters',
        ...
        'desert_sow_outdoor': ['02-01', '04-15'],
        'desert_transplant': None,
        'desert_harvest': ['03-15', '10-15'],
        'notes': "Chenopodium album — wild edible / 'weed' that grows freely across the SW. Known as quelites in Mexican cuisine. More nutritious than spinach (higher protein, calcium, vitamin A). Extremely drought tolerant once established. Self-seeds aggressively — let a few go to seed for continuous patches. Cook young leaves like spinach; older leaves get tough. Seeds are a quinoa relative and edible too. Excellent volunteer crop in desert gardens, popping up after monsoon rains. Avoid wild-collecting near roads or sprayed areas.",
        'companions': ['Corn', 'Bean (Bush)', 'Squash (Summer)'],
        'antagonists': [],
    },
    {
        'name': 'Lentil',
        ...
        'desert_seasons': ['cool'],
        'sow_indoor_weeks_before_transplant': None,
        'desert_sow_outdoor': ['10-15', '12-31'],
        'desert_transplant': None,
        'desert_harvest': ['03-15', '05-31'],
        'notes': 'Lens culinaris — cool-season pulse grown like fava or pea in low desert. Sow direct fall through early winter; harvest before May heat. Nitrogen-fixing — inoculate with rhizobium for best yields. Tolerates poor soil and drought. Pull whole plants when pods rattle; thresh dry. French green, Spanish brown, and red varieties all viable. Often used as a winter cover crop.',
        'companions': ['Carrot', 'Cucumber', 'Potato'],
        'antagonists': ['Onion', 'Garlic'],
    },
    {
        'name': 'Mache',
        ...
        'desert_sow_outdoor': ['10-01', '01-31'],
        'desert_transplant': None,
        'desert_harvest': ['11-15', '03-15'],
        'notes': "Valerianella locusta — also called corn salad or lamb's lettuce. Cold-hardy small rosette green with mild, nutty flavor (think mild butter lettuce + hazelnut). Direct-sow in cool weather; needs cold to germinate well (refrigerate seed 1 week before sowing in warmer Sep/Oct). Bolts quickly above 75F so plant for winter harvest in Zone 9b. Cut whole rosettes at base. Self-seeds readily for next winter.",
        'companions': ['Lettuce', 'Spinach', 'Carrot', 'Radish'],
        'antagonists': [],
    },
    {
        'name': 'Magenta Spreen',
        ...
        'desert_seasons': ['cool', 'warm'],
        'sow_indoor_weeks_before_transplant': None,
        'desert_sow_outdoor': ['09-15', '03-31'],
        'desert_transplant': None,
        'desert_harvest': ['11-01', '06-15'],
        'notes': 'Chenopodium giganteum — also called tree spinach or giant lambsquarters. Heat-tolerant spinach substitute with brilliant magenta-pink new growth. Self-seeding annual that grows 4-8ft tall. Pinch tops weekly for tender greens — flavor is mild, similar to spinach. Drought-tolerant once established. Closely related to quinoa and lambsquarters; seeds are also edible. Contains oxalates — cook before eating large quantities. Excellent low-desert green during shoulder seasons when true spinach struggles.',
        'companions': ['Bean (Bush)', 'Pea', 'Lettuce'],
        'antagonists': [],
    },
    {
        'name': 'Mandarin',
        ...
        'desert_sow_outdoor': None,
        'desert_transplant': ['02-15', '04-15'],
        'desert_harvest': ['11-15', '03-31'],
        'notes': 'Citrus reticulata. One of the best-performing citrus in Phoenix/desert. Includes tangerines, Satsumas, clementines, and W. Murcott/Tango types. Hardy to ~25F — more cold-tolerant than lemons or limes. Plant in Feb-Apr after last frost; avoid midsummer planting. Whitewash trunk to prevent sunburn. Needs well-drained soil and deep, infrequent watering. Kishu, Kinnow, and Gold Nugget are outstanding desert varieties. Typically self-fertile.',
        'companions': ['Nasturtium', 'Borage', 'Marigold', 'Yarrow'],
        'antagonists': [],
    },
    {
        'name': 'Molokhia',
        ...
        'sow_indoor_weeks_before_transplant': 4,
        'desert_sow_outdoor': ['03-15', '07-15'],
        'desert_transplant': ['04-01', '07-31'],
        'desert_harvest': ['05-15', '10-15'],
        'notes': 'Corchorus olitorius — Egyptian spinach, jute mallow. One of the most heat-loving leafy greens; thrives at 100F+ when lettuce/spinach are long gone. Direct sow when soil is 70F+. Pinch tips at 12in to encourage branching; harvest leaves continuously. Mucilaginous (okra-like) when cooked — used in classic Egyptian molokhia soup. High in vitamins A, C, calcium, iron. Self-seeds in desert. DO NOT eat seed pods — toxic.',
        'companions': ['Okra', 'Roselle', 'Basil', 'Sorghum'],
        'antagonists': [],
    },
    {
        'name': 'Moth Bean',
        ...
        'desert_sow_outdoor': ['04-01', '07-15'],
        'desert_transplant': None,
        'desert_harvest': ['06-15', '10-15'],
        'notes': 'One of the best heat/drought legumes for the low desert — a Thar/Rajasthan arid-zone staple (Vigna aconitifolia) that thrives at 110F+ and stays succulent at the end of the hot season. Direct-sow into warm soil (taproot, do not transplant); needs no trellis. Creeping habit doubles as living mulch and fixes nitrogen. Very low water once established — heat is a feature, not a problem. Dry seeds make dal/matki; young pods and leaves also edible (~22-24% protein).',
        'companions': ['Corn', 'Squash (Summer)', 'Sorghum', 'Pearl Millet'],
        'antagonists': ['Onion', 'Garlic', 'Garlic Chives', 'Egyptian Walking Onion'],
    },
    {
        'name': 'Naranjilla',
        'category': 'fruit',
        ...
        'desert_transplant': ['03-01', '04-15'],
        'desert_harvest': ['09-01', '12-31'],
        'notes': 'Solanum quitoense — Andean fruit also called lulo. Tart citrus-like pulp used for juice, sorbet, and jam in Ecuador/Colombia. Spiny stems and leaves — wear gloves. Needs afternoon shade in low desert summer; full sun in cooler months. Prefers high humidity — monsoon season is ideal. Loves rich, well-drained soil with consistent moisture. Hates frost — protect below 40°F or grow in container to move indoors. Self-fertile. Lifespan 3-4 years. Fruits the size of a tomato, turn orange when ripe.',
    ...
    },
    {
        ...
        'desert_sow_outdoor': None,
        'desert_transplant': ['03-01', '04-15'],
        'desert_harvest': ['11-15', '12-31'],
        'notes': "Oxalis tuberosa (New Zealand yam) — an Andean tuber with lemony, oxalic foliage and colorful tubers. Challenging but possible in the low desert and best treated as experimental: plant tubers in spring, grow the foliage through summer with afternoon shade and steady water, then let it bulk tubers ONLY after the fall equinox (short-day trigger, <12 hr daylight). The catch is frost — tops are frost-tender and tubers need 1-3 frost-free months after Sept 21 to size up, so site it in a warm, frost-protected microclimate (south wall, under eaves) where Phoenix's mid-December first frost gives just enough window. Mulch heavily. Cure harvested tubers in sun a few days to sweeten (reduces oxalic tang). Hilling boosts yield.",
    ...
    },
    {
        ...
        'sow_indoor_weeks_before_transplant': None,
        'desert_sow_outdoor': None,
        'desert_transplant': ['03-15', '09-15'],
        'desert_harvest': ['04-15', '11-30'],
        'notes': "Gynura crepioides (syn. G. bicolor) — a fast-growing, heat-loving perennial leafy green for Zones 9-11 with green tops and striking purple undersides. One of the best hot-season cut-and-come-again greens for the low desert: give it afternoon shade and steady water to establish, after which it's fairly drought tolerant (it sulks in dry heat but rebounds with the monsoon). Grown from cuttings, which root readily in water or soil — no seed needed. Dies back in frost and returns with warmth. Eat young leaves raw in moderation or lightly cooked/stir-fried (slightly mucilaginous, nutty-pine flavor); a staple of the Okinawan longevity diet. Pinch tips to keep bushy.",
        'companions': ['Malabar Spinach', 'Okra', 'Sweet Potato'],
        'antagonists': [],
    },
    {
        ...
        'sow_indoor_weeks_before_transplant': None,
        'desert_sow_outdoor': None,
        'desert_transplant': ['10-15', '04-15'],
        'desert_harvest': ['01-01', '12-31'],
        'notes': 'Atriplex nummularia — an Australian perennial saltbush (a relative of the native quailbush) and one of the most drought-, heat-, and salt-tolerant edible shrubs available, reaching 8-10 ft. Outstanding on alkaline and saline desert soils where little else thrives; needs minimal water once established. The silvery, salty leaves are edible — eaten fresh, blanched, sautéed (like chips), or dried and ground as a seasoning salt; seeds can be ground to flour or roasted. Year-round harvest of evergreen foliage. Grown from cuttings or seed. Doubles as windbreak, erosion control, and forage. Keep it pruned to encourage tender new growth, which is the best eating.',
        'companions': ['Mesquite', 'Quailbush', 'Wolfberry'],
        'antagonists': [],
    },
    {
        'name': 'Peach',
        ...
        'desert_transplant': ['12-15', '02-28'],
        'desert_harvest': ['05-01', '07-15'],
        'notes': 'Prunus persica. Requires a LOW-CHILL variety in Phoenix (200-400 chill hours) — standard peaches will not fruit. Reliable low-chill varieties: Florida Prince (150 hrs), Desert Gold (250 hrs), Earligrande (275 hrs), Babcock (250-300 hrs), Mid-Pride (250 hrs), Tropic Snow (200 hrs). Plant bare-root Dec-Feb. Whitewash trunks to prevent sunburn. Thin fruit to 6 in apart for better size. Peach leaf curl is rare in dry desert. Self-fertile. Pick early before extreme heat bakes fruit on the tree.',
        'companions': ['Garlic', 'Chive', 'Nasturtium', 'Tansy', 'Marigold'],
        'antagonists': ['Tomato', 'Pepper', 'Potato'],
    },
    {
        'name': 'Pearl Millet',
        'category': 'grain',
        ...
        'desert_transplant': None,
        'desert_harvest': ['06-15', '11-15'],
        'notes': 'One of the most heat- and drought-tolerant cereals, ideally suited to low-desert summers; direct-sow after soil warms in spring or ride the monsoon for rainfall-supported growth. Thrives on poor, sandy soils where other grains fail and needs little irrigation. Frost-tender, so finish harvest before December frost; provide light bird protection as heads ripen.',
        'companions': ['Bean (Bush)', 'Black-eyed Pea', 'Squash (Summer)'],
        'antagonists': [],
    },
    {
        'name': 'Pineapple Sage',
        ...
        'desert_sow_outdoor': None,
        'desert_transplant': ['02-15', '04-15'],
        'desert_harvest': ['04-01', '12-15'],
        'notes': 'Salvia elegans — perennial Mexican salvia with pineapple-scented leaves and brilliant red tubular flowers in fall. Hummingbird magnet; among the best late-season nectar plants for Sonoran gardens. Leaves used in teas, fruit salads, cold drinks; edible flowers garnish desserts. Prefers afternoon shade in low desert and consistent moisture in summer, but more forgiving than common sage. Cut back hard after frost; usually returns from roots in Zone 9b. Reaches 3-4 ft tall and wide.',
        'companions': ['Tomato', 'Pepper', 'Bean', 'Strawberry'],
        'antagonists': [],
    },
    {
        'name': 'Pistachio',
        ...
        'desert_sow_outdoor': None,
        'desert_transplant': ['01-15', '03-15'],
        'desert_harvest': ['09-01', '10-15'],
        'notes': 'Pistacia vera. Excellent low-desert nut tree — thrives in hot, dry summers and cool winters (needs ~600-1000 chill hours). Dioecious: plant one male (Peters) per 8-10 females (Kerman, Golden Hills, Lost Hills). Deep-rooted and extremely drought-tolerant once established. Alternate bears. Avoid wet soils/overwatering — prone to verticillium and root rot. Grafted trees recommended; 5-7 years to first harvest.',
        'companions': ['Mesquite', 'Pomegranate', 'Fig'],
        'antagonists': [],
    },
    {
        'name': 'Pluot',
        ...
        'sow_indoor_weeks_before_transplant': None,
        'desert_sow_outdoor': None,
        'desert_transplant': ['12-01', '02-15'],
        'desert_harvest': ['05-15', '07-15'],
        'notes': 'Plum-apricot hybrid (Prunus salicina x P. armeniaca) bred by Floyd Zaiger. For Zone 9b/10a select low-chill varieties (200-400 chill hours): Flavor Supreme, Flavor Grenade, Splash, Dapple Dandy. Plant bare-root Dec-Feb; needs another low-chill plum (e.g. Santa Rosa, Burgundy) within 50 ft for cross-pollination. Prefers well-drained loam — amend native caliche heavily. Whitewash trunks to prevent sunscald. Drip irrigate deeply 2-4x/week May-Aug. Fruit thinning to 4-6 in apart improves size. Harvest fragrant fruit at slight softness near stem.',
        'companions': ['Garlic', 'Chive', 'Nasturtium', 'Marigold', 'Borage'],
        'antagonists': ['Walnut'],
    },
    {
        'name': 'Poblano Pepper',
        ...
        'desert_transplant': ['03-01', '04-15'],
        'desert_harvest': ['06-01', '10-31'],
        'notes': 'Capsicum annuum — mild heat (1,000-2,000 SHU) chile from Puebla, Mexico. Dried form is called ancho. The classic stuffing chile (chiles rellenos). Excellent desert performer once established — like all peppers, sets fruit better at moderate heat than during 110F+ peaks. Use 30-40% shade cloth from June through August. Harvest green for chiles rellenos, ripen to red/brown for ancho drying. Prolific in monsoon season as nights cool.',
        'companions': ['Tomato', 'Basil', 'Carrot', 'Onion', 'Spinach', 'Marigold'],
        'antagonists': ['Fennel', 'Brassicas'],
    },
    {
        ...
        'desert_transplant': ['02-15', '04-30'],
        'desert_harvest': ['11-01', '02-28'],
        'notes': 'Citrus maxima. Largest citrus fruit — Chandler is the top variety for Arizona (sweet, pink flesh). Vigorous grower that handles Phoenix heat well. Needs frost protection below 28F — plant against south-facing wall or use covers. Deep watering 1-2x/week in summer. Fruit takes 6-7 months to ripen. Less cold-hardy than grapefruit but more heat-tolerant. Organic fertilizer 3x/year. Excellent fresh eating — segments peel cleanly.',
        'companions': ['Marigold', 'Nasturtium', 'Lavender', 'Lemon'],
        'antagonists': [],
    },
    {
        'name': 'Quailbush',
        ...
        'desert_transplant': ['10-01', '03-31'],
        'desert_harvest': ['03-01', '11-30'],
        'notes': "Atriplex lentiformis — native Sonoran saltbush, evergreen shrub to 8ft. Extreme drought, heat, and salinity tolerance — grows in caliche, brackish soil, and reclaimed water. Young leaves and shoots edible (salty, like spinach); soak/blanch to reduce salt. Traditional Tohono O'odham food. Pollen producer (mild allergen). Excellent windbreak, wildlife habitat, and nurse plant for tender crops. Trim aggressively to keep shape. Skip fertilizer.",
        'companions': ['Mesquite', 'Palo Verde', 'Tepary Bean'],
        'antagonists': [],
    },
    {
        'name': 'Rat-tail Radish',
        'category': 'vegetable',
        'subcategory': 'fruit',
        'days_to_maturity_min': 45,
        'days_to_maturity_max': 60,
        ...
        'desert_sow_outdoor': ['03-01', '09-15'],
        'desert_transplant': None,
        'desert_harvest': ['04-15', '11-01'],
        'notes': "A heat-LOVING radish grown for its long crisp seed pods, not roots (Raphanus sativus var. caudatus, 'mougri'). This flips the usual radish calendar: sow it across the WARM season (Mar-Sep, including monsoon) when cool-season root radishes bolt and fail — it actively wants the heat. No edible root; harvest the pods young (up to ~10 in) and often, as they turn tough/fibrous fast. Succession-sow for a continuous summer 'radish' crop and to fill the hot-season leafy-green gap. Crisp, peppery pods eaten raw, stir-fried, or pickled; young leaves also edible.",
        'companions': ['Cucumber', 'Lettuce', 'Bean (Bush)', 'Winter Melon'],
        'antagonists': ['Hyssop'],
    },
    {
        'name': 'Salad Burnet',
        ...
        'desert_transplant': ['10-01', '03-15'],
        'desert_harvest': ['11-01', '05-31'],
        'notes': "Sanguisorba minor — Mediterranean evergreen perennial herb with cucumber-flavored leaves. Lovely lacy rosettes. Cool-season grower in Zone 9b; semi-dormant in peak summer but rarely dies if shaded. Drought-tolerant once established. Use young leaves in salads, vinegars, herb butters, and cold drinks (Pimm's classic). Cut regularly to keep tender. Bolts to small reddish flower heads — remove to prolong leaf production.",
        'companions': ['Thyme', 'Mint', 'Strawberry', 'Lettuce'],
        'antagonists': [],
    },
    {
        'name': 'Salsify',
        ...
        'desert_sow_outdoor': ['09-15', '02-15'],
        'desert_transplant': None,
        'desert_harvest': ['02-01', '05-31'],
        'notes': 'Tragopogon porrifolius — also called oyster plant for its subtle shellfish-like flavor when cooked. Long, thin taproots (Mammoth Sandwich Island is classic variety). Requires loose, deep, stone-free soil to produce straight roots — raised beds ideal in desert clay. Direct-sow only; taproots resent transplanting. Flavor improves after light frost. Biennial — second-year flower buds (scorzonera-style) also edible. Sow early fall for a long cool-season crop.',
        'companions': ['Carrot', 'Beet', 'Onion', 'Mustard Greens'],
        'antagonists': [],
    },
    {
        ...
        'desert_sow_outdoor': None,
        'desert_transplant': ['10-15', '03-15'],
        'desert_harvest': ['07-01', '09-15'],
        'notes': 'Prosopis pubescens (tornillo). Native SW US/N Mexico mesquite, smaller than velvet mesquite (to ~23 ft), with distinctive tightly-coiled screw-shaped pods. Pods are sweet and high in protein, calcium, iron, zinc and lysine — dried, washed and milled into a sweet flour like honey mesquite. Nitrogen-fixing, extremely drought-resilient once established, riparian-tolerant. Thorny. A heritage desert food and pollinator/habitat tree.',
        'companions': ['Tepary Bean', 'Desert Milkweed', 'Baja Fairy Duster'],
        'antagonists': [],
    },
    {
        ...
        'desert_transplant': ['03-01', '04-15'],
        'desert_harvest': ['05-15', '10-31'],
        'notes': 'Capsicum annuum — Japanese frying pepper, mostly mild (100-1,000 SHU) but ~1 in 10 surprises with mild heat. Compact plant (24-30 in) suits container culture. Extremely prolific — picks 3-5 inch fruits every 2-3 days through the season. Pan-blistered with sea salt is the classic preparation. One of the most heat-tolerant sweet peppers. Pairs well with tomato and basil. Pick young/green for best flavor; pods turn red if left on plant.',
        'companions': ['Tomato', 'Basil', 'Carrot', 'Onion', 'Marigold', 'Nasturtium'],
        'antagonists': ['Fennel', 'Brassicas'],
    },
    {
        'name': 'Sorrel',
        ...
        'desert_transplant': ['10-01', '03-15'],
        'desert_harvest': ['10-15', '05-31'],
        'notes': 'Rumex acetosa (garden sorrel). Tangy, lemony perennial green — one of the first greens to emerge in spring. Thrives in Phoenix cool season. Grows through winter with minimal care. Afternoon shade extends season into warm months. Cut-and-come-again harvest. Leaves used in soups (French sorrel soup), salads, sauces, and as a lemon substitute. Goes semi-dormant in summer heat but returns in fall. Hardy perennial — lasts years. High in vitamin C and oxalic acid.',
        'companions': ['Strawberry', 'Lettuce', 'Spinach', 'Carrot'],
        'antagonists': [],
    },
    {
        'name': 'Sotol',
        ...
        'desert_transplant': ['03-01', '05-31'],
        'desert_harvest': ['01-01', '12-31'],
        'notes': 'Dasylirion wheeleri (desert spoon). Native Sonoran/Chihuahuan-desert rosette succulent, extremely drought- and cold-hardy (to ~0F). The trimmed heart (cabeza) and flower-stalk core are roasted and eaten or distilled into the spirit sotol; leaf bases are sweet when pit-roasted. Primarily a slow-growing, very-low-water landscape/heritage food plant — a harvested heart kills the rosette, so it is a multi-year/once-only harvest. Sharp serrated leaf margins; site away from paths.',
        'companions': ['Agave', 'Prickly Pear', 'Red Yucca'],
        'antagonists': [],
    },
    {
        'name': 'Sugarcane',
        ...
        'desert_transplant': ['03-01', '05-15'],
        'desert_harvest': ['11-01', '02-28'],
        'notes': 'Saccharum officinarum — perennial grass that thrives in Phoenix-area heat with adequate water. Plant 12-18 inch cane segments horizontally 2-4 inches deep with at least one node. Can grow 8-12 ft tall in a single season. Frost kills tops but rhizomes regrow in spring once mulched. Heavy feeder of nitrogen and potassium. Harvest stalks before flowering when sugar content peaks. Also functions as a windbreak and privacy screen. Look for Louisiana purple, Black Cuban, or Yellow Caledonia cultivars.',
        'companions': ['Banana', 'Sweet Potato', 'Pigeon Pea'],
        'antagonists': [],
    },
    {
        'name': 'Tamarillo',
        ...
        'desert_transplant': ['02-15', '04-15'],
        'desert_harvest': ['11-01', '04-30'],
        'notes': 'Solanum betaceum — tree tomato, a short-lived (5-8 yr) subtropical small tree from the Andes. Fruits in 18-24 months from seed, sooner from cuttings. Hardy to 28F so survives most low-desert winters but drops leaves below 35F. MUST have afternoon shade or 30% shade cloth June-Sep — leaves scorch above 105F in direct sun. Brittle wood, stake firmly. Egg-shaped fruit with tart-sweet tomato/passionfruit flavor used fresh, in chutneys, smoothies. Self-fertile.',
        'companions': ['Basil', 'Marigold', 'Nasturtium', 'Borage'],
        'antagonists': ['Fennel', 'Brassicas'],
    },
    {
        'name': 'Taro',
        ...
        'desert_transplant': ['03-15', '05-31'],
        'desert_harvest': ['11-01', '02-28'],
        'notes': 'Colocasia esculenta. Starchy corm staple crop — MUST be cooked before eating (contains calcium oxalate crystals). Young leaves (luau leaf) also edible when thoroughly cooked. Plant corms 3-4 inches deep in rich, moist soil. Needs afternoon shade in Phoenix and consistent moisture — never let soil dry out. Grow in containers with saucers or boggy beds. Goes dormant in winter — mulch heavily. Harvest when leaves yellow and die back. Hardy to zone 9.',
        'companions': ['Banana', 'Ginger', 'Lemongrass', 'Sweet Potato'],
        'antagonists': [],
    },
    {
        'name': 'Tarragon',
        ...
        'desert_transplant': ['10-01', '03-31'],
        'desert_harvest': ['04-01', '11-30'],
        'notes': 'Artemisia dracunculus. French tarragon is propagated from cuttings/divisions — seed-grown Russian tarragon is flavorless, avoid it. Classic French herb for béarnaise, chicken, fish, vinegars. Perennial but struggles in peak desert summer — afternoon shade and mulch essential. Goes semi-dormant in deep heat and regrows in fall. Divide every 3-4 years to refresh flavor. Anise-licorice flavor.',
        'companions': ['Eggplant', 'Tomato', 'Most vegetables'],
        'antagonists': [],
    },
    {
        ...
        'desert_transplant': ['02-15', '04-15'],
        'desert_harvest': ['03-01', '11-30'],
        'notes': 'Camellia sinensis — true tea plant. Prefers acidic, well-draining soil (pH 4.5-6.5) which is opposite of alkaline AZ soil — amend heavily with peat/pine bark/sulfur, or grow in containers with acidic potting mix. Hardy to ~15F. Needs afternoon shade and protection from drying winds in low desert. 3-5 years before useful harvests. Pluck top two leaves and bud for tea. Container culture is most reliable in AZ.',
        'companions': ['Blueberry', 'Camellia', 'Azalea'],
        'antagonists': [],
    },
    {
        'name': 'Teff',
        ...
        'desert_seasons': ['warm', 'monsoon'],
        'sow_indoor_weeks_before_transplant': None,
        'desert_sow_outdoor': ['06-15', '08-15'],
        'desert_transplant': None,
        'desert_harvest': ['09-15', '11-30'],
        'notes': "Eragrostis tef — Ethiopian grain used for injera bread. Tiniest cereal grain in the world. Extremely drought-tolerant — needs only 14 inches of water for a crop. Gluten-free. Sow when soil is warm (65°F+); broadcast seed on prepared bed and rake in lightly. Don't bury — seeds are dust-sized. Loves Phoenix monsoon timing. Tolerates poor soil. Mature seedhead 24-48 inches. Harvest when seedheads turn from green to gold. Thresh by rubbing between palms over a bucket. Also makes excellent forage hay.",
        'companions': ['Sorghum', 'Amaranth', 'Cowpea'],
        'antagonists': [],
    },
    {
        'name': 'Texas Sage',
        ...
        'desert_transplant': ['10-01', '03-31'],
        'desert_harvest': None,
        'notes': 'Leucophyllum frutescens — also called cenizo, purple sage, or barometer bush. Chihuahuan Desert native, hardy to about 10F. Bursts into purple bloom following summer humidity spikes — a reliable monsoon indicator. Silvery foliage. Once established needs essentially no irrigation in low desert. Avoid shearing into formal balls; light tip-prune in early spring only. Excellent pollinator and hummingbird draw. Tolerates alkaline, rocky, and caliche soils.',
        'companions': ['Globe Mallow', 'Blackfoot Daisy', 'Desert Marigold', 'Penstemon'],
        'antagonists': [],
    },
    {
        'name': 'Thai Basil',
        ...
        'desert_transplant': ['03-15', '05-01'],
        'desert_harvest': ['04-15', '11-30'],
        'notes': 'Ocimum basilicum var. thyrsiflora. Purple stems, anise-clove flavor essential in Thai, Vietnamese, and Lao cuisine. Significantly more heat-tolerant than sweet basil — thrives in Phoenix summer when sweet basil bolts. Handles 110F+ with afternoon shade cloth. Direct sow after last frost or transplant. Pinch flowers for continuous leaf harvest. Self-seeds readily in desert. Pairs perfectly with peppers, curries, pho.',
        'companions': ['Pepper', 'Tomato', 'Eggplant', 'Cilantro', 'Lemongrass'],
        'antagonists': ['Sage', 'Rue'],
    },
    {
        'name': 'Tree Collard',
        ...
        'sow_indoor_weeks_before_transplant': 0,
        'desert_sow_outdoor': None,
        'desert_transplant': ['10-01', '11-30'],
        'desert_harvest': ['11-01', '05-31'],
        'notes': "Perennial 'tree kale' (Brassica oleracea) propagated from CUTTINGS, not seed — can live 5-20 years and reach 6-10 ft, so stake/prune it. More particular than its reputation in the low desert: tolerates heat better than most brassicas but Phoenix 110-118F is at/beyond its limit, so it NEEDS an east-side or filtered-shade microclimate, heavy mulch, and aggressive drip (Phoenix growers report twice-daily summer watering). Plant cuttings out in fall when it can acclimate before extreme heat. Hardy to ~20F (green types). Leaves used like collards/kale — sweeter after cool weather; purple types are anthocyanin-rich.",
        'companions': ['Onion', 'Garlic Chives', 'Beet', 'Nasturtium', 'Dill'],
    ...
    },
    {
        ...
        'desert_transplant': ['03-01', '04-15'],
        'desert_harvest': ['05-15', '10-31'],
        'notes': 'Cucurbita moschata — Italian heirloom climbing squash also called Zucchetta Rampicante. Far more squash-vine-borer and powdery-mildew resistant than common zucchini because of its solid moschata stems. Eat young (green, 8-12 in) as zucchini, or let mature on the vine for tan butternut-like winter squash. Vines reach 15-20 ft — must be trellised, both for fruit shape and to save space. One of the best summer squash for hot, humid monsoon conditions.',
        'companions': ['Corn', 'Bean', 'Nasturtium', 'Marigold', 'Borage', 'Radish'],
        'antagonists': ['Potato'],
    },
    {
        ...
        'desert_transplant': ['03-01', '05-15'],
        'desert_harvest': ['04-01', '11-30'],
        'notes': 'Persicaria odorata (syn. Polygonum odoratum; family Polygonaceae). Also called Rau Ram or laksa leaf. Spicy, peppery, citrusy cilantro-like flavor that does NOT bolt in heat — the perfect cilantro substitute for Phoenix summers; add at the end of cooking. Perennial in zone 9b+. NOT drought-tolerant: needs consistently moist, organic-rich soil and afternoon shade, thriving on monsoon humidity. Propagates easily from 4-6 inch stem cuttings rooted in water (viable seed is rare). Grow in containers with saucers to maintain moisture. Frost-tender — protect or bring indoors below ~45F and expect die-back from hard freeze.',
        'companions': ['Mint', 'Lemongrass', 'Thai Basil', 'Cilantro', 'Ginger'],
        'antagonists': ['Rosemary', 'Lavender', 'Thyme'],
    },
    {
        'name': 'Winged Bean',
        'category': 'vegetable',
        ...
        'desert_transplant': ['04-01', '05-31'],
        'desert_harvest': ['06-15', '11-15'],
        'notes': 'Psophocarpus tetragonolobus — tropical legume from Southeast Asia where the entire plant is edible (pods, leaves, flowers, seeds, tubers). Thrives in heat and humidity that kills regular green beans, making it ideal for Phoenix monsoon season. Day-length sensitive — flowering triggered by shorter days, so harvest pods in fall. Needs sturdy 6-8 ft trellis. Soak seeds 24 hours before sowing. Soil should be warm (75°F+). Nitrogen-fixing — improves soil. Pods best harvested young (3-4 inches) before fibrous. Frost kills immediately.',
        'companions': ['Corn', 'Sunflower', 'Cucumber', 'Okra'],
        'antagonists': ['Onion', 'Garlic'],
    },
    {
        'name': 'Winter Melon',
        ...
        'desert_transplant': None,
        'desert_harvest': ['07-01', '11-15'],
        'notes': 'Wax gourd / ash gourd (Benincasa hispida) — a heat-loving long-season cucurbit that uses the full Phoenix warm season. Sow Mar-Apr for a summer/fall crop, or do a second sowing in Jul-Aug for a monsoon-into-fall crop that matures before frost. Fruits are very large/heavy (10-40 lb): let it sprawl over mulch, or sling-support each fruit if trellised. Watch powdery mildew and squash pests; light afternoon shade reduces peak wilt. The waxy mature fruit stores for months. Used in winter-melon soup, stir-fries, curries, candied tung-kwa, and Indian petha.',
        'companions': ['Corn', 'Bean (Bush)', 'Nasturtium', 'Radish'],
        'antagonists': ['Potato'],
    },
    {
        ...
        'desert_transplant': ['03-01', '04-15'],
        'desert_harvest': ['05-15', '10-31'],
        'notes': 'Solanum retroflexum (sometimes called sunberry or garden huckleberry) — heat-tolerant solanaceous berry. NEVER eat unripe (green) fruit — solanine toxic. Wait until fully purple-black and soft. Cook with sugar for pies, jams; flavor improves dramatically with cooking. Self-fertile, prolific. Volunteers freely. Tolerates poor soil. Companion plant well with tomatoes/peppers (shares pests like hornworms — monitor). Grows 2-3 ft, bushy. Frost-tender annual in Phoenix.',
        'companions': ['Tomato', 'Basil', 'Marigold'],
        'antagonists': [],
    },
    {
        'name': 'Yacon',
        ...
        'sow_indoor_weeks_before_transplant': 0,
        'desert_sow_outdoor': None,
        'desert_transplant': ['02-15', '04-01'],
        'desert_harvest': ['11-01', '12-15'],
        'notes': "Smallanthus sonchifolius — Andean tuber that tastes like sweet, crisp apple/jicama, eaten raw or juiced. Sugars are mostly inulin (prebiotic, low glycemic). Grown from rhizome offsets, not the storage tubers. Afternoon shade extends harvest in low desert. Harvest after tops die back from first cool weather. Store rhizomes over winter for next year's crop. Tall (6ft) daisy-family plant.",
        'companions': ['Corn', 'Bean (Bush)', 'Squash (Summer)'],
        'antagonists': [],
    },
    {
        ...
        "desert_seasons": ["cool"],
        "sow_indoor_weeks_before_transplant": 4,
        "desert_sow_outdoor": ["09-15", "12-15"],
        "desert_transplant": ["10-01", "01-15"],
        "desert_harvest": ["11-01", "02-28"],
        "notes": "Brassica oleracea var. alboglabra (Chinese broccoli). Cool-season only in the low desert — sow mid-Sept through Dec; spring sowings bolt in the heat. Eat the thick tender stems, leaves and flower buds stir-fried or steamed with oyster sauce. Delay early-fall sowing until whiteflies decline with cooler weather (UA AZ1005). Amend alkaline desert soil with compost; light afternoon shade helps in warm shoulder weeks. Harvest the main shoot just as buds form to trigger side shoots.",
        "companions": ["Cilantro", "Dill", "Onion", "Garlic", "Nasturtium"],
        "antagonists": ["Tomato", "Pepper", "Strawberry"],
    },
    {
        "name": "Celtuce",
        ...
        "sow_indoor_weeks_before_transplant": 0,
        "desert_sow_outdoor": ["09-15", "01-31"],
        "desert_transplant": ["10-01", "02-01"],
        "desert_harvest": ["11-15", "03-31"],
        "notes": "Lactuca sativa var. augustana (stem/asparagus lettuce). Grown for its thick peeled central stem — mild, sweet, nutty and crunchy raw or stir-fried; young leaves are edible but more bitter. Treat exactly like leaf lettuce in Phoenix: strictly a fall/winter crop, no spring/summer (heat bolts it and turns stems woody and bitter). Keep soil consistently moist, use shade cloth on warm shoulder days, and harvest the stem before the flower stalk elongates.",
        "companions": ["Carrot", "Radish", "Beet", "Cilantro"],
        "antagonists": ["Fennel"],
    },
    {
        ...
        "desert_sow_outdoor": ["03-15", "05-15"],
        "desert_transplant": ["04-01", "06-01"],
        "desert_harvest": ["05-15", "11-30"],
        "notes": "Abelmoschus manihot (aibika, sunset muskmallow) — a heat- and humidity-loving perennial mallow grown as a cut-and-come-again leaf vegetable. One of the best warm-season greens for the monsoon window when most greens fail. NOT a low-water plant despite the name: needs full sun and high, consistent moisture (drip + heavy mulch). Frost-tender — grow as a summer annual or protect below the mid-20s F. Young leaves, shoots and flower buds cook like a mucilaginous (okra-like) spinach. Watch for root-knot nematodes in sandy soil.",
        "companions": ["Okra", "Roselle", "Basil", "Sweet Potato"],
        "antagonists": [],
    },
    {
        "name": "Ethiopian Kale",
        ...
        "desert_seasons": ["cool"],
        "sow_indoor_weeks_before_transplant": 0,
        "desert_sow_outdoor": ["09-01", "02-15"],
        "desert_transplant": ["09-15", "02-15"],
        "desert_harvest": ["10-01", "04-15"],
        "notes": "Brassica carinata (Abyssinian mustard, Texsel greens, amara). The most heat- and drought-tolerant of the leafy brassicas — bolts more slowly than mustard or pak choi, extending the desert season into late spring. Mild mustard flavor with nutty/almond notes; eat baby leaf at ~21 days or mature greens, shoots and flower buds (like broccoli raab). Still a fall-through-spring crop (Sept–Feb sowing) but its tolerance buys flexibility on the warm edges. Fast cut-and-come-again; amend alkaline soil and watch for flea beetles in early fall.",
        "companions": ["Cilantro", "Dill", "Onion", "Nasturtium", "Beet"],
        "antagonists": ["Tomato", "Pepper", "Strawberry"],
    },
    {
        "name": "Za'atar",
        ...
        "cold_tolerance": "low",
        "desert_seasons": ["cool", "warm"],
        "sow_indoor_weeks_before_transplant": 7,
        "desert_sow_outdoor": None,
        "desert_transplant": ["02-15", "04-15"],
        "desert_harvest": ["04-01", "11-30"],
        "notes": "Origanum syriacum (Syrian oregano, bible hyssop) — the dried base of the za'atar spice blend, with an intense oregano-thyme-marjoram flavor. An excellent desert match: drought- and heat-loving and it actually prefers alkaline soil. The real risk is winter root rot from wet, poorly drained soil, so plant in gritty fast-draining mix or raised beds and water sparingly. Tender perennial — protect from the rare hard freeze. A fall transplant (Sep–Oct) also works to establish roots before summer. Harvest leaves and flowering tops at/just before bloom for peak flavor.",
        "companions": ["Rosemary", "Lavender", "Sage", "Thyme"],
        "antagonists": [],
    },
    {
        ...
        "sow_indoor_weeks_before_transplant": 0,
        "desert_sow_outdoor": None,
        "desert_transplant": ["03-01", "06-30"],
        "desert_harvest": ["09-01", "12-31"],
        "notes": "Ferocactus wislizeni (Arizona/candy barrel cactus) — a true Sonoran native, perfectly adapted to Phoenix: full sun, sharp drainage, minimal supplemental water once established. Summer flowers give way to tart, lemony yellow fruit that persists into winter (used for candy/jelly); flower buds cook as a vegetable and the seeds are a traditional O'odham/Seri food. Very slow and long-lived. IMPORTANT: a Protected Native Plant in Arizona (salvage-restricted) — buy nursery-propagated stock, do not wild-collect. Hardy to the mid-teens F. Overwatering/poor drainage causes rot.",
        "companions": ["Prickly Pear", "Agave", "Mesquite", "Palo Verde"],
        "antagonists": [],
    },
    {
        ...
        "desert_transplant": ["03-01", "05-31"],
        "desert_harvest": ["05-15", "07-15"],
        "notes": "Echinocereus engelmannii (Engelmann's/strawberry hedgehog cactus) — Sonoran/Mojave native that forms clumping mounds of stems and bears the best-eating of the desert cacti fruits: small red fruit that is genuinely sweet and strawberry-like (spines rub off when ripe). Magenta spring flowers precede early-summer fruit. Needs full sun and excellent drainage (rocky/gritty soil or a mound); overwatering is the main killer. Fruit ripens fast and wildlife takes it quickly, so harvest promptly. Buy nursery stock; avoid wild collection.",
    ...
    # ── NEW PLANTS (research run 2026-06-02 r11) ──
    {
        "name": "Ghost Pepper",
        "category": "vegetable",
        "subcategory": "hot pepper",
        ...
        "sow_indoor_weeks_before_transplant": 10,
        "desert_sow_outdoor": None,
        "desert_transplant": ["02-25", "03-31"],
        "desert_harvest": ["06-01", "11-15"],
        "notes": "Ghost Pepper (Capsicum chinense, Bhut Jolokia) is a ~1,000,000 SHU superhot that needs a long, warm season but struggles with low-desert extremes. Transplant in late February-March so plants establish before peak heat; a second July transplant can crop into fall. Provide at least 50% afternoon shade once temps exceed ~90F, since flower and fruit set drop sharply above 90-95F and pollen aborts, so most pods set in late spring and again after monsoon nights cool. Keep soil consistently moist and mulch heavily to buffer root-zone heat.",
        "companions": ["Basil", "Onion", "Carrot", "Marigold", "Oregano", "Spinach"],
        "antagonists": ["Fennel", "Bean (Bush)", "Broccoli"],
    },
    {
        "name": "Aji Amarillo",
        "category": "vegetable",
        ...
        "cold_tolerance": "low",
        "desert_seasons": ["warm", "monsoon"],
        "sow_indoor_weeks_before_transplant": 9,
        "desert_sow_outdoor": None,
        "desert_transplant": ["02-15", "03-31"],
        "desert_harvest": ["06-15", "12-15"],
        "notes": "Aji Amarillo (Capsicum baccatum) is a long-season Peruvian chile needing 90-120+ days to ripen, so the Phoenix low desert's long warm season is a genuine asset: transplant late Feb-Mar after frost and harvest from early summer into fall. Flowers will not set fruit when night temps stay above ~86F, so plants often pause through the worst of June-Aug heat and set heavily again as nights cool; give 50% afternoon shade cloth over 90F to prevent fruit scorch. In 9b/10a it commonly overwinters as a short-lived perennial if protected from rare frost. Plants get tall (5 ft+) and top-heavy, so stake early.",
        "companions": ["Basil", "Onion", "Carrot", "Marigold", "Oregano", "Nasturtium"],
        "antagonists": ["Fennel", "Kohlrabi", "Bean (Bush)"],
    },
    {
        "name": "Cassabanana",
        "category": "fruit",
        "subcategory": "vining fruit",
        "days_to_maturity_min": 100,
        "days_to_maturity_max": 180,
        "spacing_inches": 36,
        "sun": "full",
        ...
        "desert_transplant": ["03-15", "04-30"],
        "desert_harvest": ["08-15", "11-30"],
        "notes": "Sicana odorifera is a heat-craving tropical cucurbit vine well suited to Phoenix's long, hot warm/monsoon season; it needs sustained high heat to ripen its large fragrant fruit and is killed by frost. Sow or transplant after soil hits 70F (mid-March to April) so the vine has the full summer-through-fall window to set and ripen fruit before first light frost. Extremely vigorous (to 50 ft) and requires very strong support; give deep-watered, compost-rich beds and consistent moisture since it is not drought tolerant. Fruit may take many additional weeks to fully ripen and color up after reaching full size.",
        "companions": ["Corn", "Sunflower", "Nasturtium", "Bean (Bush)"],
        "antagonists": ["Potato"],
    },
    {
        "name": "Safflower",
        ...
        "desert_transplant": None,
        "desert_harvest": ["05-01", "07-15"],
        "notes": "Safflower (Carthamus tinctorius, Asteraceae) is a deep-taprooted thistle-like annual oilseed/dye crop with a long Arizona commercial history; AZ and CA are the main US producers. In the low desert it is best fall/winter sown (Oct-Feb) so the cold-hardy rosette establishes through mild winter (tolerates frost to ~20F in rosette) and matures before extreme summer heat; it is direct-sown and resents transplanting due to its taproot. Drought tolerant once established via a taproot reaching 6-10 ft, but needs consistent moisture until flowering and well-drained soil to avoid root rot. Most varieties grow stiff leaf spines near flowering, so wear gloves; spineless types exist.",
        "companions": ["Sunflower", "Flax", "Corn"],
        "antagonists": [],
    },
    {
        "name": "Nigella",
        ...
        "desert_seasons": ["cool"],
        "sow_indoor_weeks_before_transplant": None,
        "desert_sow_outdoor": ["10-01", "12-15"],
        "desert_transplant": None,
        "desert_harvest": ["04-15", "06-01"],
        "notes": "Edible-seed black cumin (Nigella sativa), NOT the ornamental N. damascena 'Love-in-a-Mist'. In low-desert Phoenix grow as a cool-season annual: direct-sow fall through early winter (it resents transplanting and benefits from cool soil to germinate), let it flower in late winter/spring, then harvest the pungent black kalonji seeds once the inflated capsules dry and brown in late spring before extreme heat arrives. Drought-tolerant once established and needs sharp drainage; avoid wet feet.",
        "companions": ["Calendula", "Borage", "Cilantro", "Dill"],
        "antagonists": [],
    },
    {
        "name": "Finger Millet",
        ...
        "desert_seasons": ["warm", "monsoon"],
        "sow_indoor_weeks_before_transplant": None,
        "desert_sow_outdoor": ["05-15", "07-15"],
        "desert_transplant": None,
        "desert_harvest": ["09-15", "11-30"],
        "notes": "Finger millet (Eleusine coracana) is a C4 warm-season cereal grain that thrives in low-desert Arizona heat once soil is reliably warm (above 65F). Direct-sow into a finely tilled bed from mid-May through the start of monsoon; it tolerates early-season dry spells then grows rapidly with monsoon moisture and is harvested in fall before first frost. The crop is frost-tender and must complete its 90-130 day cycle during the warm season. The distinctive finger-like seed heads are cut when grains turn brown and hard.",
        "companions": ["Cowpea", "Pigeon Pea", "Peanut"],
        "antagonists": [],
    },
    {
        "name": "Mango",
        ...
        "desert_transplant": ["03-15", "05-15"],
        "desert_harvest": ["07-01", "09-30"],
        "notes": "Mangifera indica is grown by Phoenix hobbyists only in protected warm microclimates. Mature trees take leaf/branch injury near 25-29F and young trees can be killed at 29-30F, so plant against a south/west-facing warm wall and build a frame-and-plastic frost cover for nights below the upper 30s. Young trees scorch in low-desert sun and need 30-50% shade cloth once temps exceed 85F for the first two years, plus white-latex paint on exposed bark. Best marginal-climate cultivars are 'Manila'/'Ataulfo' (most cold-adapted and locally available), 'Keitt' (late, thrives in desert heat), and 'Valencia Pride'.",
...
def init_db():
    ...
    VARIETIES = [
        ...
        ("Black-eyed Pea", "California Blackeye #5", "Classic Southern pea, very heat and drought tolerant.", 60, 75, "excellent", None, "Earthy, nutty", "Medium dry pea", "Cream with black eye", "Bush", 5, "Reliable producer in extreme heat; can be shelled fresh or dried.", "Open-pollinated"),
        ...
        # ── ADDED 2026-06-01: extension-grounded desert varieties ──
        ("Okra", "Star of David", "Israeli-bred heirloom with fat ribbed pods that show a star when sliced, accustomed to extreme heat.", 60, 75, "excellent", None, "rich, nutty, robust", "6-7 ft plant, fat ribbed pods", "green", "very tall vigorous", 5, "Bred in Israel for hot, dry conditions, making it one of the best okras for low-desert heat and aridity.", "shop.seedsavers.org; parkseed.com"),
        ("Sweet Potato", "Centennial", "Carrot-colored leading U.S. heirloom with deep orange moist flesh and good storage.", 90, 110, "high", "root-knot nematode & wireworm resistant", "sweet, moist, classic", "medium-large tapered roots", "copper-orange skin, deep orange flesh", "sprawling vine", 4, "Heat- and drought-adapted and earlier than Beauregard, a solid second choice for desert beds.", "aggie-horticulture.tamu.edu EHT-026; gardenerspath.com"),
        ("Sweet Potato", "Garnet", "Early-to-mid season variety with deep red skin and sweet moist orange flesh.", 110, 120, "high", None, "very sweet, moist", "medium-large roots", "garnet-red skin, orange flesh", "sprawling vine", 4, "Explicitly recommended for long, hot summers; needs the full desert season to size up roots.", "gardenerspath.com; evergreenseeds.com"),
        ("Fig", "Conadria", "Greenish-yellow fig with purple tinge and strawberry flesh, outstanding for drying.", 0, 0, "excellent", "resists souring/splitting", "sweet, mild, good dried", "medium fruit, vigorous tree", "greenish-yellow skin, strawberry flesh", "large vigorous tree", 5, "Bred for hot inland climates; highly heat- and split-resistant, one of the best dried-fig figs for the low desert.", "extension.arizona.edu AZ1636; figboss.com"),
        ("Fig", "Brown Turkey", "Medium purple-brown fig with pink interior, best eaten fresh.", 0, 0, "high", None, "mild, sweet, fresh", "medium fruit, moderate tree", "purple-brown skin, pink flesh", "medium spreading tree", 4, "UA Extension recommends it for fresh eating in the low desert; preserves less well than Black Mission but very heat-tolerant.", "extension.arizona.edu AZ1636; apnursery.com"),
        ("Pomegranate", "Eversweet", "Very sweet, nearly seedless variety with light arils, sweet even when underripe.", 0, 0, "high", None, "very sweet, low acid", "medium fruit", "pink-red rind, clear/pink arils", "medium shrub", 4, "Sweet and reliable in the desert; lighter color than Wonderful and slightly less heat-extreme tolerant but ripens dependably.", "extension.usu.edu; gardenerspath.com"),
        ("Melon", "Ha'Ogen", "Israeli heirloom melon with green-to-salmon flesh and complex spiced-sweet flavor.", 80, 90, "high", None, "complex, sweet, lightly spiced", "3-5 lb fruit", "yellow-orange rind, green flesh", "vining", 4, "Israeli desert heirloom bred for hot dry climates; reliable in low-desert spring/early-summer plantings.", "trueleafmarket.com; gardenerspath.com"),
        ("Cantaloupe", "Hearts of Gold", "Heirloom cantaloupe on vigorous vines with thick, sweet deep-orange flesh.", 80, 90, "high", None, "sweet, juicy, classic", "3 lb fruit", "netted rind, deep orange flesh", "vigorous vining", 4, "Open-pollinated heat-tolerant heirloom that yields well in desert heat with steady irrigation.", "trueleafmarket.com; gardenerspath.com"),
        ("Garlic", "Lorz Italian", "Heat-loving Italian softneck heirloom with strong, robust flavor and good storage.", 0, 0, "excellent", None, "strong, robust, spicy", "large bulbs", "white wrapper", "softneck", 5, "Noted to grow extremely well in heat and adapt to warm regions, a strong-flavored choice for the desert.", "harvesttotable.com; gardeningknowhow.com"),
        ("Black-eyed Pea", "California Blackeye #46", "UCR-bred 1987 release similar to #5 but with smaller seeds and more erect plants.", 70, 85, "excellent", "improved disease tolerance", "rich, sweet, meaty", "erect bush, smaller seeds", "green pods to tan, cream seed/black eye", "erect bush", 5, "Bred by UC Riverside for the heat and challenging soils of the Southwest; very dependable in low-desert summers.", "ufseeds.com; davidsgardenseeds.com"),
        ("Black-eyed Pea", "Pinkeye Purple Hull", "Widely grown heirloom cowpea with purple hulls and pink-eyed seeds, prized for heat reliability.", 65, 75, "excellent", None, "sweet, tender, Southern classic", "~2 ft bush, purple pods", "purple hull, cream seed/pink eye", "compact bush", 5, "The most widely grown heirloom cowpea, cherished for reliable yields in high heat, dry conditions, and poor soil.", "stclareseeds.com; harvesttotable.com"),
        ("Basil", "Italian Large Leaf", "Sweet Italian basil with very large glossy leaves on a tall productive plant.", 60, 80, "moderate", None, "sweet, mild, classic", "24-36 in plant, 3-4 in leaves", "medium-dark green", "tall upright", 4, "Vigorous and sweet like Genovese; tolerates desert heat with regular water and some afternoon shade to delay bolting.", "savvygardening.com; bloomingexpert.com"),
        ("Eggplant", "Listada de Gandia", "Spanish heirloom with violet fruit irregularly streaked white; sets well under high heat.", 80, 90, "excellent", None, "mild, sweet, creamy, non-bitter", "5 in fruit, 2-3 ft plant", "violet with white stripes", "compact bushy", 5, "Mature plants set fruit well under high heat and tolerate drought, making it one of the best desert eggplants despite slow early vigor.", "territorialseed.com; gardenzeus.com"),
        ("Eggplant", "Thai Long Green", "Heat- and moisture-tolerant Asian eggplant with long slender tender green fruit.", 80, 85, "excellent", None, "tender, sweet, non-bitter, nearly seedless", "10 in fruit, 2-3 ft plant", "light/lime green", "compact bushy", 5, "Explicitly heat- and moisture-tolerant; long slim fruit set reliably through desert summer heat.", "harvesttotable.com; bountifulgardener.com"),

        # ── 2026-06-01 PLANT RESEARCH varieties (new desert edibles) ──
        ("Devil's Claw", "White-seeded (var. hohokamiana)", "Tohono O'odham domesticated devil's claw with white seeds and long flexible claws.", 60, 110, "excellent", None, "young pods okra-like; seeds oily, nutty", "Pods to 15 in", "Green pods, white seeds", "Sprawling annual to 6 ft wide", 5, "O'odham-domesticated form: white seeds germinate faster than the wild type, and the dried claws are longer and more flexible for basketry. Best monsoon-sown.", "nativeseeds.org"),
        ("Devil's Claw", "Wild Black-seeded", "Native wild devil's claw with black seeds and shorter, stiffer claws.", 70, 120, "excellent", None, "young pods okra-like", "Pods 4-7 in", "Green pods, black seeds", "Sprawling annual", 4, "The wild Sonoran form. Slower, more erratic germination than the domesticate but extremely heat- and drought-hardy. Young pods boiled like okra.", "fs.usda.gov"),
        ("Huauzontle", "Red Aztec", "Striking red-stemmed Aztec spinach/huauzontle, ornamental and edible.", 50, 90, "high", None, "mild, spinach-like leaves; broccoli-like buds", "3-5 ft", "Red stems, green leaves", "Upright bushy annual", 4, "Heat- and drought-tolerant goosefoot. Eat young leaves like spinach and flower-bud clusters like tiny broccoli. Self-seeds. Red form is ornamental.", "underwoodgardens.com"),
        ("Orach", "Red", "Burgundy-leaved orach, heat-tolerant spinach substitute, salt/alkaline tolerant.", 40, 60, "moderate", None, "mild, earthy, spinach-like", "4-6 ft if bolted", "Deep red/burgundy", "Upright annual", 3, "Tolerates saline and very alkaline desert soils. Handles warmth better than spinach but bolts in true summer heat — best in cool/warm shoulder seasons. Striking color.", "highdesertseed.com"),
        ("Orach", "Green", "Classic green mountain spinach, mild flavor, salt tolerant.", 40, 60, "moderate", None, "mild, tender, spinach-like", "4-6 ft if bolted", "Green", "Upright annual", 3, "The standard orach. Salt- and alkaline-tolerant warm-season spinach alternative; retains flavor even after bolting. Sow late winter and fall.", "pfaf.org"),
        ("Texas Persimmon", "Native seedling", "Standard native Diospyros texana; requires male and female trees for fruit.", 1095, 1825, "excellent", None, "sweet, prune-like when fully black-ripe", "Round, ~1 in", "Black when ripe", "Multi-trunk small tree 10-15 ft", 4, "Drought-tolerant native; thrives in alkaline well-drained desert soil. Dioecious — plant a male nearby to fruit a female. Sweet black fruit ripens mid-late summer.", "wildflower.org"),
        ("Pindo Palm", "Standard (Butia capitata)", "Cold-hardy jelly palm with sweet apricot-pineapple fruit for jelly.", 1460, 2190, "high", None, "sweet-tart, apricot-pineapple", "Fruit ~1 in clusters", "Orange fruit", "Feather palm to 15-20 ft", 5, "Premier cold-hardy palm for Phoenix (hardy ~15F), drought tolerant and disease resistant. Self-fruitful; summer fruit makes excellent jelly.", "public.asu.edu"),
        ...
        # ── CONSOLIDATED VARIETY RESEARCH (from plant-research PRs, deduped) ──
        ('Ajwain', 'Common Carom', 'Standard thyme-scented carom seed cultivar for rabi-season seed harvest.', 130, 160, 'moderate', None, 'thyme-cumin, pungent, slightly bitter', 'Seed ~2 mm; plant 2-3 ft', 'Greyish-brown ribbed seed', 'Erect feathery annual', 4, 'Cool-dry-season crop ideal for low-desert winter. Direct sow Oct-Nov, harvest browning umbels in spring before heat and humidity degrade seed.', 'agritell.com; gardeningknowhow.com'),
        ('Anise Hyssop', 'Blue Fortune', "Sterile hybrid that doesn't self-seed — long bloom season.", 90, 120, 'high', None, 'Strong anise-licorice', 'Tall (24-36 in)', 'Light blue-purple flower spikes', 'Upright clump', 5, 'Long bloomer (June-October) without becoming weedy. Pollinator favorite. Drought tolerant once established.', 'Hybrid'),
        ...
        ('Armenian Cucumber', 'Metki Dark Green Serpent', 'Long ribbed dark-green Armenian cucumber (actually a melon) that never turns bitter.', 60, 75, 'excellent', None, 'mild, sweet, refreshing, never bitter', 'long (18-36 in) ribbed fruit', 'dark green', 'vigorous vine', 5, 'Classic dark-green Armenian type with the same extreme heat tolerance as Painted Serpent; thrives through desert summer when true cucumbers fail.', 'rareseeds.com; trueleafmarket.com'),
        ('Basil', 'Amazel', 'Sterile sweet Italian basil hybrid with strong basil-downy-mildew resistance that resists bolting in heat.', 28, 42, 'high', 'basil downy mildew (Peronospora belbahrii)', 'classic sweet Genovese-style Italian, aromatic', '20-36 in tall, 12-24 in wide', 'green foliage', 'large vigorous upright, sterile, slow-to-bolt', 4, 'Because it is sterile it keeps making leaves instead of flowering, resisting heat-induced bolting through long hot desert summers (grown from cuttings, not seed).', 'provenwinners.com'),
        ('Cantaloupe', "Hale's Best Jumbo", '1920s heat-loving heirloom muskmelon with heavily netted rind and sweet salmon flesh.', 80, 90, 'high', None, 'very sweet, aromatic, juicy', '3-4 lb oval fruit', 'netted green-tan rind, salmon-orange flesh', 'vigorous vining', 5, 'An old commercial heirloom developed for hot, dry California melon fields; drought- and heat-tolerant and dependable in low-desert spring plantings.', 'trueleafmarket.com; harvesttotable.com'),
        ('Cardoon', 'Gigante di Romagna', 'Italian heirloom cardoon with thick tender stalks.', 120, 150, 'high', None, 'Mild artichoke heart', 'Large rosette (4-5 ft)', 'Silver-grey foliage', 'Architectural perennial', 4, 'Premier Italian variety. Blanch by wrapping stalks for 3 weeks before harvest. Plant fall for spring harvest in Zone 9b.', 'Italian heirloom'),
        ('Chiltepin Pepper', 'Sonoran Wild', 'True Sonoran Desert wild type collected from native stands; tiny round berries.', 100, 120, 'high', None, 'intensely hot, smoky, quick-flash heat', 'Berries ~0.25 in; shrub 3-4 ft', 'Green ripening bright red', 'Bushy perennial shrub', 5, 'The genuine Sonoran ecotype — a 35-50 year perennial in frost-free low desert. Grows as understory beneath nurse trees; give afternoon shade. Erratic germination, very drought hardy once established.', 'nativeseeds.org; growinginthegarden.com'),
        ('Chiltepin Pepper', 'Texas Bird Pepper', 'Texas/Tamaulipas wild tepin form, slightly larger and more upright.', 95, 115, 'high', None, 'sharp, fruity, fleeting fierce heat', 'Berries ~0.3 in; shrub to 4 ft', 'Green to red', 'Upright bushy shrub', 4, 'Eastern wild tepin ecotype. A touch larger-fruited and faster than the Sonoran type; equally heat- and drought-tolerant. Perennial in 9b/10a with light frost protection.', 'fs.usda.gov'),
        ('Collard Greens', 'Champion', 'Improved Vates-type, compact and slow-bolting.', 60, 75, 'high', None, 'Mild, classic collard flavor', 'Compact rosette (24-30 in)', 'Dark blue-green', 'Compact upright', 4, 'More compact than Georgia. Very slow to bolt. Good for succession planting in desert cool season.', 'Open-pollinated'),
        ('Collard Greens', 'Morris Heading', 'Loose-heading type, tender leaves, old Southern heirloom.', 70, 85, 'high', None, 'Sweet, tender, mild', 'Medium plant (24 in)', 'Dark green', 'Loose heading', 4, 'Forms loose head rather than rosette. Sweeter, more tender leaves than standard collards. Good for fresh eating.', 'Heirloom'),
        ('Corn', "Tohono O'odham 60-Day", "Ultra-fast desert-adapted flour corn from the floodwater (ak-chin) fields of southern Arizona's Tohono O'odham.", 60, 75, 'excellent', None, 'starchy, traditional flour-corn flavor for masa and meal', 'short plants, small-medium ears', 'white to multicolored flour kernels', 'short fast-maturing annual grass', 5, 'Adapted over 4,000 years to the low desert; matures in ~60 days on summer monsoon rains, ideally direct-sown around July 1.', 'nativeseeds.org; backyardgardener.com'),
        ...
        ('Curry Plant', "'Dwarf' (nana)", 'Compact 12-15 in form, denser silver foliage, ideal for containers and edging.', 90, 110, 'high', None, 'mild curry aroma', '12-15 in mound', 'Silver-grey', 'Compact evergreen subshrub', 4, 'Smaller selection well suited to pots and tight desert beds. Same drought- and heat-loving care; sharp drainage essential.', 'plantlust.com'),
        ('Curry Plant', 'Standard (Helichrysum italicum)', 'Silver-foliaged curry-scented Mediterranean subshrub with everlasting yellow flowers.', 90, 120, 'high', None, 'mild curry aroma, savory', '2 ft tall x 3 ft wide', 'Silver foliage, yellow flowers', 'Evergreen subshrub', 4, 'Loves heat, poor alkaline soil, and dry summers — rot from overwatering is the main risk. Aromatic seasoning herb; flowers dry for everlastings. Hardy ~Zone 7-11, dislikes hard frost.', 'gardenia.net; gardenbeast.com'),
        ('Cushaw Squash', 'Green-Striped Cushaw', 'Classic heirloom cushaw with crookneck, green-and-cream striped fruit.', 90, 110, 'excellent', 'Squash vine borer resistant', 'mild, sweet, low-water flesh', 'large crookneck (10-20 lb)', 'cream with green stripes', 'long vigorous vine', 5, 'Widely grown heat- and drought-tolerant heirloom; vine-borer resistant and a dependable keeper for pies and baking.', 'rareseeds.com; plants.ces.ncsu.edu'),
        ('Cushaw Squash', 'Hopi Vatnga', 'Traditional Hopi cushaw with large pear-shaped fruit, green or striped.', 90, 110, 'excellent', 'Squash vine borer resistant', 'mild, nutty', 'large pear-shaped fruit', 'dark green or striped', 'long vigorous vine', 5, 'The only Hopi squash currently in the NS/S seed bank; a hardy dryland cushaw adapted to hot, arid Southwest conditions.', 'nativeseeds.org'),
        ('Cushaw Squash', 'Magdalena Big Cheese', 'Sonoran landrace cushaw from Magdalena, Sonora; very heat- and drought-tolerant.', 90, 110, 'excellent', 'Squash vine borer resistant', 'mild, sweet, good keeper', 'large tan cheese-shaped fruit', 'tan/buff', 'long vigorous vine', 5, 'From Magdalena, Sonora — explicitly recommended by Native Seeds/SEARCH as an excellent choice for low-desert gardens. Heat, drought, and vine-borer resilient with long storage life.', 'nativeseeds.org'),
        ('Date Palm', 'Barhi', 'Soft, exceptionally sweet date often eaten fresh at the crunchy khalal stage.', 1460, 2190, 'excellent', None, 'very sweet, butterscotch', 'small-medium fruit', 'yellow (khalal) to amber', 'tall palm', 5, 'Prized for eating fresh-yellow and crisp before fully ripening. Heavy bearer in low-desert heat; female, requires male pollen.', 'extension.arizona.edu'),
        ('Eggplant', 'Aswad', 'Iraqi heirloom with massive teardrop deep-purple-black fruit and dense, dry flesh for frying and baking.', 70, 85, 'high', None, 'rich, meaty, drier flesh, mild, not bitter', 'large fruit up to 3 lb+', 'deep purple-black', 'upright bushy plant', 5, 'Selected in the hot, arid climate of Iraq; documented as heat- and drought-tolerant and sets fruit reliably through extreme low-desert heat.', 'rareseeds.com; trueloveseeds.com; highdesertseed.com'),
        ('Fava Bean', 'Aquadulce', 'Spanish variety, extra-large beans, very cold-hardy.', 85, 110, 'low', None, 'Sweet, tender when young', 'Very long pods (8-10 in)', 'Green pods, large pale seeds', 'Tall plant (4-5 ft)', 4, 'Extra-large beans, very productive. Tolerates frost to 10F. Ideal for fall planting in desert.', 'Spanish heirloom'),
        ('Fava Bean', 'Bell Bean', 'Small-seeded cover crop variety, prolific nitrogen fixer.', 75, 90, 'low', None, 'Edible but grown for soil improvement', 'Small pods', 'Green', 'Short plant (2-3 ft)', 5, 'Cover crop variety — chop and drop before flowering for nitrogen. Also edible. Excellent desert cool-season soil builder.', 'Cover crop'),
        ('Fava Bean', 'Windsor', 'Classic English broad bean, large seeds.', 85, 105, 'low', None, 'Rich, nutty, buttery', 'Large pods (6-8 in)', 'Green pods, pale green seeds', 'Upright plant (3-4 ft)', 4, 'Traditional culinary fava. Large beans perfect for shelling. Plant October-December in Phoenix for April-May harvest. Nitrogen fixer.', 'Heirloom'),
        ...
        ('Fremont Wolfberry', 'Native (Lycium fremontii)', 'Sonoran Desert native desert-thorn with the largest, sweetest native wolfberries.', 365, 730, 'high', None, 'sweet-tart, sweeter dried; some plants bitter', 'Berries ~1 cm', 'Yellow to orange-red', 'Drought-deciduous thorny shrub 3-6 ft', 5, 'Among the largest and sweetest of the native Lyciums. Spring-fruiting, drops leaves in summer drought and releafs after rain. Thrives in strongly alkaline soil below 3000 ft.', 'arboretum.arizona.edu; cabezaprieta.org'),
        ('Garlic', "Chet's Italian Red", 'Heirloom artichoke-type softneck with large bulbs of 10-20 mild cloves, selected over 25 years.', 210, 240, 'high', None, 'pleasant and mild, even raw', 'large bulbs, 10-20 cloves', 'white-yellowish with purple/pink blush', 'softneck, no scape', 4, 'An artichoke-group softneck that needs no winter chill, performs in mild-winter/hot-summer climates, matures early, and stores 6+ months.', 'filareefarm.com; seedsavers.org; gardenerspath.com'),
        ("I'itoi Onion", 'Standard', "Original Tohono O'odham heirloom multiplier onion.", 90, 365, 'excellent', None, 'Sharp, shallot-like', 'Small clumping bulbs', 'Copper-pink', 'Perennial clumping bunch', 5, 'Plant single bulblets in fall; clump expands each year. Harvest greens year-round, dig clumps in late spring before summer dormancy.', 'Native heirloom'),
        ('Lettuce', 'Parris Island Cos', 'Heat-resilient romaine; slow to bolt, classic crisp upright heads.', 65, 75, 'high', 'Tip-burn tolerant', 'crisp, sweet, mild', 'tall romaine head', 'medium green', 'upright romaine', 4, 'One of the more bolt-resistant romaines for stretching the desert cool-season lettuce window; pairs well with shade cloth in shoulder season.', 'trueleafmarket.com; extension guides'),
        ...
        ('Mandarin', 'Clementine', 'Classic small sweet mandarin, mostly seedless.', 730, 1460, 'high', None, 'Sweet, mildly tart, aromatic', 'Small (2-2.5 in)', 'Deep orange', 'Small tree (10-12 ft)', 4, 'The classic holiday mandarin. Mostly seedless if grown isolated from other citrus. Ripens Nov-Jan. Needs pollinator-free zone for true seedless fruit.', 'North African/Spanish'),
        ('Mandarin', 'Gold Nugget', 'Bumpy-skinned, exceptionally sweet late-season mandarin.', 730, 1460, 'high', None, 'Very sweet, rich, seedless', 'Medium (2 in)', 'Yellow-orange, bumpy skin', 'Medium tree (10-15 ft)', 5, 'Ripens Feb-May — latest mandarin. Holds well on tree. One of the sweetest mandarins grown. UC Riverside breeding.', 'UC Riverside'),
        ('Mandarin', 'Kishu Seedless', 'Tiny, sweet, seedless mandarin. Extremely popular.', 730, 1460, 'high', None, 'Intensely sweet, easy peel', 'Small (1-1.5 in)', 'Deep orange', 'Small tree (8-12 ft)', 5, "Tiny fruits packed with flavor. Completely seedless. Kids' favorite. Ripens Nov-Jan in AZ. Hardy to ~25F. Self-fertile.", 'Ancient Japanese'),
        ('Mandarin', 'Owari Satsuma', 'Classic seedless Satsuma, very cold-hardy.', 730, 1460, 'moderate', None, 'Sweet, mild, easy peel', 'Medium (2.5 in)', 'Light orange', 'Small tree (8-12 ft)', 4, 'Most cold-hardy mandarin (hardy to ~18F). Easy peel, seedless. Ripens Oct-Dec — earliest citrus in AZ. Japanese origin.', 'Japanese heirloom'),
        ('Mandarin', 'W. Murcott (Tango)', 'Seedless late-season mandarin, excellent flavor.', 730, 1460, 'high', None, 'Sweet-tart, rich, easy peel', 'Medium (2.5 in)', 'Deep reddish-orange', 'Medium tree (12-15 ft)', 5, 'Tango is the seedless patented version. Ripens Jan-Mar. Heavy producer. Outstanding desert performer.', 'University of California'),
        ('Melon', "Hale's Best Jumbo", 'Heirloom netted cantaloupe bred in the 1920s in California heat for reliable sweet orange-fleshed fruit.', 75, 90, 'excellent', 'tolerant of powdery mildew', 'very sweet, juicy, aromatic', 'large (4-6 lb)', 'tan netted rind, deep orange flesh', 'vigorous trailing vine', 5, 'Repeatedly cited by Mojave and low-desert growers as the most reliable cantaloupe in extreme heat and dry spells.', 'botanicalinterests.com; trueleafmarket.com; ufseeds.com'),
        ('Oca', 'New Zealand Yam (mixed)', 'Standard short-day Andean oca; colorful waxy tubers, lemony foliage.', 180, 240, 'low', None, 'tangy-lemony fresh, sweeter after sun-curing', 'Tubers 2-3 in', 'Red, yellow, pink, apricot', 'Low clumping perennial', 2, 'Marginal in low desert — needs frost-free months after the fall equinox to bulk tubers. Site in a warm protected microclimate, mulch heavily, cure tubers in sun to sweeten.', 'cultivariable.com; pfaf.org'),
        ('Okinawa Spinach', 'Purple-back (Gynura bicolor)', 'Classic green-topped, purple-undersided heat-loving perennial green.', 50, 70, 'excellent', None, 'mild, nutty-pine, slightly mucilaginous', '12-24 in mounding', 'Green over purple', 'Spreading perennial', 5, 'The standard Okinawan longevity green. Grown from cuttings; cut-and-come-again all summer with afternoon shade and water. Best young leaves; dies back in frost and resprouts.', 'ourpermaculturelife.com; sowexotic.com'),
        ('Okra', 'Cowhorn', 'Heirloom okra with very long curved pods that stay tender at larger size.', 55, 65, 'excellent', None, 'mild, tender', '6-8 ft plant, 8-10 in pods', 'green', 'very tall', 4, 'Long pods remain tender longer than most types, useful in desert heat where okra sizes up fast; needs staking at full height.', 'rareseeds.com; harvesttotable.com'),
        ('Okra', 'Hill Country Red', 'Texas heirloom okra with red-tinged stems and pods, exceptionally heat- and drought-hardy.', 64, 75, 'excellent', None, 'rich, classic okra', '5-6 ft plant, ribbed pods', 'green pods with red blush', 'tall vigorous', 5, 'A Texas dryland heirloom selected for brutal heat and drought; among the most reliable okras for the low desert.', 'shop.seedsavers.org; aggie-horticulture.tamu.edu'),
        ('Okra', 'Jambalaya', 'Compact, early hybrid okra producing high yields of uniform tender green pods once heat arrives.', 50, 55, 'excellent', None, 'mild, grassy, crisp; tender when young', '3-4 in pods, 3-5 ft plant', 'green', 'compact upright bush', 5, 'Earliest-maturing okra here lets the plant bear before peak July-August 115F stress, and its compact size suits raised beds and containers.', 'johnnyseeds.com; territorialseed.com; reneesgarden.com'),
        ('Old Man Saltbush', 'Standard (Atriplex nummularia)', 'Large silver-leaved Australian saltbush; edible salty leaves, extreme tolerance.', 180, 365, 'excellent', None, 'salty, mineral, spinach-like', '8-10 ft shrub', 'Silver-grey', 'Evergreen woody shrub', 5, 'Possibly the toughest edible shrub for saline/alkaline desert soil. Year-round leaf harvest; eat fresh, fried as chips, or dried as seasoning salt. Prune for tender new growth.', 'tuckerbush.com.au; feedipedia.org'),
        ('Onion', 'Red Creole', 'Heirloom short-day onion producing firm, flat, bright-red bulbs; the standard red for southern latitudes.', 100, 110, 'high', None, 'pungent, sharp; firm and stores well', 'medium flattened globe', 'bright red', 'short-day bulbing', 5, 'Short-day type bulbs on the 10-12 hour days of a Phoenix winter/spring planting; carried by Native Seeds/SEARCH and recommended for AZ low desert.', 'nativeseeds.org; ufseeds.com; growinginthegarden.com'),
        ...
        ('Peach', 'Babcock', 'Low-chill (250-300 hrs) white-fleshed peach, heirloom California variety.', 730, 1095, 'high', None, 'Sweet, juicy, aromatic white flesh', 'Medium (2.5 in)', 'Cream with red blush', 'Medium tree (15-20 ft)', 4, 'Old California heirloom. Thin-skinned white peach with outstanding flavor. Ripens June in Phoenix. Self-fertile.', 'Heirloom'),
        ('Peach', 'Desert Gold', 'Low-chill (250 hrs) peach bred for California/desert climate.', 730, 1095, 'excellent', None, 'Sweet, yellow flesh, semi-freestone', 'Medium (2.5-3 in)', 'Yellow with red blush', 'Medium tree (15-18 ft)', 5, 'Classic California/AZ low-desert peach. Ripens mid-May. Large crops reliably. Self-fertile.', 'California'),
        ('Peach', 'Earligrande', 'Low-chill (275 hrs) yellow semi-freestone.', 730, 1095, 'excellent', None, 'Sweet-tart, yellow flesh', 'Medium (2.5 in)', 'Red over yellow', 'Medium tree (12-15 ft)', 5, 'Very early ripening — late April to early May in Phoenix. Reliable low desert producer.', 'University of Florida'),
        ('Peach', 'Florida Prince', 'Very low chill (150 hrs), earliest ripening peach for desert.', 730, 1095, 'excellent', None, 'Sweet, yellow flesh, clingstone', 'Medium (2.5 in)', 'Red-blush yellow', 'Small tree (12-15 ft)', 5, 'Among the lowest-chill peaches — ripens in May in Phoenix. Reliable producer where standard peaches fail. Self-fertile. Heavy bearer needs thinning.', 'University of Florida'),
        ('Peach', 'Mid-Pride', 'Low-chill (250 hrs) yellow freestone, Zaiger breeding.', 730, 1095, 'excellent', None, 'Rich, sweet, classic yellow peach', 'Large (3 in)', 'Red over yellow', 'Medium tree (15-18 ft)', 5, 'Freestone — easy to pit. Ripens late June/early July. One of the best-flavored low-chill peaches. Self-fertile.', 'Zaiger Genetics'),
        ('Peach', 'Tropic Snow', 'Very low chill (200 hrs) white freestone peach.', 730, 1095, 'excellent', None, 'Sweet, low-acid white flesh', 'Medium-large (2.5-3 in)', 'White with red blush', 'Medium tree (12-15 ft)', 4, 'White freestone for very warm winters. Ripens late May in Phoenix. Excellent eating quality.', 'University of Florida'),
        ('Pepper', 'Aji Amarillo', 'Peruvian yellow chile with fruity heat — backbone of Peruvian cuisine.', 100, 120, 'excellent', None, 'Fruity, raisin-like, medium-hot', 'Long (4-6 in)', 'Yellow-orange when ripe', 'Tall bush (3-4 ft)', 5, 'Long season suits desert. Productive perennial in frost-free microclimates. Essential for ají de gallina, papa a la huancaína.', 'Peruvian heirloom'),
        ('Pepper', 'NuMex Big Jim', 'NMSU-bred Hatch-type chile with very large mild-to-medium pods.', 75, 85, 'excellent', None, 'mild-medium heat, rich roasting flavor', '10-12 in pods, 2-3 ft plant', 'green ripening red', 'bushy', 5, 'Developed by New Mexico State University for the desert Southwest; the classic large roasting/Hatch chile, very productive in low-desert heat.', 'aces.nmsu.edu; chileplants.com'),
        ('Pepper', 'NuMex Joe E. Parker', 'Improved NMSU Anaheim/NuMex 6-4 selection with uniform thick-walled pods.', 78, 85, 'excellent', None, 'mild, sweet roasting chile', '6-8 in pods, 2 ft plant', 'green ripening red', 'bushy', 5, 'NMSU release prized for uniform, heavy yields of mild roasting chiles; a dependable workhorse pepper for desert gardens.', 'aces.nmsu.edu; sandiaseed.com'),
        ('Pepper', 'Padron', 'Spanish tapas pepper — pick young for mild, leave on for surprise heat.', 60, 75, 'excellent', None, 'Mild grassy when young, hot when mature', 'Small (1-2 in)', 'Green to red', 'Compact bush', 5, 'Productive in desert heat. Pick at 1-1.5 inches for tapas (most are mild, ~1 in 10 is spicy). Blister in olive oil with salt.', 'Spanish heirloom'),
        ('Pistachio', 'Golden Hills', 'Newer UC female release; earlier harvest and higher yield than Kerman.', 1825, 2920, 'excellent', None, 'rich, buttery', 'large tree', 'tan shell, green kernel', 'spreading deciduous tree', 4, 'Ripens ~10-14 days before Kerman with strong yields; pollinate with a compatible early male (Randy/Famoso). Good for stretching harvest in hot inland/desert plantings.', 'ucanr.edu California Pistachio Research'),
        ('Pistachio', 'Kerman', 'The leading female (nut-bearing) pistachio cultivar; large kernels, golden hulls.', 1825, 2920, 'excellent', None, 'rich, buttery, classic pistachio', 'large rounded tree', 'tan shell, green kernel', 'spreading deciduous tree', 4, 'Standard commercial female; reliable 40-50 lb yields at maturity. Needs a Peters male nearby for pollination and adequate winter chill — best in higher-desert AZ; low-desert Phoenix is borderline on chill hours.', 'ucanr.edu California Pistachio Research; onegreenworld.com'),
        ('Pistachio', 'Peters', 'The standard male pollinizer for Kerman; bears no nuts but supplies pollen.', 1825, 2920, 'excellent', None, 'N/A (pollen source)', 'large tree', 'N/A', 'spreading deciduous tree', 4, 'Wind-pollinates up to ~11 female trees. Plant ~1 Peters per 8-11 Kermans, upwind, with overlapping bloom. Essential — without a male, females set no nuts.', 'onegreenworld.com; ucanr.edu California Pistachio Research'),
        ('Pluot', 'Dapple Dandy', "'Dinosaur egg' pluot with maroon-speckled green skin.", 730, 1095, 'high', None, 'Very sweet, tropical, juicy', 'Large fruit', 'Green/maroon mottled, pink flesh', 'Standard tree', 5, 'Visually stunning. Reliable producer in low desert with proper pollinizer (Burgundy plum or Flavor Supreme). Ripens July-August.', 'Zaiger Genetics'),
        ('Pluot', 'Flavor Supreme', 'Top-flavored low-chill pluot — green-mottled skin, red flesh.', 730, 1095, 'high', None, 'Outstanding sweet-tart, complex', 'Medium fruit', 'Green with red mottling, red flesh', 'Standard tree', 5, 'Lower chill hours (~250-300) work in Zone 9b. Needs Japanese plum pollinator (Santa Rosa). Ripens June-July.', 'Zaiger Genetics'),
        ...
        ('Screwbean Mesquite', 'Native (wild type)', 'Wild-type Prosopis pubescens grown for sweet, protein-rich coiled pods.', 1095, 1825, 'excellent', None, 'sweet, molasses-like, nutty', 'small tree to ~23 ft, screw-shaped pods', 'tan coiled pods', 'deciduous nitrogen-fixing tree', 4, 'Seed-grown native; pods dried, washed and milled into sweet flour. Nitrogen-fixing and very drought-resilient once established.', 'southwestdesertflora.com; raindanceseeds.com'),
        ('Sorrel', 'Red Veined', 'Striking sorrel with crimson veins and lemon tang.', 55, 70, 'low', None, 'Bright lemony-tart', 'Small leaves', 'Green with red veins', 'Low rosette perennial', 4, 'Beautiful in salads. Cool-season harvest in Zone 9b; mulch heavily and shade for summer survival. Perennial root.', 'Heirloom'),
        ...
        ('Squash (Summer)', 'Dark Star', 'Open-pollinated zucchini (Black Beauty x Raven) selected for drought tolerance and vigor on minimal irrigation.', 50, 60, 'high', None, 'sweet, delicate', '6-8 in fruit', 'dark glossy green', 'open bush', 4, 'Bred for deep roots and drought tolerance that establish without irrigation, suiting low-desert beds in the cooler shoulder seasons.', 'redwoodseeds.net; sandiegoseedcompany.com; highmowingseeds.com'),
        ('Tepary Bean', 'Mitla Black', 'Black-seeded tepary from Oaxaca — drought-hardy and productive.', 70, 90, 'excellent', None, 'Earthy, rich, dense', 'Small dry bean', 'Black', 'Low bush', 5, 'Mexican selection with good heat resilience. Plant after last frost or in monsoon season. Minimal irrigation needed.', 'Mexican heirloom'),
        ('Tomato', 'Sun Sugar', 'Golden cherry tomato — sweetest cherry rated by many growers.', 62, 70, 'high', 'FT', 'Tropical, intensely sweet', 'Cherry (0.5 oz)', 'Golden yellow', 'Indeterminate', 4, 'Crack-resistant improvement on Sun Gold. Productive into early summer in low desert. Plant early February.', 'Hybrid'),
        ('Watermelon', 'Charleston Gray', 'Large elongated open-pollinated heirloom with greenish-gray rind and crisp, fiberless bright-red sweet flesh.', 80, 90, 'high', 'fusarium wilt, anthracnose, sunburn', 'sweet, juicy, crisp, fiberless', '22-26 in, 25-35 lb fruit', 'light greenish-gray rind, red flesh', 'vigorous sprawling vine', 5, "Heat- and sunburn-tolerant with a thick rind, well-adapted to Arizona's scorching low-desert summers when planted into warm soil (70F+).", 'botanicalinterests.com; burpee.com; travis-tx.tamu.edu'),
        ('Watermelon', 'Jubilee', 'Large striped oblong heirloom (Florida Giant) on heat-loving vigorous vines.', 90, 100, 'high', 'fusarium & anthracnose tolerant', 'very sweet, juicy', '25-40 lb oblong fruit', 'light/dark green stripes, red flesh', 'vigorous vining', 4, 'Florida-bred for hot climates; needs the full warm season and consistent water but yields huge sweet melons in the desert.', 'trueleafmarket.com; gardeningknowhow.com'),
        ('Yacon', 'Morado', 'Reddish-skinned yacon with sweet crisp flesh.', 180, 240, 'moderate', None, 'Sweet, crunchy, apple-jicama', 'Large storage roots (6-12 in)', 'Red-purple skin, white flesh', 'Tall perennial (5-6 ft top)', 4, 'Best yacon for low desert with afternoon shade. Sweetens after first light frost. Replant crown divisions; eat tubers.', 'Andean heirloom'),
        ('Gai Lan', 'Green Lance', 'Vigorous F1 hybrid Chinese broccoli with smooth blue-green stems; uniform and quick.', 45, 60, 'moderate', None, 'mild, sweet, broccoli-like', '12-15 in', 'blue-green', 'upright', 3, 'Fast and uniform — well suited to the short low-desert cool window. Sow mid-Sept through Dec and cut the central shoot at bud stage to push side shoots.', 'westcoastseeds.com; johnnyseeds.com'),
        ('Gai Lan', 'Suiho', 'Heat-tolerant open-pollinated gai lan selected for slower bolting and tender stems.', 50, 70, 'high', None, 'mild, slightly sweet', '12-18 in', 'medium green', 'upright', 3, 'One of the more bolt-resistant gai lans, giving a little extra room on the warm shoulders of the Phoenix cool season. Still a fall/winter crop.', 'kitazawaseed.com; evergreenseeds.com'),
        ('Celtuce', 'Standard Green', 'Classic stem lettuce with a thick crisp peeled core and mildly bitter leaves.', 60, 80, 'low', None, 'mild, sweet, nutty stem', '12-20 in', 'light green', 'upright rosette to thick stalk', 3, 'Treat as leaf lettuce: fall/winter only in Phoenix. Keep evenly moist and harvest the stem before the flower stalk bolts, or it turns woody and bitter.', 'highdesertseed.com; tyrantfarms.com'),
        ('Edible Hibiscus', 'Green Aibika', 'Standard fast-growing green-leaved aibika; cut-and-come-again perennial mallow green.', 60, 90, 'excellent', None, 'mild, sweet, mucilaginous', '6-9 ft', 'green', 'tall perennial shrub', 4, 'Top monsoon-season green for Phoenix — grow from cuttings, full sun, high water and heavy mulch. Frost-tender; treat as a summer annual or protect below mid-20s F.', 'pfaf.org; ourpermaculturelife.com'),
        ('Ethiopian Kale', 'Amara', 'Fast nutty-flavored Abyssinian mustard for baby leaf or mature greens; slow to bolt.', 21, 50, 'high', None, 'mild mustard, nutty/almond', '24-36 in', 'green', 'upright leafy', 4, 'The most heat- and drought-tolerant green here — bolts slower than mustard, extending the desert season into late spring. Cut-and-come-again from a Sept–Feb sowing.', 'johnnyseeds.com; highdesertseed.com'),
        ("Za'atar", 'Standard (Origanum syriacum)', 'Silver-green Syrian oregano; the authentic dried base of the za\'atar spice blend.', 75, 90, 'excellent', None, 'intense oregano-thyme-marjoram', '12-30 in', 'grey-green foliage, white flowers', 'perennial subshrub', 4, 'Loves heat and alkaline desert soil; the main risk is winter root rot in wet, poorly drained ground — plant in gritty mix or raised beds and water sparingly. Protect from hard freeze.', 'missouribotanicalgarden.org; gardeningknowhow.com'),
        ('Fishhook Barrel Cactus', 'Native (Ferocactus wislizeni)', 'Sonoran native barrel cactus grown for tart lemony yellow fruit, edible buds and seeds.', 1095, 3650, 'excellent', None, 'tart, sour, lemony fruit', 'to ~8 ft, ribbed barrel', 'green body, yellow fruit', 'slow columnar cactus', 5, 'Perfectly desert-adapted: full sun, sharp drainage, minimal water. Arizona Protected Native Plant — buy nursery-propagated stock. Fruit used for candy/jelly; seeds a traditional food.', 'arboretum.arizona.edu; fireflyforest.com'),
        ('Hedgehog Cactus', 'Native (Echinocereus engelmannii)', 'Clumping Sonoran/Mojave native bearing sweet strawberry-like red fruit.', 1095, 2555, 'excellent', None, 'sweet, juicy, strawberry-like', '4-12 in mounding clumps', 'green stems, magenta flowers, red fruit', 'clumping cactus', 5, 'Best-eating of the desert cacti fruits. Needs full sun and excellent drainage (rocky/gritty soil or a mound); overwatering is the main killer. Harvest fruit promptly before wildlife.', 'aznps.com; southwestdesertflora.com'),
        # ── NEW VARIETIES (research run 2026-06-02 r11) ──
        ("Ghost Pepper", "Bhut Jolokia (Red)", "Classic Indian landrace superhot, ~1,000,000 SHU, wrinkled red pods 2.5-3 in long on a ~3 ft bushy plant; long slow season.", 100, 120, "low", None, "searing slow-building heat with fruity undertone", "2.5-3 in long pods", "ripens orange to red", "bushy upright shrub ~36 in", 3, "Grows in low desert if transplanted late Feb-March and given 50%+ afternoon shade over 90F; fruit set stalls in peak summer and resumes after monsoon cooling. Needs consistent moisture and slow germination start.", "sandiaseed.com"),
        ("Ghost Pepper", "Bhut Jolokia (Peach)", "Lighter-colored ghost selection with similar superhot heat and long season; pods ripen to peach/cream rather than red.", 100, 120, "low", None, "intense floral-fruity heat", "2.5-3 in long pods", "ripens to peach/cream", "bushy upright shrub ~36 in", 3, "Same low-desert handling as red ghost: established before heat, afternoon shade, steady water; expect best set spring and post-monsoon.", "peppergeek.com"),
        ("Aji Amarillo", "Aji Amarillo (standard)", "Classic long Peruvian yellow-orange chile, the most-used chile in Peru; 5-6 in tapered pods ripening yellow-orange with fruity mango notes and medium heat.", 90, 120, "high", None, "fruity, sweet-tart, tropical mango", "5-6 in long x 1.25 in wide", "deep yellow-orange when ripe", "tall sprawling bush 5 ft+", 4, "Long season is well matched to Phoenix's extended warm season; transplant Feb-Mar. Needs afternoon shade over 90F and may halt fruit set when nights exceed 86F mid-summer, setting again as nights cool. Can overwinter in 9b with frost protection.", "sandiaseed.com"),
        ("Aji Amarillo", "Aji Amarillo Grande", "Larger-podded selection of the Peruvian amarillo; slightly bigger fruit, similar fruity flavor and heat, equally long season.", 100, 120, "high", None, "fruity, tropical, medium heat", "6-7 in long", "yellow-orange", "tall sprawling bush", 4, "Same desert handling as standard Aji Amarillo; very long DTM rewards Phoenix's long season but requires early indoor start and stake support. Provide afternoon shade in peak heat.", "peppergeek.com"),
        ("Cassabanana", "Standard (species)", "The standard species form; a vigorous tropical vine to 50 ft bearing huge cylindrical fragrant fruit with sweet cantaloupe-like flesh. The only commonly available type; no named cultivars in trade.", 100, 180, "excellent", None, "sweet melon/cantaloupe-like, strongly aromatic", "12-24 in long (1.8-4.5 kg)", "orange-red to dark purple-black skin; orange-yellow flesh", "fast vigorous climbing vine to 50 ft", 4, "Loves Phoenix heat and a long warm/monsoon season; needs early start, very strong support, deep water, and the full summer-fall to ripen its large fruit before frost. Not drought tolerant; ripening can be slow.", "tradewindsfruit.com"),
        ("Safflower", "Spineless (S-208 type)", "Spineless or near-spineless oilseed/cut-flower types selected to ease handling and harvest; orange-yellow florets, good for home gardens and ornamental/dye use.", 110, 140, "excellent", "moderate", "mild, faint saffron-like florets", "24-40 in tall", "yellow to orange florets", "erect branched annual", 4, "Easier to handle than spined types; fall/winter sow in low desert, harvest late spring before extreme heat.", "ndsu.edu"),
        ("Safflower", "Spined (oilseed field type)", "Traditional high-oil field types that develop stiff leaf spines near flowering; higher seed yield and oil but require gloves to handle; deep taproot gives strong drought tolerance.", 120, 150, "excellent", "moderate", "neutral light seed oil; yellow/red dye florets", "30-48 in tall", "yellow, orange, or red florets", "erect branched annual", 4, "Best drought performance for low-desert dryland; spines make hand-harvest of florets difficult.", "corn.agronomy.wisc.edu"),
        ("Nigella", "Black Seed (Kalonji)", "Traditional edible black cumin grown for its pungent black culinary seeds; 10-12 inch plants with fennel-like foliage and white/pale-blue bee-attracting flowers, followed by inflated seed capsules harvested dry.", 80, 100, "moderate", None, "pungent, peppery, nutty-bitter", "10-12 in tall", "black seeds, white/pale-blue flowers", "upright branching annual", 4, "Reliable low-desert cool-season crop: fall direct-sow, spring harvest before extreme heat. Direct-sow only (dislikes transplanting); drought-tolerant once established but needs excellent drainage.", "trueloveseeds.com"),
        ("Finger Millet", "Ragi (common landrace)", "Standard open-pollinated finger millet grown for its calcium-rich brown grain; tufted erect grass with digitate finger-like seed heads, well adapted to hot, low-input dryland conditions.", 90, 130, "excellent", None, "mild nutty earthy", "36-48 in tall", "reddish-brown grain", "erect tufted annual bunchgrass", 4, "Strong low-desert performer as a monsoon-season grain; direct-sow after soil warms and harvest before first frost. Watch for birds at grain fill and provide good drainage.", "en.wikipedia.org"),
        ("Mango", "Manila (Ataulfo)", "Southeast Asian / Mexican-type mango, long and thin, very sweet and nearly fiberless; the most commonly available and most cold-adapted choice for marginal climates, often used as rootstock. Ripens yellow-to-orange mid-to-late August in Phoenix.", 1095, 1825, "high", None, "Very sweet, rich, creamy, low-fiber", "Small to medium", "Yellow to orange", "Upright to spreading evergreen", 4, "Best starter cultivar for low-desert Phoenix microclimates; relatively more cold-tolerant and reliable, but still needs frost protection below upper-30s and shade cloth on young trees.", "phoenixtropicals.com"),
        ("Mango", "Keitt", "Indian-type late-season mango, larger fruit that stays mostly green when ripe, slightly more tart than Manila but very sweet when ripened in low-desert heat. Late ripening (often Sept) helps it dodge spring frost on the bloom.", 1095, 1825, "excellent", None, "Sweet with mild tartness, firm, low-fiber", "Large", "Green with blush, stays green when ripe", "Vigorous spreading evergreen", 4, "Excels in extreme desert heat and its late bloom/ripening reduces frost risk to flowers; mature trees take cold to mid-20s with protection. Still requires a warm wall and shade for young trees.", "phoenixtropicals.com"),
    ]
