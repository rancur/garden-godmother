...
PLANTS = [
    ...
    },
    {
        ...
        "desert_transplant": ["03-01", "04-30"],
        "desert_harvest": ["05-15", "10-15"],
        "notes": "Melothria scabra — Mexican Sour Gherkin or mouse melon. Native to Mexico/Central America so it loves desert heat. Vigorous vine producing grape-sized fruit that taste like cucumber with a citrus tang. Trellis 5-8 ft. Far more pest- and disease-resistant than true cucumbers. Tubers can be overwintered for an earlier start the next year. Productive through monsoon when most cucumbers have died.",
        "companions": ["Bean", "Corn", "Sunflower", "Marigold", "Nasturtium"],
        "antagonists": ["Potato"],
    },
    {
        "name": "Goldenberry",
    ...
    },
    {
        ...
        "desert_sow_outdoor": None,
        "desert_transplant": ["02-15", "04-15"],
        "desert_harvest": ["10-15", "06-15"],
        "notes": "Solanum muricatum — Andean perennial shrub producing melon-flavored fruit (cantaloupe + cucumber + honeydew). Hardy to ~28F so usually overwinters in 9b/10a. Propagated easily from cuttings — much faster than seed. Needs afternoon shade above 110F to prevent sunburn on fruit. Tolerates poor soil. Stake or cage as branches are brittle. Light yields year one, heavy by year two. Good container candidate for pulling indoors during rare hard freezes.",
    ...
    },
    {
        ...
        "desert_harvest": ["01-01", "12-31"],
        "notes": "Allium × proliferum — perennial topsetting onion that 'walks' across the bed by producing bulbils on top of stalks that bend over and root. One of the easiest perennial alliums for the low desert. Plant bulbils Sep-Nov for establishment before heat. Goes semi-dormant in summer above 110F — water sparingly to prevent rot. Harvest greens like scallions year-round, bulbils for pickling, mature bulbs in spring. Once established, self-perpetuates indefinitely with zero work.",
        "companions": ["Carrot", "Lettuce", "Tomato", "Strawberry", "Beet"],
        "antagonists": ["Bean", "Pea", "Asparagus"],
    },
    {
        "name": "Orach",
        ...
        "notes": "Atriplex hortensis — Mountain Spinach, an ancient salt-tolerant chenopod. Outlasts spinach by months in the desert: holds quality into May/June after spinach has bolted. Red, gold, and green forms. Drought- and salinity-tolerant once established. Direct sow shallowly; thin to 12 in. Pinch flower spikes to extend leaf harvest. Self-seeds prolifically — let one plant go to seed for next year's crop. Mild spinach flavor, holds shape better when cooked.",
        "companions": ["Bean", "Pea", "Carrot", "Beet", "Lettuce"],
        "antagonists": [],
    },
    {
        "name": "Anise Hyssop",
        ...
        "desert_transplant": ["02-15", "04-15"],
        "desert_harvest": ["05-01", "11-15"],
        "notes": "Agastache foeniculum — drought-tolerant perennial in the mint family. Lavender-blue flower spikes are pollinator magnets. Leaves taste of licorice/anise and brew into excellent tea. Hardy to 0F and tolerates 115F+ desert summers without irrigation once established. Better desert performer than true hyssop. Cut back hard after bloom for second flush. Self-seeds modestly. Companion to fruit trees for pollinator attraction. Resistant to deer, rabbits, and javelina.",
        "companions": ["Tomato", "Pepper", "Eggplant", "Squash", "Cucumber"],
        "antagonists": [],
    },
    {
        "name": "French Sorrel",
        ...
        "desert_transplant": ["10-01", "03-15"],
        "desert_harvest": ["11-01", "05-31"],
        "notes": "Rumex scutatus — perennial leafy green with bright lemon-tart flavor. Better desert choice than common garden sorrel: smaller, less invasive, milder oxalic acid. Goes dormant in deep desert summer (>105F) but returns in fall. Plant in afternoon-shade location to extend season. Pinch flower stalks to keep producing tender leaves. Classic in French sorrel soup and sauces. Mulch heavily through summer and water sparingly to keep crown alive.",
        "companions": ["Strawberry", "Lettuce", "Bean"],
        "antagonists": [],
    },
    {
        "name": "Tamarillo",
