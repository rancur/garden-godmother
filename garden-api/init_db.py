...
PLANTS = [
    ...
    # ── GINGER ──
    {
        ...
        "desert_seasons": ["warm", "monsoon"],
        "sow_indoor_weeks_before_transplant": 8,
        "desert_sow_outdoor": ["03-15", "05-01"],
        "desert_transplant": ["04-01", "05-31"],
        "desert_harvest": ["12-01", "01-31"],
        "notes": "Zingiber officinale. Requires afternoon shade and rich, moist soil in desert. Plant rhizomes 2 inches deep. Grows well under tree canopy or with 50% shade cloth. Harvest after 8-10 months when leaves die back.",
        "companions": ["Turmeric", "Lemongrass", "Bean (Bush)", "Cilantro"],
        "antagonists": [],
    },
    # ── PAPAYA ──
    {
        ...
        "desert_transplant": ["03-15", "05-15"],
        "desert_harvest": ["12-01", "05-31"],
        "notes": "Carica papaya. Plant against south-facing wall for frost protection. Mexican varieties handle desert heat best. Keep fairly dry in winter to prevent root rot. Treat as short-lived perennial — may freeze to ground below 32F but can regrow in mild winters.",
        "companions": ["Banana", "Lemongrass", "Sweet Potato", "Basil"],
        "antagonists": [],
    },
    # ── MUSTARD GREENS ──
    {
        ...
        "notes": "Brassica juncea. Fast-growing cool-season green with peppery flavor. Direct sow in fall for best results. Bolts quickly in heat — harvest before temperatures exceed 80F. Many varieties: Southern Giant Curled, Red Giant, Florida Broadleaf.",
        "companions": ["Lettuce", "Spinach", "Onion", "Carrot", "Beet"],
        "antagonists": ["Tomato", "Pepper", "Strawberry"],
    },
    # ── MIZUNA ──
    {
        ...
        "desert_transplant": None,
        "desert_harvest": ["10-15", "03-31"],
        "notes": "Brassica rapa var. nipposinica. Japanese mustard green with mild, peppery flavor and feathery leaves. Excellent cut-and-come-again green. More heat-tolerant than many brassicas but still a cool-season crop in Phoenix. Great for salad mixes.",
        "companions": ["Lettuce", "Arugula", "Spinach", "Radish", "Carrot"],
        "antagonists": ["Tomato", "Pepper"],
    },
    # ── TATSOI ──
    {
        "name": "Tatsoi",
    ...
    # ── KOHLRABI ──
    {
        ...
        "desert_transplant": ["10-01", "02-28"],
        "desert_harvest": ["11-01", "03-31"],
        "notes": "Brassica oleracea var. gongylodes. Harvest when bulbs are 2-3 inches across for best flavor and tenderness. Gets woody if left too long. Both bulb and leaves are edible. Good for fall/winter desert gardens.",
        "companions": ["Beet", "Onion", "Lettuce", "Cucumber", "Celery"],
        "antagonists": ["Tomato", "Pepper", "Strawberry"],
    },
    # ── CHOLLA ──
    {
        ...
        "desert_transplant": ["10-01", "03-31"],
        "desert_harvest": ["03-01", "05-15"],
        "notes": "Cylindropuntia spp. (staghorn cholla). Immature flower buds are a traditional Tohono O'odham food, rich in calcium. Harvest buds in spring before they open. Remove spines by rolling on rough surface or blanching. Buds taste like a cross between green bean, artichoke, and asparagus.",
        "companions": ["Prickly Pear"],
        "antagonists": [],
    },
    # ── MEXICAN OREGANO ──
    {
        ...
        "desert_transplant": ["03-15", "05-01"],
        "desert_harvest": ["12-01", "01-31"],
        "notes": "Zingiber officinale. Needs warm, shaded spot with super-draining soil. In Phoenix, grow in containers or under shade cloth/trees. About 10 months to harvest. Perennial in frost-free spots.",
        "companions": ["Turmeric", "Lemongrass", "Cilantro"],
        "antagonists": ["None known"],
    },
    # ── ALOE VERA ──
    {
    ...
    # ── PERSIMMON ──
    {
        ...
        "notes": "Diospyros kaki. Non-astringent Fuyu is the best desert choice — eat crisp like an apple. CRITICAL: needs afternoon shade in Phoenix to prevent leaf burn. Plant on east side of house or under deciduous canopy. Requires D. virginiana rootstock for desert heat tolerance — avoid D. lotus rootstock. Water 3x/week in summer. Low-maintenance once established. Bears fruit at 3-5 years.",
        "companions": ["Comfrey", "Nasturtium", "Marigold", "Lavender"],
        "antagonists": [],
    },
    # ── PECAN ──
    {
        ...
        "desert_transplant": ["01-15", "03-15"],
        "desert_harvest": ["10-01", "12-31"],
        "notes": "Carya illinoinensis. Major Arizona crop — thrives in desert heat. Plant bare root in late winter. Western Schley, Wichita, and Apache are best AZ varieties. Need 2 varieties for cross-pollination. VERY large tree (50ft). Heavy water user — not for low-water landscapes. Zinc deficiency common — supplement with zinc sulfate. Drill through caliche if present. Nuts ripen in fall.",
    ...
    # ── KUMQUAT ──
    {
        ...
        "desert_transplant": ["03-01", "04-30"],
        "desert_harvest": ["11-01", "03-31"],
        "notes": "Citrus japonica. Most cold-hardy citrus — tolerates 15-18F. Nagami (oval, tart) and Meiwa (round, sweet) are best varieties. Eat whole including rind. Needs afternoon shade in desert summer. Avoid reflected heat from walls. Deep water 1.5hrs to 3ft depth every 1-2 weeks. Use organic fertilizer only in desert soil to avoid salt buildup. Fruits 2-3 years after planting.",
        "companions": ["Lavender", "Nasturtium", "Marigold", "Lemon"],
        "antagonists": [],
    },
    # ── ALMOND ──
    {
    ...
    # ── ASHWAGANDHA ──
    {
        ...
        "desert_transplant": ["03-15", "06-01"],
        "desert_harvest": ["09-01", "12-31"],
        "notes": "Withania somnifera. Adaptogenic medicinal herb — desert native that thrives in Phoenix heat (100F+). Extremely drought tolerant. Prefers sandy loam, pH 7.5-8.0 (perfect for AZ alkaline soil). Sow when soil reaches 70F. Perennial in zone 9b+ — cut to ground after frost, roots regrow in spring. Harvest roots at 150-180 days when berries turn red. Leaves also usable. Virtually no pest problems.",
    ...
    # ── STEVIA ──
    {
        ...
        "desert_harvest": ["04-15", "11-30"],
        "notes": "Stevia rebaudiana. Natural sweetener — leaves 30x sweeter than sugar with zero calories. Needs afternoon shade in desert to prevent stress. Tender perennial in zone 9b with frost protection. Plant in spring or fall (avoid midsummer transplanting). Well-drained loamy soil, pH 6.7-7.2. Keep soil evenly moist but never soggy. Harvest leaves once plant reaches 8 inches. Pinch flowers to extend leaf production.",
        "companions": ["Basil", "Marigold", "Lavender"],
        "antagonists": [],
    },
    # ── HOLY BASIL (TULSI) ──
    {
    ...
    },
    {
        ...
        "desert_transplant": ["02-15", "05-01"],
        "desert_harvest": ["11-01", "03-31"],
        "notes": "Persian (Bearss/Tahitian) lime is most popular for Phoenix — seedless, productive, year-round harvest potential. Key lime is smaller but more aromatic. Very frost-sensitive — plant in warmest microclimate, south-facing wall ideal. Avoid western exposure which burns fruit. Fertilize in 3 splits: Jan-Feb, Mar-Apr, Aug-Sep. Water deeply 1-2x/week for young trees.",
        "companions": ["Marigold", "Nasturtium", "Lavender"],
        "antagonists": [],
    },
    {
        "name": "Apple",
    ...
    # HERBS
    {
        ...
        "desert_transplant": ["03-15", "05-01"],
        "desert_harvest": ["04-01", "11-30"],
        "notes": "Murraya koenigii — essential herb in South Indian and Sri Lankan cooking. Thrives in Phoenix heat but needs afternoon shade when temps exceed 100F. Can sunburn in full western exposure. Water daily in summer, weekly in spring/fall. Well-draining soil critical — root rot is the main killer. Keep in container first 2 years, then plant in ground. Frost-sensitive — cover below 32F. Aromatic leaves used fresh for tempering (tadka).",
        "companions": ["Pepper", "Eggplant", "Tomato"],
        "antagonists": [],
    },
    {
        "name": "Shiso",
    ...
    # NATIVE/EDIBLE
    {
        ...
        "sow_indoor_weeks_before_transplant": None,
        "desert_sow_outdoor": None,
        "desert_transplant": ["10-01", "04-01"],
        "desert_harvest": None,
        "notes": "Agave americana and other species — iconic Sonoran Desert plant. Extremely drought-tolerant once established. Edible flower stalk (quiote) can be roasted when it bolts — tastes like asparagus. Heart (piña) is roasted for traditional mezcal/tequila production. Agave nectar from sap. Produces pups (offsets) for easy propagation. Dies after flowering (monocarpic) but pups continue the colony. Zero irrigation needed once established. Virtually pest-free.",
        "companions": ["Prickly Pear", "Desert Milkweed", "Globe Mallow"],
        "antagonists": [],
    },
    # ── KUMQUAT ──
    {
        ...
        "desert_transplant": ["02-15", "05-15"],
        "desert_harvest": ["11-01", "03-31"],
        "notes": "Fortunella spp. Most cold-hardy of all citrus — tolerates brief dips to 18°F. Eat whole, skin and all. Nagami (oval, tart) and Meiwa (round, sweet) are best varieties for AZ. Compact tree 6-10 ft, excellent for containers. Fruit sweetest after a cold snap. Plant on south-facing wall for winter protection.",
        "companions": ["Lemon", "Orange", "Marigold", "Nasturtium", "Lavender"],
        "antagonists": [],
    },
    # ── LIME ──
    {
        ...
        "desert_sow_outdoor": None,
        "desert_transplant": ["03-01", "05-15"],
        "desert_harvest": ["06-01", "12-31"],
        "notes": "Citrus aurantiifolia (Key) / C. latifolia (Persian). Most cold-sensitive citrus — protect below 32°F. Persian (Bearss) lime is hardier and seedless. Key lime is more aromatic but frost-tender. Mexican lime excellent for hot climates. Water deeply and consistently. Yellowing fruit is fully ripe and sweetest.",
        "companions": ["Lemon", "Orange", "Grapefruit", "Nasturtium", "Marigold"],
        "antagonists": [],
    },
    # ── PERSIMMON ──
    {
        ...
        "desert_transplant": ["12-01", "02-28"],
        "desert_harvest": ["10-01", "12-31"],
        "notes": "Diospyros kaki (Asian) / D. virginiana (American). Fuyu (non-astringent, eat crisp) is easiest for beginners. Hachiya (astringent, must be fully soft). Giant Fuyu and Jiro excellent for AZ heat. Low-chill 100-200 hrs. Beautiful fall foliage. Very few pest/disease problems. Deep taproot makes established trees drought-tolerant.",
    ...
    # ── PECAN ──
    {
        ...
        "desert_transplant": ["01-15", "03-15"],
        "desert_harvest": ["10-01", "12-31"],
        "notes": "Carya illinoinensis. Classic Arizona nut tree — thrives in low desert heat. Western Schley and Wichita are top AZ varieties (low chill <600 hrs). Large tree 40-70 ft, needs space. Heavy water user — flood irrigate, not drip. Requires annual zinc fertilizer. Plant two varieties for cross-pollination. Produces in 3-4 years from grafted stock.",
    ...
    # ── CURRY LEAF ──
    {
        ...
        "desert_transplant": ["03-15", "05-31"],
        "desert_harvest": ["04-01", "11-30"],
        "notes": "Murraya koenigii (syn. Bergera koenigii). Essential in South Indian and Sri Lankan cooking. Thrives in Phoenix summer heat (tolerates 117°F). Must protect below 32°F — grow in container or against south wall. Fresh leaves far superior to dried. Cannot be shipped into AZ — source locally. Slow to establish but vigorous once rooted.",
        "companions": ["Pepper", "Tomato", "Lemongrass", "Basil"],
        "antagonists": [],
    },
    # ── STEVIA ──
    {
        ...
        "desert_harvest": ["04-01", "11-30"],
        "notes": "Stevia rebaudiana. Natural zero-calorie sweetener — leaves 30-40x sweeter than sugar. Grow as annual in AZ (dies below 28°F). Provide afternoon shade in summer to prevent leaf scorch. Harvest leaves before flowering for best sweetness. Pinch flowers to extend leaf production. Excellent container plant.",
        "companions": ["Basil", "Mint", "Cilantro"],
        "antagonists": [],
    },
    # ── BAY LAUREL ──
    {
        ...
        "desert_transplant": ["10-01", "03-31"],
        "desert_harvest": ["01-01", "12-31"],
        "notes": "Laurus nobilis. Mediterranean evergreen tree — very well adapted to AZ heat and alkaline soil. Slow-growing to 15-30 ft but easily kept smaller by pruning. Classic culinary herb for soups, stews, braises. Harvest mature leaves anytime — dry for 2 weeks for best flavor. Drought-tolerant once established. Excellent in large containers.",
        "companions": ["Rosemary", "Sage", "Thyme", "Oregano", "Lavender"],
        "antagonists": [],
    },
    # ── ALOE VERA ──
    {
        ...
        "desert_transplant": ["03-01", "05-31"],
        "desert_harvest": ["01-01", "12-31"],
        "notes": "Aloe barbadensis miller. Edible gel used in drinks, desserts, and traditional medicine. Thrives in Phoenix heat with minimal water. Protect from frost below 28°F. Multiplies readily via pups — easily shared. Prefers well-drained sandy soil. Afternoon shade in summer prevents sunburn on leaves. Medicinal gel soothes burns and skin irritation.",
        "companions": ["Lavender", "Rosemary", "Agave"],
        "antagonists": [],
    },
    # ═══════════════════════════════════════════════════════════════════
    # NEW PLANTS — Research batch 2026-04-14
    # ═══════════════════════════════════════════════════════════════════
    # ── THAI BASIL ──
    {
        "name": "Thai Basil",
